  ...
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.Mail))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {6, _, bytes} ->
                ...
                {[attachments: msg.attachments ++ [Soulless.Lq.RewardSlot.decode!(delimited)]],
                 rest}
              ...
              {10, _, bytes} ->
                ...
                {[title_i18n: msg.title_i18n ++ [Soulless.Lq.I18nContext.decode!(delimited)]],
                 rest}
              ...
              {11, _, bytes} ->
                ...
                {[content_i18n: msg.content_i18n ++ [Soulless.Lq.I18nContext.decode!(delimited)]],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:attachments, :unpacked, {:message, Soulless.Lq.RewardSlot}},
        7 => {:create_time, {:scalar, 0}, :uint32},
        8 => {:expire_time, {:scalar, 0}, :uint32},
        9 => {:reference_id, {:scalar, 0}, :uint32},
        10 => {:title_i18n, :unpacked, {:message, Soulless.Lq.I18nContext}},
        11 => {:content_i18n, :unpacked, {:message, Soulless.Lq.I18nContext}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        attachments: {6, :unpacked, {:message, Soulless.Lq.RewardSlot}},
        content: {5, {:scalar, ""}, :string},
        content_i18n: {11, :unpacked, {:message, Soulless.Lq.I18nContext}},
        ...
        title_i18n: {10, :unpacked, {:message, Soulless.Lq.I18nContext}}
      }
    end
