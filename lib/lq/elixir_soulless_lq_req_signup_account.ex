...
defmodule(Soulless.Lq.ReqSignupAccount) do
  @moduledoc false
  (
    defstruct(
      account: "",
        ...
        defp(encode_code(acc, msg)) do
          try do
            if(msg.code == "") do
              ...
              [acc, <<26>>, Protox.Encode.encode_string(msg.code)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqSignupAccount))
          end
        )
      )
