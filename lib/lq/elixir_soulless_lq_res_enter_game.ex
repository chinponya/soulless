...
defmodule(Soulless.Lq.ResEnterGame) do
  @moduledoc false
  (
      ...
      [
        ...
        defp(encode_is_end(acc, msg)) do
          try do
            if(msg.is_end == false) do
              ...
              [acc, <<16>>, Protox.Encode.encode_bool(msg.is_end)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_step(acc, msg)) do
          try do
            if(msg.step == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.step)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_game_restore(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:game_restore, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResEnterGame))
          end
        )
      )
                ...
                {[
                   game_restore:
                     Protox.Message.merge(
                       msg.game_restore,
                       Soulless.Lq.GameRestore.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        4 => {:game_restore, {:scalar, nil}, {:message, Soulless.Lq.GameRestore}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        game_restore: {4, {:scalar, nil}, {:message, Soulless.Lq.GameRestore}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :game_restore,
          tag: 4,
          type: {:message, Soulless.Lq.GameRestore}
        }
      ]
    end
