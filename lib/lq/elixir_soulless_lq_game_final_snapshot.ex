...
defmodule(Soulless.Lq.GameFinalSnapshot) do
  @moduledoc false
  (
    defstruct(
      uuid: "",
      ...
      [
        ...
        defp(encode_category(acc, msg)) do
          try do
            if(msg.category == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.category)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_calculate_param(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:calculate_param, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_account_views(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:account_views, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_final_players(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:final_players, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameFinalSnapshot))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {4, _, bytes} ->
                ...
                {[mode: Protox.Message.merge(msg.mode, Soulless.Lq.GameMode.decode!(delimited))],
                 rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   meta:
                     Protox.Message.merge(msg.meta, Soulless.Lq.GameMetaData.decode!(delimited))
                 ], rest}
                ...
                {[
                   calculate_param:
                     Protox.Message.merge(
                       msg.calculate_param,
                       Soulless.Lq.GameFinalSnapshot.CalculateParam.decode!(delimited)
                     )
                 ], rest}
              ...
              {10, _, bytes} ->
                ...
                {[
                   seats: msg.seats ++ [Soulless.Lq.GameFinalSnapshot.GameSeat.decode!(delimited)]
                 ], rest}

              {11, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[rounds: msg.rounds ++ [Soulless.Lq.GameRoundSnapshot.decode!(delimited)]], rest}
              ...
              {12, _, bytes} ->
                ...
                {[
                   account_views:
                     msg.account_views ++ [Soulless.Lq.PlayerGameView.decode!(delimited)]
                 ], rest}
              ...
              {13, _, bytes} ->
                ...
                {[
                   final_players:
                     msg.final_players ++
                       [Soulless.Lq.GameFinalSnapshot.FinalPlayer.decode!(delimited)]
                 ], rest}
              ...
              {14, _, bytes} ->
                ...
                {[
                   afk_info:
                     msg.afk_info ++ [Soulless.Lq.GameFinalSnapshot.AFKInfo.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        4 => {:mode, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
        5 => {:meta, {:scalar, nil}, {:message, Soulless.Lq.GameMetaData}},
        6 =>
          {:calculate_param, {:scalar, nil},
           {:message, Soulless.Lq.GameFinalSnapshot.CalculateParam}},
        7 => {:create_time, {:scalar, 0}, :uint32},
        8 => {:start_time, {:scalar, 0}, :uint32},
        9 => {:finish_time, {:scalar, 0}, :uint32},
        10 => {:seats, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.GameSeat}},
        11 => {:rounds, :unpacked, {:message, Soulless.Lq.GameRoundSnapshot}},
        12 => {:account_views, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
        13 => {:final_players, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.FinalPlayer}},
        14 => {:afk_info, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.AFKInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        account_views: {12, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
        afk_info: {14, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.AFKInfo}},
        calculate_param:
          {6, {:scalar, nil}, {:message, Soulless.Lq.GameFinalSnapshot.CalculateParam}},
        category: {3, {:scalar, 0}, :uint32},
        create_time: {7, {:scalar, 0}, :uint32},
        final_players: {13, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.FinalPlayer}},
        finish_time: {9, {:scalar, 0}, :uint32},
        meta: {5, {:scalar, nil}, {:message, Soulless.Lq.GameMetaData}},
        mode: {4, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
        rounds: {11, :unpacked, {:message, Soulless.Lq.GameRoundSnapshot}},
        seats: {10, :unpacked, {:message, Soulless.Lq.GameFinalSnapshot.GameSeat}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :mode,
          tag: 4,
          type: {:message, Soulless.Lq.GameMode}
        },
        %{
          __struct__: Protox.Field,
          json_name: "meta",
          ...
          name: :meta,
          tag: 5,
          type: {:message, Soulless.Lq.GameMetaData}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 6,
          type: {:message, Soulless.Lq.GameFinalSnapshot.CalculateParam}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :seats,
          tag: 10,
          type: {:message, Soulless.Lq.GameFinalSnapshot.GameSeat}
        },
        %{
          __struct__: Protox.Field,
          json_name: "rounds",
          ...
          name: :rounds,
          tag: 11,
          type: {:message, Soulless.Lq.GameRoundSnapshot}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :account_views,
          tag: 12,
          type: {:message, Soulless.Lq.PlayerGameView}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :final_players,
          tag: 13,
          type: {:message, Soulless.Lq.GameFinalSnapshot.FinalPlayer}
        },
        %{
          __struct__: Protox.Field,
          json_name: "afkInfo",
          ...
          name: :afk_info,
          tag: 14,
          type: {:message, Soulless.Lq.GameFinalSnapshot.AFKInfo}
        }
      ]
    end
