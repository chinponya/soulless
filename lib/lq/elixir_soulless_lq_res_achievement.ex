...
defmodule(Soulless.Lq.ResAchievement) do
  @moduledoc false
  (
    defstruct(error: nil, progresses: [], rewarded_group: [], __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAchievement))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:progresses, :unpacked, {:message, Soulless.Lq.AchievementProgress}},
        3 => {:rewarded_group, :packed, :uint32}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        progresses: {2, :unpacked, {:message, Soulless.Lq.AchievementProgress}},
        rewarded_group: {3, :packed, :uint32}
      }
    end
