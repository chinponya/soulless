...
defmodule(Soulless.Lq.ResLevelLeaderboard.Item) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResLevelLeaderboard.Item))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResLevelLeaderboard.Item,
    ...
    def(defs()) do
      %{
        ...
        2 => {:level, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        level: {2, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}}
      }
    end
