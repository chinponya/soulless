...
defmodule(Soulless.Lq.GameAction) do
  @moduledoc false
  (
    defstruct(
      passed: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameAction))
          end
        )
      )
                ...
                {[
                   user_input:
                     Protox.Message.merge(
                       msg.user_input,
                       Soulless.Lq.GameUserInput.decode!(delimited)
                     )
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   user_event:
                     Protox.Message.merge(
                       msg.user_event,
                       Soulless.Lq.GameUserEvent.decode!(delimited)
                     )
                 ], rest}
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :user_input,
          tag: 4,
          type: {:message, Soulless.Lq.GameUserInput}
        },
        %{
          __struct__: Protox.Field,
          json_name: "userEvent",
          ...
          name: :user_event,
          tag: 5,
          type: {:message, Soulless.Lq.GameUserEvent}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gameEvent",
