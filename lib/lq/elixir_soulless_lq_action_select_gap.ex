...
defmodule(Soulless.Lq.ActionSelectGap) do
  @moduledoc false
  (
    defstruct(gap_types: [], tingpais0: [], tingpais1: [], operation: nil, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionSelectGap))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:tingpais0, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        3 => {:tingpais1, :unpacked, {:message, Soulless.Lq.TingPaiInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        tingpais0: {2, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        tingpais1: {3, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
