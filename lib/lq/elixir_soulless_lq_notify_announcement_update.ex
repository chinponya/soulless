...
defmodule(Soulless.Lq.NotifyAnnouncementUpdate) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyAnnouncementUpdate))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyAnnouncementUpdate,
    ...
    def(defs()) do
      %{
        1 => {:announcements, :unpacked, {:message, Soulless.Lq.Announcement}},
    ...
    def(defs_by_name()) do
      %{
        announcements: {1, :unpacked, {:message, Soulless.Lq.Announcement}},
