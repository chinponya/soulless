...
defmodule(Soulless.Lq.ResAccountInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAccountInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                ...
                {[room: Protox.Message.merge(msg.room, Soulless.Lq.Room.decode!(delimited))],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:account, {:scalar, nil}, {:message, Soulless.Lq.Account}},
        3 => {:room, {:scalar, nil}, {:message, Soulless.Lq.Room}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        account: {2, {:scalar, nil}, {:message, Soulless.Lq.Account}},
        error: {1, {:scalar, nil}, {:message, Soulless.Lq.Error}},
        room: {3, {:scalar, nil}, {:message, Soulless.Lq.Room}}
      }
    end
