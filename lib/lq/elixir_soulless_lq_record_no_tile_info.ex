...
defmodule(Soulless.Lq.RecordNoTileInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordNoTileInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   players: msg.players ++ [Soulless.Lq.RecordNoTilePlayerInfo.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:players, :unpacked, {:message, Soulless.Lq.RecordNoTilePlayerInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        players: {2, :unpacked, {:message, Soulless.Lq.RecordNoTilePlayerInfo}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :players,
          tag: 2,
          type: {:message, Soulless.Lq.RecordNoTilePlayerInfo}
        }
      ]
    end
