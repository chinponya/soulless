...
defmodule(Soulless.Lq.ActionDealTile) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
        ...
        defp(encode_left_tile_count(acc, msg)) do
          try do
            if(msg.left_tile_count == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.left_tile_count)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionDealTile))
          end
        )
      )
