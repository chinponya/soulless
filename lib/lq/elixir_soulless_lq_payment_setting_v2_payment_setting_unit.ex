...
defmodule(Soulless.Lq.PaymentSettingV2.PaymentSettingUnit) do
  @moduledoc false
  (
    defstruct(
      platform: "",
      ...
      [
        ...
        defp(encode_enable_for_frozen_account(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:enable_for_frozen_account, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PaymentSettingV2.PaymentSettingUnit))
          end
        )
      )
                ...
                {[
                   maintain:
                     Protox.Message.merge(
                       msg.maintain,
                       Soulless.Lq.PaymentSettingV2.PaymentMaintain.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.PaymentSettingV2.PaymentSettingUnit,
    ...
    def(defs()) do
      %{
        ...
        5 =>
          {:maintain, {:scalar, nil}, {:message, Soulless.Lq.PaymentSettingV2.PaymentMaintain}},
    ...
    def(defs_by_name()) do
      %{
        ...
        maintain: {5, {:scalar, nil}, {:message, Soulless.Lq.PaymentSettingV2.PaymentMaintain}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :maintain,
          tag: 5,
          type: {:message, Soulless.Lq.PaymentSettingV2.PaymentMaintain}
        },
        %{
          __struct__: Protox.Field,
