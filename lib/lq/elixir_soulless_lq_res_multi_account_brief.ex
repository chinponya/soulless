...
defmodule(Soulless.Lq.ResMultiAccountBrief) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResMultiAccountBrief))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[players: msg.players ++ [Soulless.Lq.PlayerBaseView.decode!(delimited)]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResMultiAccountBrief,
    ...
    def(defs()) do
      %{
        ...
        2 => {:players, :unpacked, {:message, Soulless.Lq.PlayerBaseView}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        players: {2, :unpacked, {:message, Soulless.Lq.PlayerBaseView}}
      }
    end
