...
defmodule(Soulless.Lq.RecordNewRound) do
  @moduledoc false
  (
    defstruct(
      chang: 0,
            ...
            case(msg.doras) do
              ...
              values ->
                [
                  acc,
                  Enum.reduce(values, [], fn value, acc ->
                    [acc, <<130, 1>>, Protox.Encode.encode_string(value)]
                  end)
                ]
            end
          rescue
            ...
            case(msg.opens) do
              ...
              values ->
                [
                  acc,
                  Enum.reduce(values, [], fn value, acc ->
                    [acc, <<138, 1>>, Protox.Encode.encode_message(value)]
                  end)
                ]
            end
          rescue
        ...
        defp(encode_muyu(acc, msg)) do
          try do
            if(msg.muyu == nil) do
              ...
              [acc, <<146, 1>>, Protox.Encode.encode_message(msg.muyu)]
            end
          rescue
            ArgumentError ->
            ...
            case(msg.operations) do
              ...
              values ->
                [
                  acc,
                  Enum.reduce(values, [], fn value, acc ->
                    [acc, <<154, 1>>, Protox.Encode.encode_message(value)]
                  end)
                ]
            end
          rescue
        ...
        defp(encode_ju_count(acc, msg)) do
          try do
            if(msg.ju_count == 0) do
              ...
              [acc, <<160, 1>>, Protox.Encode.encode_uint32(msg.ju_count)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_new_tile(acc, msg)) do
          try do
            if(msg.new_tile == "") do
              ...
              [acc, <<170, 1>>, Protox.Encode.encode_string(msg.new_tile)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordNewRound))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {11, _, bytes} ->
                ...
                {[
                   tingpai: msg.tingpai ++ [Soulless.Lq.RecordNewRound.TingPai.decode!(delimited)]
                 ], rest}
              ...
              {17, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[opens: msg.opens ++ [Soulless.Lq.NewRoundOpenedTiles.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        ...
        11 => {:tingpai, :unpacked, {:message, Soulless.Lq.RecordNewRound.TingPai}},
        12 => {:operation, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        13 => {:md5, {:scalar, ""}, :string},
        14 => {:paishan, {:scalar, ""}, :string},
        15 => {:left_tile_count, {:scalar, 0}, :uint32},
        16 => {:doras, :unpacked, :string},
        17 => {:opens, :unpacked, {:message, Soulless.Lq.NewRoundOpenedTiles}},
        18 => {:muyu, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        19 => {:operations, :unpacked, {:message, Soulless.Lq.OptionalOperationList}},
        20 => {:ju_count, {:scalar, 0}, :uint32},
        21 => {:new_tile, {:scalar, ""}, :string}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        muyu: {18, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        new_tile: {21, {:scalar, ""}, :string},
        opens: {17, :unpacked, {:message, Soulless.Lq.NewRoundOpenedTiles}},
        operation: {12, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        operations: {19, :unpacked, {:message, Soulless.Lq.OptionalOperationList}},
        ...
        tingpai: {11, :unpacked, {:message, Soulless.Lq.RecordNewRound.TingPai}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :tingpai,
          tag: 11,
          type: {:message, Soulless.Lq.RecordNewRound.TingPai}
        },
        %{
          __struct__: Protox.Field,
          json_name: "operation",
        ...
        %{
          ...
          name: :opens,
          tag: 17,
          type: {:message, Soulless.Lq.NewRoundOpenedTiles}
        },
        %{
          __struct__: Protox.Field,
          json_name: "muyu",
