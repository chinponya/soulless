...
defmodule(Soulless.Lq.ResOpenRandomRewardItem) do
  @moduledoc false
  (
    defstruct(error: nil, results: [], __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_results(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResOpenRandomRewardItem))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResOpenRandomRewardItem,
