...
defmodule(Soulless.Lq.ResReadSNS) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResReadSNS))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   sns_content:
                     Protox.Message.merge(msg.sns_content, Soulless.Lq.SNSBlog.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:sns_content, {:scalar, nil}, {:message, Soulless.Lq.SNSBlog}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        sns_content: {2, {:scalar, nil}, {:message, Soulless.Lq.SNSBlog}}
      }
    end
