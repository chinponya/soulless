...
defmodule(Soulless.Lq.ResFetchRPGBattleHistory.BattleResult) do
  @moduledoc false
  (
    defstruct(
      chang: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchRPGBattleHistory.BattleResult))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchRPGBattleHistory.BattleResult,
