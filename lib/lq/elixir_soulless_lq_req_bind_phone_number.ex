...
defmodule(Soulless.Lq.ReqBindPhoneNumber) do
  @moduledoc false
  (
      ...
      [
        ...
        defp(encode_phone(acc, msg)) do
          try do
            if(msg.phone == "") do
              ...
              [acc, <<18>>, Protox.Encode.encode_string(msg.phone)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_password(acc, msg)) do
          try do
            if(msg.password == "") do
              ...
              [acc, <<26>>, Protox.Encode.encode_string(msg.password)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_multi_bind_version(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:multi_bind_version, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqBindPhoneNumber))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ReqBindPhoneNumber,
