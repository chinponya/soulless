...
defmodule(Soulless.Lq.GameEndResult.PlayerItem) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameEndResult.PlayerItem))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.GameEndResult.PlayerItem,
