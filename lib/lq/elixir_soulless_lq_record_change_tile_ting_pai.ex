...
defmodule(Soulless.Lq.RecordChangeTile.TingPai) do
  @moduledoc false
  (
    defstruct(seat: 0, tingpais1: [], __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_seat(msg) |> encode_tingpais1(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordChangeTile.TingPai))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.RecordChangeTile.TingPai,
    ...
    def(defs()) do
      %{
        ...
        2 => {:tingpais1, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        tingpais1: {2, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
