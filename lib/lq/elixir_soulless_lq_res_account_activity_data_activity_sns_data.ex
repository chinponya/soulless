...
defmodule(Soulless.Lq.ResAccountActivityData.ActivitySNSData) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAccountActivityData.ActivitySNSData))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[blog: msg.blog ++ [Soulless.Lq.SNSBlog.decode!(delimited)]], rest}

              {2, 2, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)

                {[liked_id: msg.liked_id ++ Protox.Decode.parse_repeated_uint32([], delimited)],
                 rest}

              {2, _, bytes} ->
                {value, rest} = Protox.Decode.parse_uint32(bytes)
                {[liked_id: msg.liked_id ++ [value]], rest}

              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[reply: msg.reply ++ [Soulless.Lq.SNSReply.decode!(delimited)]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResAccountActivityData.ActivitySNSData,
    ...
    def(defs()) do
      %{
        1 => {:blog, :unpacked, {:message, Soulless.Lq.SNSBlog}},
        2 => {:liked_id, :packed, :uint32},
        3 => {:reply, :unpacked, {:message, Soulless.Lq.SNSReply}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        blog: {1, :unpacked, {:message, Soulless.Lq.SNSBlog}},
        liked_id: {2, :packed, :uint32},
        reply: {3, :unpacked, {:message, Soulless.Lq.SNSReply}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :blog,
          tag: 1,
          type: {:message, Soulless.Lq.SNSBlog}
        },
        %{
          __struct__: Protox.Field,
          json_name: "likedId",
        ...
        %{
          ...
          name: :reply,
          tag: 3,
          type: {:message, Soulless.Lq.SNSReply}
        }
      ]
    end
