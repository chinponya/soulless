...
defmodule(Soulless.Lq.ResReceiveActivityFlipTask) do
  @moduledoc false
  (
    defstruct(count: 0, error: nil, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_count(msg) |> encode_error(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResReceiveActivityFlipTask))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResReceiveActivityFlipTask,
