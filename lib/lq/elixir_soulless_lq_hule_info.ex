...
defmodule(Soulless.Lq.HuleInfo) do
  @moduledoc false
  (
    defstruct(
      hand: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.HuleInfo))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        12 => {:fans, :unpacked, {:message, Soulless.Lq.FanInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        fans: {12, :unpacked, {:message, Soulless.Lq.FanInfo}},
