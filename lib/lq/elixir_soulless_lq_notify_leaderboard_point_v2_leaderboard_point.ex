...
defmodule(Soulless.Lq.NotifyLeaderboardPointV2.LeaderboardPoint) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyLeaderboardPointV2.LeaderboardPoint))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyLeaderboardPointV2.LeaderboardPoint,
