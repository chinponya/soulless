...
defmodule(Soulless.Lq.GameRestore) do
  @moduledoc false
  (
    defstruct(
      snapshot: nil,
      ...
      [
        ...
        defp(encode_passed_waiting_time(acc, msg)) do
          try do
            if(msg.passed_waiting_time == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.passed_waiting_time)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:passed_waiting_time, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_game_state(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:game_state, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_last_pause_time_ms(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:last_pause_time_ms, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameRestore))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
                ...
                {[
                   snapshot:
                     Protox.Message.merge(
                       msg.snapshot,
                       Soulless.Lq.GameSnapshot.decode!(delimited)
                     )
                 ], rest}
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[actions: msg.actions ++ [Soulless.Lq.ActionPrototype.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        1 => {:snapshot, {:scalar, nil}, {:message, Soulless.Lq.GameSnapshot}},
        2 => {:actions, :unpacked, {:message, Soulless.Lq.ActionPrototype}},
    ...
    def(defs_by_name()) do
      %{
        actions: {2, :unpacked, {:message, Soulless.Lq.ActionPrototype}},
        game_state: {4, {:scalar, 0}, :uint32},
        last_pause_time_ms: {6, {:scalar, 0}, :uint32},
        passed_waiting_time: {3, {:scalar, 0}, :uint32},
        snapshot: {1, {:scalar, nil}, {:message, Soulless.Lq.GameSnapshot}},
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :snapshot,
          tag: 1,
          type: {:message, Soulless.Lq.GameSnapshot}
        },
        %{
          __struct__: Protox.Field,
          json_name: "actions",
          ...
          name: :actions,
          tag: 2,
          type: {:message, Soulless.Lq.ActionPrototype}
        },
        %{
          __struct__: Protox.Field,
