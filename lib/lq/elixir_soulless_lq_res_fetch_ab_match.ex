...
defmodule(Soulless.Lq.ResFetchABMatch) do
  @moduledoc false
  (
    defstruct(
      error: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchABMatch))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {7, _, bytes} ->
                ...
                {[
                   match_max_point:
                     msg.match_max_point ++
                       [Soulless.Lq.ResFetchABMatch.MatchPoint.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        3 => {:match_count, {:scalar, 0}, :uint32},
        4 => {:buy_in_count, {:scalar, 0}, :uint32},
        5 => {:point, {:scalar, 0}, :uint32},
        6 => {:rewarded, {:scalar, false}, :bool},
        7 => {:match_max_point, :unpacked, {:message, Soulless.Lq.ResFetchABMatch.MatchPoint}},
        8 => {:quit, {:scalar, false}, :bool}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        match_count: {3, {:scalar, 0}, :uint32},
        match_id: {2, {:scalar, 0}, :uint32},
        match_max_point: {7, :unpacked, {:message, Soulless.Lq.ResFetchABMatch.MatchPoint}},
        point: {5, {:scalar, 0}, :uint32},
        quit: {8, {:scalar, false}, :bool},
        rewarded: {6, {:scalar, false}, :bool}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 7,
          type: {:message, Soulless.Lq.ResFetchABMatch.MatchPoint}
        },
        %{
          __struct__: Protox.Field,
          json_name: "quit",
