...
defmodule(Soulless.Lq.NotifyCustomContestSystemMsg) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyCustomContestSystemMsg))
          end
        )
      )
                ...
                {[
                   game_start:
                     Protox.Message.merge(
                       msg.game_start,
                       Soulless.Lq.CustomizedContestGameStart.decode!(delimited)
                     )
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   game_end:
                     Protox.Message.merge(
                       msg.game_end,
                       Soulless.Lq.CustomizedContestGameEnd.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyCustomContestSystemMsg,
    ...
    def(defs()) do
      %{
        ...
        4 => {:game_start, {:scalar, nil}, {:message, Soulless.Lq.CustomizedContestGameStart}},
        5 => {:game_end, {:scalar, nil}, {:message, Soulless.Lq.CustomizedContestGameEnd}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        game_end: {5, {:scalar, nil}, {:message, Soulless.Lq.CustomizedContestGameEnd}},
        game_start: {4, {:scalar, nil}, {:message, Soulless.Lq.CustomizedContestGameStart}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :game_start,
          tag: 4,
          type: {:message, Soulless.Lq.CustomizedContestGameStart}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gameEnd",
          ...
          name: :game_end,
          tag: 5,
          type: {:message, Soulless.Lq.CustomizedContestGameEnd}
        }
      ]
    end
