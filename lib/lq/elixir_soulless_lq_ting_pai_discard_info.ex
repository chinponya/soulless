...
defmodule(Soulless.Lq.TingPaiDiscardInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.TingPaiDiscardInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[infos: msg.infos ++ [Soulless.Lq.TingPaiInfo.decode!(delimited)]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.TingPaiDiscardInfo,
    ...
    def(defs()) do
      %{
        ...
        3 => {:infos, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        infos: {3, :unpacked, {:message, Soulless.Lq.TingPaiInfo}},
        tile: {1, {:scalar, ""}, :string},
        zhenting: {2, {:scalar, false}, :bool}
      }
    end
