...
defmodule(Soulless.Lq.ResCreateWechatAppOrder.CallWechatAppParam) do
  @moduledoc false
  (
    defstruct(
      appid: "",
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResCreateWechatAppOrder.CallWechatAppParam))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResCreateWechatAppOrder.CallWechatAppParam,
