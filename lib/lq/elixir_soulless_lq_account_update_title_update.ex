...
defmodule(Soulless.Lq.AccountUpdate.TitleUpdate) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountUpdate.TitleUpdate))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountUpdate.TitleUpdate,
