...
defmodule(Soulless.Lq.ZHPShop) do
  @moduledoc false
  (
      ...
      [
        ...
        defp(encode_buy_records(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:buy_records, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_free_refresh(acc, msg)) do
          try do
            if(msg.free_refresh == nil) do
              ...
              [acc, <<26>>, Protox.Encode.encode_message(msg.free_refresh)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ZHPShop))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[buy_records: msg.buy_records ++ [Soulless.Lq.BuyRecord.decode!(delimited)]],
                 rest}
                ...
                {[
                   free_refresh:
                     Protox.Message.merge(
                       msg.free_refresh,
                       Soulless.Lq.ZHPShop.RefreshCount.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:buy_records, :unpacked, {:message, Soulless.Lq.BuyRecord}},
        3 => {:free_refresh, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop.RefreshCount}},
        4 => {:cost_refresh, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop.RefreshCount}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        buy_records: {2, :unpacked, {:message, Soulless.Lq.BuyRecord}},
        cost_refresh: {4, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop.RefreshCount}},
        free_refresh: {3, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop.RefreshCount}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :buy_records,
          tag: 2,
          type: {:message, Soulless.Lq.BuyRecord}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :free_refresh,
          tag: 3,
          type: {:message, Soulless.Lq.ZHPShop.RefreshCount}
        },
        %{
          __struct__: Protox.Field,
