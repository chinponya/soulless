...
defmodule(Soulless.Lq.ResGameLiveLeftSegment) do
  @moduledoc false
  (
    defstruct(
      error: nil,
      ...
      [
        ...
        defp(encode_live_state(acc, msg)) do
          try do
            if(msg.live_state == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.live_state)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:live_state, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_segment_end_millisecond(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:segment_end_millisecond, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResGameLiveLeftSegment))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResGameLiveLeftSegment,
