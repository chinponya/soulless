...
defmodule(Soulless.Lq.ReqCreateXsollaOrder) do
  @moduledoc false
  (
    defstruct(
      goods_id: 0,
      ...
      [
        ...
        defp(encode_payment_method(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:payment_method, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqCreateXsollaOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ReqCreateXsollaOrder,
