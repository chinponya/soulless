...
defmodule(Soulless.Lq.ResAccountUpdate) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAccountUpdate))
          end
        )
      )
                ...
                {[
                   update:
                     Protox.Message.merge(
                       msg.update,
                       Soulless.Lq.AccountUpdate.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:update, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        update: {2, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :update,
          tag: 2,
          type: {:message, Soulless.Lq.AccountUpdate}
        }
      ]
    end
