...
defmodule(Soulless.Lq.ActionChangeTile) do
  @moduledoc false
  (
    defstruct(
      in_tiles: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionChangeTile))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        6 => {:tingpais0, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        7 => {:tingpais1, :unpacked, {:message, Soulless.Lq.TingPaiInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        tingpais0: {6, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        tingpais1: {7, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
