...
defmodule(Soulless.Lq.ResFetchChallengeInfo) do
  @moduledoc false
  (
    defstruct(
      error: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchChallengeInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   task_progress:
                     msg.task_progress ++ [Soulless.Lq.TaskProgress.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchChallengeInfo,
    ...
    def(defs()) do
      %{
        ...
        2 => {:task_progress, :unpacked, {:message, Soulless.Lq.TaskProgress}},
        3 => {:refresh_count, {:scalar, 0}, :uint32},
        4 => {:level, {:scalar, 0}, :uint32},
        5 => {:match_count, {:scalar, 0}, :uint32},
        6 => {:ticket_id, {:scalar, 0}, :uint32},
    ...
    def(defs_by_name()) do
      %{
        ...
        match_count: {5, {:scalar, 0}, :uint32},
        refresh_count: {3, {:scalar, 0}, :uint32},
        rewarded_season: {7, :packed, :uint32},
        task_progress: {2, :unpacked, {:message, Soulless.Lq.TaskProgress}},
        ticket_id: {6, {:scalar, 0}, :uint32}
      }
    end
