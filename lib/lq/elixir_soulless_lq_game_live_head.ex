...
defmodule(Soulless.Lq.GameLiveHead) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameLiveHead))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        3 => {:game_config, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
        4 => {:players, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
    ...
    def(defs_by_name()) do
      %{
        game_config: {3, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
        players: {4, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
