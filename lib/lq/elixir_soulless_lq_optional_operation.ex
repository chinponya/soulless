...
defmodule(Soulless.Lq.OptionalOperation) do
  @moduledoc false
  (
    defstruct(
      type: 0,
      ...
      [
        ...
        defp(encode_combination(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:combination, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_change_tile_states(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:change_tile_states, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.OptionalOperation))
          end
        )
      )
