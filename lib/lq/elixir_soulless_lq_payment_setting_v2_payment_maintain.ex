...
defmodule(Soulless.Lq.PaymentSettingV2.PaymentMaintain) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PaymentSettingV2.PaymentMaintain))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.PaymentSettingV2.PaymentMaintain,
