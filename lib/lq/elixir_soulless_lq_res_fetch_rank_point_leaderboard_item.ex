...
defmodule(Soulless.Lq.ResFetchRankPointLeaderboard.Item) do
  @moduledoc false
  (
        ...
        defp(encode_view(acc, msg)) do
          try do
            if(msg.view == nil) do
              ...
              [acc, <<26>>, Protox.Encode.encode_message(msg.view)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchRankPointLeaderboard.Item))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                ...
                {[
                   view:
                     Protox.Message.merge(msg.view, Soulless.Lq.PlayerBaseView.decode!(delimited))
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchRankPointLeaderboard.Item,
    ...
    def(defs()) do
      %{
        ...
        3 => {:view, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        view: {3, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}}
      }
    end
