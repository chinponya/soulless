...
defmodule(Soulless.Lq.ResRefreshZHPShop) do
  @moduledoc false
  (
    defstruct(error: nil, zhp: nil, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_zhp(msg) |> encode_unknown_fields(msg)
        end
      )
        ...
        defp(encode_zhp(acc, msg)) do
          try do
            if(msg.zhp == nil) do
              ...
              [acc, <<18>>, Protox.Encode.encode_message(msg.zhp)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResRefreshZHPShop))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:zhp, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        zhp: {2, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop}}
      }
    end
