...
defmodule(Soulless.Lq.RecordHuleXueZhanMid) do
  @moduledoc false
  (
    defstruct(
      hules: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordHuleXueZhanMid))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.RecordHuleXueZhanMid,
    ...
    def(defs()) do
      %{
        ...
        9 => {:liqi, {:scalar, nil}, {:message, Soulless.Lq.LiQiSuccess}},
    ...
    def(defs_by_name()) do
      %{
        ...
        liqi: {9, {:scalar, nil}, {:message, Soulless.Lq.LiQiSuccess}},
