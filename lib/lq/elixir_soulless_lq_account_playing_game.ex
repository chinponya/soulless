...
defmodule(Soulless.Lq.AccountPlayingGame) do
  @moduledoc false
  (
    defstruct(game_uuid: "", category: 0, meta: nil, __uf__: [])
        ...
        defp(encode_category(acc, msg)) do
          try do
            if(msg.category == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.category)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountPlayingGame))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountPlayingGame,
