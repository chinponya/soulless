...
defmodule(Soulless.Lq.AccountDetailStatisticV2) do
  @moduledoc false
  (
    defstruct(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountDetailStatisticV2))
          end
        )
      )
              ...
              {2, _, bytes} ->
                ...
                {[
                   rank_statistic:
                     Protox.Message.merge(
                       msg.rank_statistic,
                       Soulless.Lq.AccountDetailStatisticV2.RankStatistic.decode!(delimited)
                     )
                 ], rest}
                ...
                {[
                   customized_contest_statistic:
                     Protox.Message.merge(
                       ...
                       Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic.decode!(
                         delimited
                       )
                     )
                 ], rest}
                ...
                {[
                   challenge_match_statistic:
                     Protox.Message.merge(
                       ...
                       Soulless.Lq.AccountDetailStatisticV2.ChallengeStatistic.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountDetailStatisticV2,
    ...
    def(defs()) do
      %{
        1 =>
          {:friend_room_statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        2 =>
          {:rank_statistic, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatisticV2.RankStatistic}},
        3 =>
          {:customized_contest_statistic, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic}},
        4 =>
          {:leisure_match_statistic, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatistic}},
        5 =>
          {:challenge_match_statistic, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatisticV2.ChallengeStatistic}},
        6 =>
          {:activity_match_statistic, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatistic}},
        7 => {:ab_match_statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ab_match_statistic: {7, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        activity_match_statistic:
          {6, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        challenge_match_statistic:
          {5, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatisticV2.ChallengeStatistic}},
        customized_contest_statistic:
          {3, {:scalar, nil},
           {:message, Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic}},
        friend_room_statistic:
          {1, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        leisure_match_statistic:
          {4, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        rank_statistic:
          {2, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatisticV2.RankStatistic}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :rank_statistic,
          tag: 2,
          type: {:message, Soulless.Lq.AccountDetailStatisticV2.RankStatistic}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 3,
          type: {:message, Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          tag: 5,
          type: {:message, Soulless.Lq.AccountDetailStatisticV2.ChallengeStatistic}
        },
        %{
          __struct__: Protox.Field,
