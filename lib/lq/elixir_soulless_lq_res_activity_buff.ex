...
defmodule(Soulless.Lq.ResActivityBuff) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResActivityBuff))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   buff_list:
                     msg.buff_list ++
                       [Soulless.Lq.ResActivityBuff.ActivityBuffData.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:buff_list, :unpacked, {:message, Soulless.Lq.ResActivityBuff.ActivityBuffData}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        buff_list: {2, :unpacked, {:message, Soulless.Lq.ResActivityBuff.ActivityBuffData}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :buff_list,
          tag: 2,
          type: {:message, Soulless.Lq.ResActivityBuff.ActivityBuffData}
        }
      ]
    end
