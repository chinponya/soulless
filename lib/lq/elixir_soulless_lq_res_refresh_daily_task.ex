...
defmodule(Soulless.Lq.ResRefreshDailyTask) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResRefreshDailyTask))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResRefreshDailyTask,
    ...
    def(defs()) do
      %{
        ...
        2 => {:progress, {:scalar, nil}, {:message, Soulless.Lq.TaskProgress}},
    ...
    def(defs_by_name()) do
      %{
        ...
        progress: {2, {:scalar, nil}, {:message, Soulless.Lq.TaskProgress}},
