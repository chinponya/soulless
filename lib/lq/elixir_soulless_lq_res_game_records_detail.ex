...
defmodule(Soulless.Lq.ResGameRecordsDetail) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResGameRecordsDetail))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResGameRecordsDetail,
    ...
    def(defs()) do
      %{
        ...
        2 => {:record_list, :unpacked, {:message, Soulless.Lq.RecordGame}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        record_list: {2, :unpacked, {:message, Soulless.Lq.RecordGame}}
      }
    end
