...
defmodule(Soulless.Lq.ResCollectedGameRecordList) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResCollectedGameRecordList))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   record_list:
                     msg.record_list ++ [Soulless.Lq.RecordCollectedData.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResCollectedGameRecordList,
    ...
    def(defs()) do
      %{
        ...
        2 => {:record_list, :unpacked, {:message, Soulless.Lq.RecordCollectedData}},
    ...
    def(defs_by_name()) do
      %{
        ...
        record_list: {2, :unpacked, {:message, Soulless.Lq.RecordCollectedData}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :record_list,
          tag: 2,
          type: {:message, Soulless.Lq.RecordCollectedData}
        },
        %{
          __struct__: Protox.Field,
