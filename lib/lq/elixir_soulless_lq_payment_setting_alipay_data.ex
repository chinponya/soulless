...
defmodule(Soulless.Lq.PaymentSetting.AlipayData) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PaymentSetting.AlipayData))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.PaymentSetting.AlipayData,
