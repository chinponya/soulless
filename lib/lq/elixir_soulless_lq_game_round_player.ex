...
defmodule(Soulless.Lq.GameRoundPlayer) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameRoundPlayer))
          end
        )
      )
                ...
                {[
                   result:
                     Protox.Message.merge(
                       msg.result,
                       Soulless.Lq.GameRoundPlayerResult.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        3 => {:result, {:scalar, nil}, {:message, Soulless.Lq.GameRoundPlayerResult}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        result: {3, {:scalar, nil}, {:message, Soulless.Lq.GameRoundPlayerResult}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :result,
          tag: 3,
          type: {:message, Soulless.Lq.GameRoundPlayerResult}
        }
      ]
    end
