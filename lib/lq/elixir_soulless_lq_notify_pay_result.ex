...
defmodule(Soulless.Lq.NotifyPayResult) do
  @moduledoc false
  (
    defstruct(
      pay_result: 0,
      ...
      [
        defp(encode_pay_result(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:pay_result, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_goods_id(acc, msg)) do
          try do
            if(msg.goods_id == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.goods_id)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_new_month_ticket(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:new_month_ticket, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_resource_modify(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:resource_modify, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyPayResult))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[
                   resource_modify:
                     msg.resource_modify ++
                       [Soulless.Lq.NotifyPayResult.ResourceModify.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        5 => {:resource_modify, :unpacked, {:message, Soulless.Lq.NotifyPayResult.ResourceModify}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        resource_modify: {5, :unpacked, {:message, Soulless.Lq.NotifyPayResult.ResourceModify}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 5,
          type: {:message, Soulless.Lq.NotifyPayResult.ResourceModify}
        }
      ]
    end
