...
defmodule(Soulless.Lq.ResShopInfo) do
  @moduledoc false
  (
    defstruct(error: nil, shop_info: nil, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_shop_info(msg) |> encode_unknown_fields(msg)
        end
      )
        ...
        defp(encode_shop_info(acc, msg)) do
          try do
            if(msg.shop_info == nil) do
              ...
              [acc, <<18>>, Protox.Encode.encode_message(msg.shop_info)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResShopInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   shop_info:
                     Protox.Message.merge(msg.shop_info, Soulless.Lq.ShopInfo.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:shop_info, {:scalar, nil}, {:message, Soulless.Lq.ShopInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        shop_info: {2, {:scalar, nil}, {:message, Soulless.Lq.ShopInfo}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :shop_info,
          tag: 2,
          type: {:message, Soulless.Lq.ShopInfo}
        }
      ]
    end
