    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResGameRecord))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                ...
                {[
                   head: Protox.Message.merge(msg.head, Soulless.Lq.RecordGame.decode!(delimited))
                 ], rest}
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :head,
          tag: 3,
          type: {:message, Soulless.Lq.RecordGame}
        },
        %{
          __struct__: Protox.Field,
          json_name: "data",
