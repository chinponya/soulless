...
defmodule(Soulless.Lq.RecordGame) do
  @moduledoc false
  (
    defstruct(
      uuid: "",
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordGame))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[
                   config:
                     Protox.Message.merge(msg.config, Soulless.Lq.GameConfig.decode!(delimited))
                 ], rest}
              ...
              {11, _, bytes} ->
                ...
                {[
                   accounts:
                     msg.accounts ++ [Soulless.Lq.RecordGame.AccountInfo.decode!(delimited)]
                 ], rest}
                ...
                {[
                   result:
                     Protox.Message.merge(
                       msg.result,
                       Soulless.Lq.GameEndResult.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        5 => {:config, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
        11 => {:accounts, :unpacked, {:message, Soulless.Lq.RecordGame.AccountInfo}},
        12 => {:result, {:scalar, nil}, {:message, Soulless.Lq.GameEndResult}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        accounts: {11, :unpacked, {:message, Soulless.Lq.RecordGame.AccountInfo}},
        config: {5, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
        end_time: {3, {:scalar, 0}, :uint32},
        result: {12, {:scalar, nil}, {:message, Soulless.Lq.GameEndResult}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :config,
          tag: 5,
          type: {:message, Soulless.Lq.GameConfig}
        },
        %{
          __struct__: Protox.Field,
          json_name: "accounts",
          ...
          name: :accounts,
          tag: 11,
          type: {:message, Soulless.Lq.RecordGame.AccountInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "result",
          ...
          name: :result,
          tag: 12,
          type: {:message, Soulless.Lq.GameEndResult}
        }
      ]
    end
