...
defmodule(Soulless.Lq.NotifyRoomPlayerUpdate) do
  @moduledoc false
  (
    defstruct(
      update_list: [],
      ...
      [
        defp(encode_update_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:update_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_remove_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:remove_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_owner_id(acc, msg)) do
          try do
            if(msg.owner_id == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.owner_id)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_player_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:player_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyRoomPlayerUpdate))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   update_list: msg.update_list ++ [Soulless.Lq.PlayerBaseView.decode!(delimited)]
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   player_list: msg.player_list ++ [Soulless.Lq.PlayerBaseView.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyRoomPlayerUpdate,
    ...
    def(defs()) do
      %{
        1 => {:update_list, :unpacked, {:message, Soulless.Lq.PlayerBaseView}},
        2 => {:remove_list, :packed, :uint32},
        3 => {:owner_id, {:scalar, 0}, :uint32},
        4 => {:robot_count, {:scalar, 0}, :uint32},
        5 => {:player_list, :unpacked, {:message, Soulless.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        player_list: {5, :unpacked, {:message, Soulless.Lq.PlayerBaseView}},
        remove_list: {2, :packed, :uint32},
        robot_count: {4, {:scalar, 0}, :uint32},
        seq: {6, {:scalar, 0}, :uint32},
        update_list: {1, :unpacked, {:message, Soulless.Lq.PlayerBaseView}}
      }
    end
