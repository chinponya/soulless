...
defmodule(Soulless.Lq.AccountUpdate) do
  @moduledoc false
  (
    defstruct(
      numerical: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountUpdate))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   numerical:
                     msg.numerical ++
                       [Soulless.Lq.AccountUpdate.NumericalUpdate.decode!(delimited)]
                 ], rest}
                ...
                {[
                   character:
                     Protox.Message.merge(
                       msg.character,
                       Soulless.Lq.AccountUpdate.CharacterUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {3, _, bytes} ->
                ...
                {[bag: Protox.Message.merge(msg.bag, Soulless.Lq.BagUpdate.decode!(delimited))],
                 rest}
              ...
              {4, _, bytes} ->
                ...
                {[
                   achievement:
                     Protox.Message.merge(
                       msg.achievement,
                       Soulless.Lq.AccountUpdate.AchievementUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   shilian:
                     Protox.Message.merge(
                       msg.shilian,
                       Soulless.Lq.AccountShiLian.decode!(delimited)
                     )
                 ], rest}
              ...
              {6, _, bytes} ->
                ...
                {[
                   daily_task:
                     Protox.Message.merge(
                       msg.daily_task,
                       Soulless.Lq.AccountUpdate.DailyTaskUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {7, _, bytes} ->
                ...
                {[
                   title:
                     Protox.Message.merge(
                       msg.title,
                       Soulless.Lq.AccountUpdate.TitleUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {9, _, bytes} ->
                ...
                {[
                   activity_task:
                     Protox.Message.merge(
                       msg.activity_task,
                       Soulless.Lq.AccountUpdate.TaskUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {13, _, bytes} ->
                ...
                {[
                   challenge:
                     Protox.Message.merge(
                       msg.challenge,
                       Soulless.Lq.AccountUpdate.AccountChallengeUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {14, _, bytes} ->
                ...
                {[
                   ab_match:
                     Protox.Message.merge(
                       msg.ab_match,
                       Soulless.Lq.AccountUpdate.AccountABMatchUpdate.decode!(delimited)
                     )
                 ], rest}
              ...
              {15, _, bytes} ->
                ...
                {[
                   activity:
                     Protox.Message.merge(
                       msg.activity,
                       Soulless.Lq.AccountUpdate.AccountActivityUpdate.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        1 => {:numerical, :unpacked, {:message, Soulless.Lq.AccountUpdate.NumericalUpdate}},
        2 => {:character, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.CharacterUpdate}},
        3 => {:bag, {:scalar, nil}, {:message, Soulless.Lq.BagUpdate}},
        4 =>
          {:achievement, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AchievementUpdate}},
        5 => {:shilian, {:scalar, nil}, {:message, Soulless.Lq.AccountShiLian}},
        6 => {:daily_task, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.DailyTaskUpdate}},
        7 => {:title, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TitleUpdate}},
        8 => {:new_recharged_list, :packed, :uint32},
        9 => {:activity_task, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        10 =>
          {:activity_flip_task, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        11 =>
          {:activity_period_task, {:scalar, nil},
           {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        12 =>
          {:activity_random_task, {:scalar, nil},
           {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        13 =>
          {:challenge, {:scalar, nil},
           {:message, Soulless.Lq.AccountUpdate.AccountChallengeUpdate}},
        14 =>
          {:ab_match, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate}},
        15 =>
          {:activity, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AccountActivityUpdate}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ab_match:
          {14, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate}},
        achievement: {4, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AchievementUpdate}},
        activity:
          {15, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AccountActivityUpdate}},
        activity_flip_task:
          {10, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        activity_period_task:
          {11, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        activity_random_task:
          {12, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        activity_task: {9, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TaskUpdate}},
        bag: {3, {:scalar, nil}, {:message, Soulless.Lq.BagUpdate}},
        challenge:
          {13, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.AccountChallengeUpdate}},
        character: {2, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.CharacterUpdate}},
        daily_task: {6, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.DailyTaskUpdate}},
        new_recharged_list: {8, :packed, :uint32},
        numerical: {1, :unpacked, {:message, Soulless.Lq.AccountUpdate.NumericalUpdate}},
        shilian: {5, {:scalar, nil}, {:message, Soulless.Lq.AccountShiLian}},
        title: {7, {:scalar, nil}, {:message, Soulless.Lq.AccountUpdate.TitleUpdate}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :numerical,
          tag: 1,
          type: {:message, Soulless.Lq.AccountUpdate.NumericalUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "character",
          ...
          name: :character,
          tag: 2,
          type: {:message, Soulless.Lq.AccountUpdate.CharacterUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "bag",
          ...
          name: :bag,
          tag: 3,
          type: {:message, Soulless.Lq.BagUpdate}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :achievement,
          tag: 4,
          type: {:message, Soulless.Lq.AccountUpdate.AchievementUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "shilian",
          ...
          name: :shilian,
          tag: 5,
          type: {:message, Soulless.Lq.AccountShiLian}
        },
        %{
          __struct__: Protox.Field,
          json_name: "dailyTask",
          ...
          name: :daily_task,
          tag: 6,
          type: {:message, Soulless.Lq.AccountUpdate.DailyTaskUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "title",
          ...
          name: :title,
          tag: 7,
          type: {:message, Soulless.Lq.AccountUpdate.TitleUpdate}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :activity_task,
          tag: 9,
          type: {:message, Soulless.Lq.AccountUpdate.TaskUpdate}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :challenge,
          tag: 13,
          type: {:message, Soulless.Lq.AccountUpdate.AccountChallengeUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "abMatch",
          ...
          name: :ab_match,
          tag: 14,
          type: {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "activity",
          ...
          name: :activity,
          tag: 15,
          type: {:message, Soulless.Lq.AccountUpdate.AccountActivityUpdate}
        }
      ]
    end
