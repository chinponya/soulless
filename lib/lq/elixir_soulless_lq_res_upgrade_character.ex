...
defmodule(Soulless.Lq.ResUpgradeCharacter) do
  @moduledoc false
  (
    defstruct(error: nil, character: nil, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_character(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResUpgradeCharacter))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResUpgradeCharacter,
    ...
    def(defs()) do
      %{
        ...
        2 => {:character, {:scalar, nil}, {:message, Soulless.Lq.Character}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        character: {2, {:scalar, nil}, {:message, Soulless.Lq.Character}},
