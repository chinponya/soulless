...
defmodule(Soulless.Lq.ActionNoTile) do
  @moduledoc false
  (
    defstruct(
      liujumanguan: false,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionNoTile))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[players: msg.players ++ [Soulless.Lq.NoTilePlayerInfo.decode!(delimited)]],
                 rest}

              {3, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[scores: msg.scores ++ [Soulless.Lq.NoTileScoreInfo.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:players, :unpacked, {:message, Soulless.Lq.NoTilePlayerInfo}},
        3 => {:scores, :unpacked, {:message, Soulless.Lq.NoTileScoreInfo}},
        4 => {:gameend, {:scalar, false}, :bool},
        5 => {:muyu, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        muyu: {5, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        players: {2, :unpacked, {:message, Soulless.Lq.NoTilePlayerInfo}},
        scores: {3, :unpacked, {:message, Soulless.Lq.NoTileScoreInfo}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :players,
          tag: 2,
          type: {:message, Soulless.Lq.NoTilePlayerInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "scores",
          ...
          name: :scores,
          tag: 3,
          type: {:message, Soulless.Lq.NoTileScoreInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gameend",
