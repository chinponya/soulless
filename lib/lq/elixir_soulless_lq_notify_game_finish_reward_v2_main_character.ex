...
defmodule(Soulless.Lq.NotifyGameFinishRewardV2.MainCharacter) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyGameFinishRewardV2.MainCharacter))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyGameFinishRewardV2.MainCharacter,
