...
defmodule(Soulless.Lq.ResOpenChest) do
  @moduledoc false
  (
    defstruct(
      error: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResOpenChest))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[results: msg.results ++ [Soulless.Lq.OpenResult.decode!(delimited)]], rest}
                ...
                {[
                   chest_replace_up:
                     msg.chest_replace_up ++
                       [Soulless.Lq.ResOpenChest.ChestReplaceCountData.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:results, :unpacked, {:message, Soulless.Lq.OpenResult}},
        3 => {:total_open_count, {:scalar, 0}, :uint32},
        4 => {:faith_count, {:scalar, 0}, :uint32},
        5 =>
          {:chest_replace_up, :unpacked,
           {:message, Soulless.Lq.ResOpenChest.ChestReplaceCountData}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        chest_replace_up:
          {5, :unpacked, {:message, Soulless.Lq.ResOpenChest.ChestReplaceCountData}},
        error: {1, {:scalar, nil}, {:message, Soulless.Lq.Error}},
        faith_count: {4, {:scalar, 0}, :uint32},
        results: {2, :unpacked, {:message, Soulless.Lq.OpenResult}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :results,
          tag: 2,
          type: {:message, Soulless.Lq.OpenResult}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          tag: 5,
          type: {:message, Soulless.Lq.ResOpenChest.ChestReplaceCountData}
        }
      ]
    end
