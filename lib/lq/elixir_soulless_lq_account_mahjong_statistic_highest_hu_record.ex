...
defmodule(Soulless.Lq.AccountMahjongStatistic.HighestHuRecord) do
  @moduledoc false
  (
    defstruct(
      fanshu: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountMahjongStatistic.HighestHuRecord))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountMahjongStatistic.HighestHuRecord,
