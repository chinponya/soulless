...
defmodule(Soulless.Lq.GameUserInput) do
  @moduledoc false
  (
        ...
        defp(encode_emo(acc, msg)) do
          try do
            if(msg.emo == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.emo)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameUserInput))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
                ...
                {[
                   operation:
                     Protox.Message.merge(
                       msg.operation,
                       Soulless.Lq.GameSelfOperation.decode!(delimited)
                     )
                 ], rest}
              ...
              {11, _, bytes} ->
                ...
                {[
                   cpg:
                     Protox.Message.merge(msg.cpg, Soulless.Lq.GameChiPengGang.decode!(delimited))
                 ], rest}
              ...
              {12, _, bytes} ->
                ...
                {[
                   vote:
                     Protox.Message.merge(
                       msg.vote,
                       Soulless.Lq.GameVoteGameEnd.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        10 => {:operation, {:scalar, nil}, {:message, Soulless.Lq.GameSelfOperation}},
        11 => {:cpg, {:scalar, nil}, {:message, Soulless.Lq.GameChiPengGang}},
        12 => {:vote, {:scalar, nil}, {:message, Soulless.Lq.GameVoteGameEnd}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        cpg: {11, {:scalar, nil}, {:message, Soulless.Lq.GameChiPengGang}},
        emo: {3, {:scalar, 0}, :uint32},
        operation: {10, {:scalar, nil}, {:message, Soulless.Lq.GameSelfOperation}},
        seat: {1, {:scalar, 0}, :uint32},
        type: {2, {:scalar, 0}, :uint32},
        vote: {12, {:scalar, nil}, {:message, Soulless.Lq.GameVoteGameEnd}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :operation,
          tag: 10,
          type: {:message, Soulless.Lq.GameSelfOperation}
        },
        %{
          __struct__: Protox.Field,
          json_name: "cpg",
          ...
          name: :cpg,
          tag: 11,
          type: {:message, Soulless.Lq.GameChiPengGang}
        },
        %{
          __struct__: Protox.Field,
          json_name: "vote",
          ...
          name: :vote,
          tag: 12,
          type: {:message, Soulless.Lq.GameVoteGameEnd}
        }
      ]
    end
