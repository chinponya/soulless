...
defmodule(Soulless.Lq.CommentItem) do
  @moduledoc false
  (
      ...
      [
        defp(encode_comment_id(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:comment_id, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_timestamp(acc, msg)) do
          try do
            if(msg.timestamp == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.timestamp)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_commenter(acc, msg)) do
          try do
            if(msg.commenter == nil) do
              ...
              [acc, <<26>>, Protox.Encode.encode_message(msg.commenter)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.CommentItem))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        3 => {:commenter, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        commenter: {3, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}},
