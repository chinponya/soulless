...
defmodule(Soulless.Lq.RecordChangeTile) do
  @moduledoc false
  (
    defstruct(
      doras: [],
      ...
      [
        ...
        defp(encode_change_tile_infos(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:change_tile_infos, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordChangeTile))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   tingpai:
                     msg.tingpai ++ [Soulless.Lq.RecordChangeTile.TingPai.decode!(delimited)]
                 ], rest}
                ...
                {[
                   change_tile_infos:
                     msg.change_tile_infos ++
                       [Soulless.Lq.RecordChangeTile.ChangeTile.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:tingpai, :unpacked, {:message, Soulless.Lq.RecordChangeTile.TingPai}},
        3 => {:change_tile_infos, :unpacked, {:message, Soulless.Lq.RecordChangeTile.ChangeTile}},
        4 => {:operation, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        5 => {:change_type, {:scalar, 0}, :uint32},
        6 => {:operations, :unpacked, {:message, Soulless.Lq.OptionalOperationList}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        change_tile_infos: {3, :unpacked, {:message, Soulless.Lq.RecordChangeTile.ChangeTile}},
        change_type: {5, {:scalar, 0}, :uint32},
        doras: {1, :unpacked, :string},
        operation: {4, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        operations: {6, :unpacked, {:message, Soulless.Lq.OptionalOperationList}},
        tingpai: {2, :unpacked, {:message, Soulless.Lq.RecordChangeTile.TingPai}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :tingpai,
          tag: 2,
          type: {:message, Soulless.Lq.RecordChangeTile.TingPai}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 3,
          type: {:message, Soulless.Lq.RecordChangeTile.ChangeTile}
        },
        %{
          __struct__: Protox.Field,
          json_name: "operation",
