...
defmodule(Soulless.Lq.PlayerBaseView) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PlayerBaseView))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        6 => {:level3, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
    ...
    def(defs_by_name()) do
      %{
        ...
        level3: {6, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
