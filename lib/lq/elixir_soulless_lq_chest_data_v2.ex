...
defmodule(Soulless.Lq.ChestDataV2) do
  @moduledoc false
  (
        ...
        defp(encode_face_black_count(acc, msg)) do
          try do
            if(msg.face_black_count == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.face_black_count)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ChestDataV2))
          end
        )
      )
