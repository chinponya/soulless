...
defmodule(Soulless.Lq.ResDailyTask) do
  @moduledoc false
  (
    defstruct(
      error: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResDailyTask))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:progresses, :unpacked, {:message, Soulless.Lq.TaskProgress}},
        3 => {:has_refresh_count, {:scalar, false}, :bool},
        4 => {:max_daily_task_count, {:scalar, 0}, :uint32},
        5 => {:refresh_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        max_daily_task_count: {4, {:scalar, 0}, :uint32},
        progresses: {2, :unpacked, {:message, Soulless.Lq.TaskProgress}},
        refresh_count: {5, {:scalar, 0}, :uint32}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "hasRefreshCount",
          kind: {:scalar, false},
          label: :optional,
          name: :has_refresh_count,
          tag: 3,
          type: :bool
        },
        %{
