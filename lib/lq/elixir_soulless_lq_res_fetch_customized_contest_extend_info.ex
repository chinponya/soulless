...
defmodule(Soulless.Lq.ResFetchCustomizedContestExtendInfo) do
  @moduledoc false
  (
      ...
      [
        ...
        defp(encode_extend_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:extend_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchCustomizedContestExtendInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   extend_list:
                     msg.extend_list ++ [Soulless.Lq.CustomizedContestExtend.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchCustomizedContestExtendInfo,
    ...
    def(defs()) do
      %{
        ...
        2 => {:extend_list, :unpacked, {:message, Soulless.Lq.CustomizedContestExtend}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        extend_list: {2, :unpacked, {:message, Soulless.Lq.CustomizedContestExtend}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :extend_list,
          tag: 2,
          type: {:message, Soulless.Lq.CustomizedContestExtend}
        }
      ]
    end
