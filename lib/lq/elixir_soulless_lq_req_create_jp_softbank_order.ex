...
defmodule(Soulless.Lq.ReqCreateJPSoftbankOrder) do
  @moduledoc false
  (
    defstruct(
      goods_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqCreateJPSoftbankOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ReqCreateJPSoftbankOrder,
