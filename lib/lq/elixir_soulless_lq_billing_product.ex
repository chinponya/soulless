...
defmodule(Soulless.Lq.BillingProduct) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.BillingProduct))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   goods:
                     Protox.Message.merge(msg.goods, Soulless.Lq.BillingGoods.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        1 => {:goods, {:scalar, nil}, {:message, Soulless.Lq.BillingGoods}},
    ...
    def(defs_by_name()) do
      %{
        ...
        goods: {1, {:scalar, nil}, {:message, Soulless.Lq.BillingGoods}},
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :goods,
          tag: 1,
          type: {:message, Soulless.Lq.BillingGoods}
        },
        %{
          __struct__: Protox.Field,
