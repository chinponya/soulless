...
defmodule(Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu,
