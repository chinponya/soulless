...
defmodule(Soulless.Lq.ReqOauth2Auth) do
  @moduledoc false
  (
    defstruct(type: 0, code: "", uid: "", client_version_string: "", __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqOauth2Auth))
          end
        )
      )
