...
defmodule(Soulless.Lq.ResArenaReward) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResArenaReward))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[items: msg.items ++ [Soulless.Lq.ResArenaReward.RewardItem.decode!(delimited)]],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:items, :unpacked, {:message, Soulless.Lq.ResArenaReward.RewardItem}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        items: {2, :unpacked, {:message, Soulless.Lq.ResArenaReward.RewardItem}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :items,
          tag: 2,
          type: {:message, Soulless.Lq.ResArenaReward.RewardItem}
        }
      ]
    end
