...
defmodule(Soulless.Lq.ReqLogin) do
  @moduledoc false
  (
    defstruct(
      account: "",
        ...
        defp(encode_version(acc, msg)) do
          try do
            if(msg.version == 0) do
              ...
              [acc, "P", Protox.Encode.encode_uint32(msg.version)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_client_version_string(acc, msg)) do
          try do
            if(msg.client_version_string == "") do
              ...
              [acc, "Z", Protox.Encode.encode_string(msg.client_version_string)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqLogin))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        10 => {:version, {:scalar, 0}, :uint32},
        11 => {:client_version_string, {:scalar, ""}, :string}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        client_version_string: {11, {:scalar, ""}, :string},
