...
defmodule(Soulless.Lq.ChuanmaGang) do
  @moduledoc false
  (
    defstruct(
      old_scores: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ChuanmaGang))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        4 => {:gameend, {:scalar, nil}, {:message, Soulless.Lq.GameEnd}},
        5 => {:hules_history, :unpacked, {:message, Soulless.Lq.HuleInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        gameend: {4, {:scalar, nil}, {:message, Soulless.Lq.GameEnd}},
        hules_history: {5, :unpacked, {:message, Soulless.Lq.HuleInfo}},
