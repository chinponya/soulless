...
defmodule(Soulless.Lq.ShopInfo) do
  @moduledoc false
  (
        ...
        defp(encode_last_refresh_time(acc, msg)) do
          try do
            if(msg.last_refresh_time == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.last_refresh_time)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:last_refresh_time, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ShopInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[zhp: Protox.Message.merge(msg.zhp, Soulless.Lq.ZHPShop.decode!(delimited))],
                 rest}
    ...
    def(defs()) do
      %{
        1 => {:zhp, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop}},
    ...
    def(defs_by_name()) do
      %{
        ...
        zhp: {1, {:scalar, nil}, {:message, Soulless.Lq.ZHPShop}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :zhp,
          tag: 1,
          type: {:message, Soulless.Lq.ZHPShop}
        },
        %{
          __struct__: Protox.Field,
