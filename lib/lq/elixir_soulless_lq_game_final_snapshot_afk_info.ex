...
defmodule(Soulless.Lq.GameFinalSnapshot.AFKInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameFinalSnapshot.AFKInfo))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.GameFinalSnapshot.AFKInfo,
