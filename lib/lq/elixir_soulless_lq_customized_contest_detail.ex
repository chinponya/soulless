...
defmodule(Soulless.Lq.CustomizedContestDetail) do
  @moduledoc false
  (
    defstruct(
      unique_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.CustomizedContestDetail))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {11, _, bytes} ->
                ...
                {[
                   game_mode:
                     Protox.Message.merge(msg.game_mode, Soulless.Lq.GameMode.decode!(delimited))
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.CustomizedContestDetail,
    ...
    def(defs()) do
      %{
        ...
        11 => {:game_mode, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
    ...
    def(defs_by_name()) do
      %{
        ...
        game_mode: {11, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
