...
defmodule(Soulless.Lq.GameSnapshot.PlayerSnapshot) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameSnapshot.PlayerSnapshot))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[
                   mings:
                     msg.mings ++
                       [Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.GameSnapshot.PlayerSnapshot,
    ...
    def(defs()) do
      %{
        ...
        5 => {:mings, :unpacked, {:message, Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        mings: {5, :unpacked, {:message, Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :mings,
          tag: 5,
          type: {:message, Soulless.Lq.GameSnapshot.PlayerSnapshot.Fulu}
        }
      ]
    end
