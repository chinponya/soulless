...
defmodule(Soulless.Lq.ResAuthGame) do
  @moduledoc false
  (
    defstruct(
      error: nil,
      ...
      [
        ...
        defp(encode_is_game_start(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:is_game_start, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_ready_id_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:ready_id_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAuthGame))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[players: msg.players ++ [Soulless.Lq.PlayerGameView.decode!(delimited)]], rest}
                ...
                {[
                   game_config:
                     Protox.Message.merge(
                       msg.game_config,
                       Soulless.Lq.GameConfig.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:players, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
        3 => {:seat_list, :packed, :uint32},
        4 => {:is_game_start, {:scalar, false}, :bool},
        5 => {:game_config, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
    ...
    def(defs_by_name()) do
      %{
        ...
        game_config: {5, {:scalar, nil}, {:message, Soulless.Lq.GameConfig}},
        is_game_start: {4, {:scalar, false}, :bool},
        players: {2, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
