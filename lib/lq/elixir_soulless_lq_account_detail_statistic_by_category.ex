...
defmodule(Soulless.Lq.AccountDetailStatisticByCategory) do
  @moduledoc false
  (
        ...
        defp(encode_detail_statistic(acc, msg)) do
          try do
            if(msg.detail_statistic == nil) do
              ...
              [acc, <<18>>, Protox.Encode.encode_message(msg.detail_statistic)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:detail_statistic, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountDetailStatisticByCategory))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountDetailStatisticByCategory,
    ...
    def(defs()) do
      %{
        ...
        2 => {:detail_statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        detail_statistic: {2, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}}
      }
    end
