...
defmodule(Soulless.Lq.AccountUpdate.AccountChallengeUpdate) do
  @moduledoc false
  (
    defstruct(
      progresses: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountUpdate.AccountChallengeUpdate))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[progresses: msg.progresses ++ [Soulless.Lq.TaskProgress.decode!(delimited)]],
                 rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountUpdate.AccountChallengeUpdate,
    ...
    def(defs()) do
      %{
        1 => {:progresses, :unpacked, {:message, Soulless.Lq.TaskProgress}},
    ...
    def(defs_by_name()) do
      %{
        ...
        progresses: {1, :unpacked, {:message, Soulless.Lq.TaskProgress}},
