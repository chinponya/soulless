...
defmodule(Soulless.Lq.ResCommonView) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResCommonView))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[slots: msg.slots ++ [Soulless.Lq.ResCommonView.Slot.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:slots, :unpacked, {:message, Soulless.Lq.ResCommonView.Slot}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        slots: {2, :unpacked, {:message, Soulless.Lq.ResCommonView.Slot}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :slots,
          tag: 2,
          type: {:message, Soulless.Lq.ResCommonView.Slot}
        }
      ]
    end
