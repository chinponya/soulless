...
defmodule(Soulless.Lq.AccountStatisticData) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountStatisticData))
          end
        )
      )
                ...
                {[
                   statistic:
                     Protox.Message.merge(
                       msg.statistic,
                       Soulless.Lq.AccountMahjongStatistic.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountStatisticData,
    ...
    def(defs()) do
      %{
        ...
        3 => {:statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountMahjongStatistic}},
    ...
    def(defs_by_name()) do
      %{
        ...
        statistic: {3, {:scalar, nil}, {:message, Soulless.Lq.AccountMahjongStatistic}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :statistic,
          tag: 3,
          type: {:message, Soulless.Lq.AccountMahjongStatistic}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gameType",
