...
defmodule(Soulless.Lq.ReqGameRecord) do
  @moduledoc false
  (
    defstruct(game_uuid: "", client_version_string: "", __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqGameRecord))
          end
        )
      )
