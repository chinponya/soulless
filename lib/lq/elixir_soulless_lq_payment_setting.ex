...
defmodule(Soulless.Lq.PaymentSetting) do
  @moduledoc false
  (
    defstruct(
      open_payment: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PaymentSetting))
          end
        )
      )
                ...
                {[
                   wechat:
                     Protox.Message.merge(
                       msg.wechat,
                       Soulless.Lq.PaymentSetting.WechatData.decode!(delimited)
                     )
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   alipay:
                     Protox.Message.merge(
                       msg.alipay,
                       Soulless.Lq.PaymentSetting.AlipayData.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        4 => {:wechat, {:scalar, nil}, {:message, Soulless.Lq.PaymentSetting.WechatData}},
        5 => {:alipay, {:scalar, nil}, {:message, Soulless.Lq.PaymentSetting.AlipayData}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        alipay: {5, {:scalar, nil}, {:message, Soulless.Lq.PaymentSetting.AlipayData}},
        open_payment: {1, {:scalar, 0}, :uint32},
        payment_info: {3, {:scalar, ""}, :string},
        payment_info_show_type: {2, {:scalar, 0}, :uint32},
        wechat: {4, {:scalar, nil}, {:message, Soulless.Lq.PaymentSetting.WechatData}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :wechat,
          tag: 4,
          type: {:message, Soulless.Lq.PaymentSetting.WechatData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "alipay",
          ...
          name: :alipay,
          tag: 5,
          type: {:message, Soulless.Lq.PaymentSetting.AlipayData}
        }
      ]
    end
