...
defmodule(Soulless.Lq.ResGameRecordList) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResGameRecordList))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                ...
                {[record_list: msg.record_list ++ [Soulless.Lq.RecordGame.decode!(delimited)]],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        3 => {:record_list, :unpacked, {:message, Soulless.Lq.RecordGame}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        record_list: {3, :unpacked, {:message, Soulless.Lq.RecordGame}},
