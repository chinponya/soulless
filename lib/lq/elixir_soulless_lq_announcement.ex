...
defmodule(Soulless.Lq.Announcement) do
  @moduledoc false
  (
        ...
        defp(encode_title(acc, msg)) do
          try do
            if(msg.title == "") do
              ...
              [acc, <<18>>, Protox.Encode.encode_string(msg.title)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.Announcement))
          end
        )
      )
