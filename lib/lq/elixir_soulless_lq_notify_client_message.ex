...
defmodule(Soulless.Lq.NotifyClientMessage) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyClientMessage))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyClientMessage,
    ...
    def(defs()) do
      %{
        1 => {:sender, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        sender: {1, {:scalar, nil}, {:message, Soulless.Lq.PlayerBaseView}},
