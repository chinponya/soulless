...
defmodule(Soulless.Lq.NotifyAccountChallengeTaskUpdate) do
  @moduledoc false
  (
    defstruct(
      progresses: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyAccountChallengeTaskUpdate))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyAccountChallengeTaskUpdate,
