...
defmodule(Soulless.Lq.ResFetchActivityFlipInfo) do
  @moduledoc false
  (
    defstruct(rewards: [], count: 0, error: nil, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchActivityFlipInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, 2, bytes} ->
                ...
                {[rewards: msg.rewards ++ Protox.Decode.parse_repeated_uint32([], delimited)],
                 rest}

              {1, _, bytes} ->
                {value, rest} = Protox.Decode.parse_uint32(bytes)
                {[rewards: msg.rewards ++ [value]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchActivityFlipInfo,
