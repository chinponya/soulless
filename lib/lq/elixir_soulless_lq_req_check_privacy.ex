...
defmodule(Soulless.Lq.ReqCheckPrivacy) do
  @moduledoc false
  (
      ...
      [
        defp(encode_device_type(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:device_type, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqCheckPrivacy))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   versions:
                     msg.versions ++ [Soulless.Lq.ReqCheckPrivacy.Versions.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:versions, :unpacked, {:message, Soulless.Lq.ReqCheckPrivacy.Versions}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        versions: {2, :unpacked, {:message, Soulless.Lq.ReqCheckPrivacy.Versions}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :versions,
          tag: 2,
          type: {:message, Soulless.Lq.ReqCheckPrivacy.Versions}
        }
      ]
    end
