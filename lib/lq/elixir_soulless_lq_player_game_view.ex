...
defmodule(Soulless.Lq.PlayerGameView) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
        ...
        defp(encode_avatar_id(acc, msg)) do
          try do
            if(msg.avatar_id == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.avatar_id)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_title(acc, msg)) do
          try do
            if(msg.title == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.title)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.PlayerGameView))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {6, _, bytes} ->
                ...
                {[
                   character:
                     Protox.Message.merge(msg.character, Soulless.Lq.Character.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        5 => {:level, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        6 => {:character, {:scalar, nil}, {:message, Soulless.Lq.Character}},
        7 => {:level3, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        8 => {:avatar_frame, {:scalar, 0}, :uint32},
        9 => {:verified, {:scalar, 0}, :uint32},
        10 => {:views, :unpacked, {:message, Soulless.Lq.ViewSlot}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        character: {6, {:scalar, nil}, {:message, Soulless.Lq.Character}},
        level: {5, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        level3: {7, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        nickname: {4, {:scalar, ""}, :string},
        title: {3, {:scalar, 0}, :uint32},
        verified: {9, {:scalar, 0}, :uint32},
        views: {10, :unpacked, {:message, Soulless.Lq.ViewSlot}}
      }
    end
