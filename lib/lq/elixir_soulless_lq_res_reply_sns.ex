...
defmodule(Soulless.Lq.ResReplySNS) do
  @moduledoc false
  (
        ...
        defp(encode_sns_reply(acc, msg)) do
          try do
            if(msg.sns_reply == nil) do
              ...
              [acc, <<18>>, Protox.Encode.encode_message(msg.sns_reply)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResReplySNS))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   sns_reply:
                     Protox.Message.merge(msg.sns_reply, Soulless.Lq.SNSReply.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:sns_reply, {:scalar, nil}, {:message, Soulless.Lq.SNSReply}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        sns_reply: {2, {:scalar, nil}, {:message, Soulless.Lq.SNSReply}}
      }
    end
