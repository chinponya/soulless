...
defmodule(Soulless.Lq.AccountActiveState) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountActiveState))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountActiveState,
    ...
    def(defs()) do
      %{
        ...
        5 => {:playing, {:scalar, nil}, {:message, Soulless.Lq.AccountPlayingGame}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        playing: {5, {:scalar, nil}, {:message, Soulless.Lq.AccountPlayingGame}}
      }
    end
