...
defmodule(Soulless.Lq.ReqOauth2Signup) do
  @moduledoc false
  (
    defstruct(
      type: 0,
      ...
      [
        ...
        defp(encode_access_token(acc, msg)) do
          try do
            if(msg.access_token == "") do
              ...
              [acc, <<18>>, Protox.Encode.encode_string(msg.access_token)]
            end
          rescue
            ArgumentError ->
              reraise(
        ...
        defp(encode_email(acc, msg)) do
          try do
            if(msg.email == "") do
              ...
              [acc, <<26>>, Protox.Encode.encode_string(msg.email)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_advertise_str(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:advertise_str, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqOauth2Signup))
          end
        )
      )
              ...
              {6, _, bytes} ->
                ...
                {[
                   client_version:
                     Protox.Message.merge(
                       msg.client_version,
                       Soulless.Lq.ClientVersionInfo.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        5 => {:device, {:scalar, nil}, {:message, Soulless.Lq.ClientDeviceInfo}},
        6 => {:client_version, {:scalar, nil}, {:message, Soulless.Lq.ClientVersionInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        client_version: {6, {:scalar, nil}, {:message, Soulless.Lq.ClientVersionInfo}},
        client_version_string: {7, {:scalar, ""}, :string},
        device: {5, {:scalar, nil}, {:message, Soulless.Lq.ClientDeviceInfo}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :client_version,
          tag: 6,
          type: {:message, Soulless.Lq.ClientVersionInfo}
        },
        %{
          __struct__: Protox.Field,
