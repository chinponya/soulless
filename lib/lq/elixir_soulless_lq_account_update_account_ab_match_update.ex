...
defmodule(Soulless.Lq.AccountUpdate.AccountABMatchUpdate) do
  @moduledoc false
  (
    defstruct(
      match_id: 0,
        ...
        defp(encode_match_count(acc, msg)) do
          try do
            if(msg.match_count == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.match_count)]
            end
          rescue
            ArgumentError ->
              reraise(
        ...
        defp(encode_buy_in_count(acc, msg)) do
          try do
            if(msg.buy_in_count == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.buy_in_count)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountUpdate.AccountABMatchUpdate))
          end
        )
      )
              ...
              {6, _, bytes} ->
                ...
                {[
                   match_max_point:
                     msg.match_max_point ++
                       [
                         Soulless.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint.decode!(
                           delimited
                         )
                       ]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountUpdate.AccountABMatchUpdate,
      ...
      %{
        ...
        6 =>
          {:match_max_point, :unpacked,
           {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint}},
    ...
    def(defs_by_name()) do
      %{
        ...
        match_max_point:
          {6, :unpacked, {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 6,
          type: {:message, Soulless.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint}
        },
        %{
          __struct__: Protox.Field,
          json_name: "quit",
