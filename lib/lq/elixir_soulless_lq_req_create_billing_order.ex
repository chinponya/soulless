...
defmodule(Soulless.Lq.ReqCreateBillingOrder) do
  @moduledoc false
  (
    ...
    (
      ...
      [
        ...
        defp(encode_payment_platform(acc, msg)) do
          try do
            if(msg.payment_platform == 0) do
              acc
            else
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.payment_platform)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:payment_platform, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_client_type(acc, msg)) do
          try do
            if(msg.client_type == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.client_type)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqCreateBillingOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ReqCreateBillingOrder,
    ...
    [
      ...
      (
        def(field_def(:payment_platform)) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "paymentPlatform",
        ...
        def(field_def("paymentPlatform")) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "paymentPlatform",
    ...
    [
      ...
      def(default(:payment_platform)) do
        {:ok, 0}
      end,
