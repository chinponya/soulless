...
defmodule(Soulless.Lq.GameRoundHuData) do
  @moduledoc false
  (
    defstruct(
      hupai: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameRoundHuData))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
                ...
                {[
                   hupai:
                     Protox.Message.merge(
                       msg.hupai,
                       Soulless.Lq.GameRoundHuData.HuPai.decode!(delimited)
                     )
                 ], rest}
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[fans: msg.fans ++ [Soulless.Lq.GameRoundHuData.Fan.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        1 => {:hupai, {:scalar, nil}, {:message, Soulless.Lq.GameRoundHuData.HuPai}},
        2 => {:fans, :unpacked, {:message, Soulless.Lq.GameRoundHuData.Fan}},
    ...
    def(defs_by_name()) do
      %{
        ...
        fans: {2, :unpacked, {:message, Soulless.Lq.GameRoundHuData.Fan}},
        fu_sum: {7, {:scalar, 0}, :uint32},
        hupai: {1, {:scalar, nil}, {:message, Soulless.Lq.GameRoundHuData.HuPai}},
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :hupai,
          tag: 1,
          type: {:message, Soulless.Lq.GameRoundHuData.HuPai}
        },
        %{
          __struct__: Protox.Field,
          json_name: "fans",
          ...
          name: :fans,
          tag: 2,
          type: {:message, Soulless.Lq.GameRoundHuData.Fan}
        },
        %{
          __struct__: Protox.Field,
          json_name: "score",
