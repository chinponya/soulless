...
defmodule(Soulless.Lq.RecordSelectGap) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordSelectGap))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   tingpai:
                     msg.tingpai ++ [Soulless.Lq.RecordSelectGap.TingPai.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:tingpai, :unpacked, {:message, Soulless.Lq.RecordSelectGap.TingPai}},
        3 => {:operation, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        operation: {3, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        tingpai: {2, :unpacked, {:message, Soulless.Lq.RecordSelectGap.TingPai}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :tingpai,
          tag: 2,
          type: {:message, Soulless.Lq.RecordSelectGap.TingPai}
        },
        %{
          __struct__: Protox.Field,
          json_name: "operation",
