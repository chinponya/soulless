...
defmodule(Soulless.Lq.ReqCreateNickname) do
  @moduledoc false
  (
        ...
        defp(encode_advertise_str(acc, msg)) do
          try do
            if(msg.advertise_str == "") do
              ...
              [acc, <<18>>, Protox.Encode.encode_string(msg.advertise_str)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqCreateNickname))
          end
        )
      )
