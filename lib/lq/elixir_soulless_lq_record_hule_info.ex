...
defmodule(Soulless.Lq.RecordHuleInfo) do
  @moduledoc false
  (
    defstruct(
      hand: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordHuleInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {12, _, bytes} ->
                ...
                {[
                   fans: msg.fans ++ [Soulless.Lq.RecordHuleInfo.RecordFanInfo.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        12 => {:fans, :unpacked, {:message, Soulless.Lq.RecordHuleInfo.RecordFanInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        fans: {12, :unpacked, {:message, Soulless.Lq.RecordHuleInfo.RecordFanInfo}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :fans,
          tag: 12,
          type: {:message, Soulless.Lq.RecordHuleInfo.RecordFanInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "fu",
