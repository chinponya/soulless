...
defmodule(Soulless.Lq.ResFetchRefundOrder.OrderInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchRefundOrder.OrderInfo))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchRefundOrder.OrderInfo,
    ...
    def(defs()) do
      %{
        ...
        3 => {:cleared, {:scalar, 0}, :uint32},
        4 => {:order_id, {:scalar, ""}, :string}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        order_id: {4, {:scalar, ""}, :string},
        success_time: {1, {:scalar, 0}, :uint32}
      }
    end
