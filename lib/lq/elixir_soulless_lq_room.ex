  ...
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.Room))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[persons: msg.persons ++ [Soulless.Lq.PlayerGameView.decode!(delimited)]], rest}
              ...
              {6, 2, bytes} ->
                ...
                {[
                   ready_list:
                     msg.ready_list ++ Protox.Decode.parse_repeated_uint32([], delimited)
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        3 => {:mode, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
        4 => {:max_player_count, {:scalar, 0}, :uint32},
        5 => {:persons, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        mode: {3, {:scalar, nil}, {:message, Soulless.Lq.GameMode}},
        owner_id: {2, {:scalar, 0}, :uint32},
        persons: {5, :unpacked, {:message, Soulless.Lq.PlayerGameView}},
