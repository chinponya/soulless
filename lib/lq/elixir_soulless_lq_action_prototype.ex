...
defmodule(Soulless.Lq.ActionPrototype) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionPrototype))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        3 => {:data, {:scalar, nil}, {:message, Soulless.Lq.Wrapper}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        data: {3, {:scalar, nil}, {:message, Soulless.Lq.Wrapper}},
