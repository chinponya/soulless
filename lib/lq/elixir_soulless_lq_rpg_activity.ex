...
defmodule(Soulless.Lq.RPGActivity) do
  @moduledoc false
  (
    defstruct(
      activity_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RPGActivity))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        7 => {:current_state, {:scalar, nil}, {:message, Soulless.Lq.RPGState}},
        8 => {:last_show_state, {:scalar, nil}, {:message, Soulless.Lq.RPGState}},
    ...
    def(defs_by_name()) do
      %{
        ...
        current_state: {7, {:scalar, nil}, {:message, Soulless.Lq.RPGState}},
        last_played_uuid: {6, {:scalar, ""}, :string},
        last_show_state: {8, {:scalar, nil}, {:message, Soulless.Lq.RPGState}},
