...
defmodule(Soulless.Lq.ResReceiveChallengeRankReward.Reward) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResReceiveChallengeRankReward.Reward))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResReceiveChallengeRankReward.Reward,
