...
defmodule(Soulless.Lq.RecordDiscardTile) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordDiscardTile))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        10 => {:operations, :unpacked, {:message, Soulless.Lq.OptionalOperationList}},
        11 => {:tile_state, {:scalar, 0}, :uint32},
        12 => {:muyu, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        muyu: {12, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        operations: {10, :unpacked, {:message, Soulless.Lq.OptionalOperationList}},
