...
defmodule(Soulless.Lq.AccountMahjongStatistic.RoundSummary) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.AccountMahjongStatistic.RoundSummary))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountMahjongStatistic.RoundSummary,
