...
defmodule(Soulless.Lq.ActionNewRound) do
  @moduledoc false
  (
    defstruct(
      chang: 0,
        ...
        defp(encode_muyu(acc, msg)) do
          try do
            if(msg.muyu == nil) do
              ...
              [acc, <<130, 1>>, Protox.Encode.encode_message(msg.muyu)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_ju_count(acc, msg)) do
          try do
            if(msg.ju_count == 0) do
              ...
              [acc, <<136, 1>>, Protox.Encode.encode_uint32(msg.ju_count)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_new_tile(acc, msg)) do
          try do
            if(msg.new_tile == "") do
              ...
              [acc, <<146, 1>>, Protox.Encode.encode_string(msg.new_tile)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionNewRound))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {9, _, bytes} ->
                ...
                {[
                   tingpais0: msg.tingpais0 ++ [Soulless.Lq.TingPaiDiscardInfo.decode!(delimited)]
                 ], rest}

              {10, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[tingpais1: msg.tingpais1 ++ [Soulless.Lq.TingPaiInfo.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        ...
        9 => {:tingpais0, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        10 => {:tingpais1, :unpacked, {:message, Soulless.Lq.TingPaiInfo}},
        11 => {:al, {:scalar, false}, :bool},
        12 => {:md5, {:scalar, ""}, :string},
        13 => {:left_tile_count, {:scalar, 0}, :uint32},
        14 => {:doras, :unpacked, :string},
        15 => {:opens, :unpacked, {:message, Soulless.Lq.NewRoundOpenedTiles}},
        16 => {:muyu, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        muyu: {16, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        new_tile: {18, {:scalar, ""}, :string},
        opens: {15, :unpacked, {:message, Soulless.Lq.NewRoundOpenedTiles}},
        operation: {7, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        scores: {6, :packed, :int32},
        tiles: {4, :unpacked, :string},
        tingpais0: {9, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
        tingpais1: {10, :unpacked, {:message, Soulless.Lq.TingPaiInfo}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :tingpais0,
          tag: 9,
          type: {:message, Soulless.Lq.TingPaiDiscardInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "tingpais1",
