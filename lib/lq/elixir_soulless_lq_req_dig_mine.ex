...
defmodule(Soulless.Lq.ReqDigMine) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ReqDigMine))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        2 => {:point, {:scalar, nil}, {:message, Soulless.Lq.Point}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        point: {2, {:scalar, nil}, {:message, Soulless.Lq.Point}}
      }
    end
