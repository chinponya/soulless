...
defmodule(Soulless.Lq.ResRichmanNextMove) do
  @moduledoc false
  (
    defstruct(
      paths: [],
      ...
      [
        ...
        defp(encode_dice(acc, msg)) do
          try do
            if(msg.dice == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.dice)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_location(acc, msg)) do
          try do
            if(msg.location == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.location)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_bank_save_add(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:bank_save_add, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResRichmanNextMove))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   paths:
                     msg.paths ++ [Soulless.Lq.ResRichmanNextMove.PathData.decode!(delimited)]
                 ], rest}
              ...
              {6, _, bytes} ->
                ...
                {[buff: msg.buff ++ [Soulless.Lq.ResRichmanNextMove.BuffData.decode!(delimited)]],
                 rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResRichmanNextMove,
    ...
    def(defs_by_name()) do
      %{
        ...
        buff: {6, :unpacked, {:message, Soulless.Lq.ResRichmanNextMove.BuffData}},
        chest_position: {8, {:scalar, 0}, :uint32},
        dice: {2, {:scalar, 0}, :uint32},
        error: {11, {:scalar, nil}, {:message, Soulless.Lq.Error}},
        exp: {9, {:scalar, 0}, :uint32},
        finished_count: {4, {:scalar, 0}, :uint32},
        location: {3, {:scalar, 0}, :uint32},
        paths: {1, :unpacked, {:message, Soulless.Lq.ResRichmanNextMove.PathData}},
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :paths,
          tag: 1,
          type: {:message, Soulless.Lq.ResRichmanNextMove.PathData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "dice",
        ...
        %{
          ...
          name: :buff,
          tag: 6,
          type: {:message, Soulless.Lq.ResRichmanNextMove.BuffData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "bankSave",
