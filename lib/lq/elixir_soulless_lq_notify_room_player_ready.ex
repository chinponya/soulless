...
defmodule(Soulless.Lq.NotifyRoomPlayerReady) do
  @moduledoc false
  (
        ...
        defp(encode_ready(acc, msg)) do
          try do
            if(msg.ready == false) do
              ...
              [acc, <<16>>, Protox.Encode.encode_bool(msg.ready)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyRoomPlayerReady))
          end
        )
      )
                ...
                {[
                   account_list:
                     Protox.Message.merge(
                       msg.account_list,
                       Soulless.Lq.NotifyRoomPlayerReady.AccountReadyState.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyRoomPlayerReady,
      ...
      %{
        ...
        3 =>
          {:account_list, {:scalar, nil},
           {:message, Soulless.Lq.NotifyRoomPlayerReady.AccountReadyState}},
    ...
    def(defs_by_name()) do
      %{
        ...
        account_list:
          {3, {:scalar, nil}, {:message, Soulless.Lq.NotifyRoomPlayerReady.AccountReadyState}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :account_list,
          tag: 3,
          type: {:message, Soulless.Lq.NotifyRoomPlayerReady.AccountReadyState}
        },
        %{
          __struct__: Protox.Field,
          json_name: "seq",
