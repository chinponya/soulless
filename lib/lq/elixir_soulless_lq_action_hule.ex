...
defmodule(Soulless.Lq.ActionHule) do
  @moduledoc false
  (
    defstruct(
      hules: [],
      ...
      [
        ...
        defp(encode_wait_timeout(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:wait_timeout, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        ...
        defp(encode_baopai(acc, msg)) do
          try do
            if(msg.baopai == 0) do
              ...
              [acc, "H", Protox.Encode.encode_int32(msg.baopai)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionHule))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[hules: msg.hules ++ [Soulless.Lq.HuleInfo.decode!(delimited)]], rest}
    ...
    def(defs()) do
      %{
        1 => {:hules, :unpacked, {:message, Soulless.Lq.HuleInfo}},
        2 => {:old_scores, :packed, :int32},
        3 => {:delta_scores, :packed, :int32},
        4 => {:wait_timeout, {:scalar, 0}, :uint32},
        5 => {:scores, :packed, :int32},
        6 => {:gameend, {:scalar, nil}, {:message, Soulless.Lq.GameEnd}},
    ...
    def(defs_by_name()) do
      %{
        baopai: {9, {:scalar, 0}, :int32},
        delta_scores: {3, :packed, :int32},
        doras: {7, :unpacked, :string},
        gameend: {6, {:scalar, nil}, {:message, Soulless.Lq.GameEnd}},
        hules: {1, :unpacked, {:message, Soulless.Lq.HuleInfo}},
        muyu: {8, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
        old_scores: {2, :packed, :int32},
        scores: {5, :packed, :int32},
        wait_timeout: {4, {:scalar, 0}, :uint32}
      }
    end
