...
defmodule(Soulless.Lq.NotifyGameFinishRewardV2.MatchChest) do
  @moduledoc false
  (
        ...
        defp(encode_origin(acc, msg)) do
          try do
            if(msg.origin == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.origin)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_final(acc, msg)) do
          try do
            if(msg.final == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.final)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyGameFinishRewardV2.MatchChest))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[rewards: msg.rewards ++ [Soulless.Lq.RewardSlot.decode!(delimited)]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyGameFinishRewardV2.MatchChest,
    ...
    def(defs()) do
      %{
        ...
        5 => {:rewards, :unpacked, {:message, Soulless.Lq.RewardSlot}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        rewards: {5, :unpacked, {:message, Soulless.Lq.RewardSlot}}
      }
    end
