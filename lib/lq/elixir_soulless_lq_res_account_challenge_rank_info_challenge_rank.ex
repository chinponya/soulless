...
defmodule(Soulless.Lq.ResAccountChallengeRankInfo.ChallengeRank) do
  @moduledoc false
  (
    defstruct(season: 0, rank: 0, level: 0, __uf__: [])
        ...
        defp(encode_level(acc, msg)) do
          try do
            if(msg.level == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.level)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResAccountChallengeRankInfo.ChallengeRank))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResAccountChallengeRankInfo.ChallengeRank,
