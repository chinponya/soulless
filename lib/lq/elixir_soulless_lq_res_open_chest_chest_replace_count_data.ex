...
defmodule(Soulless.Lq.ResOpenChest.ChestReplaceCountData) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResOpenChest.ChestReplaceCountData))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResOpenChest.ChestReplaceCountData,
