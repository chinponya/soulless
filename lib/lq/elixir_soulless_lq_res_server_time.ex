...
defmodule(Soulless.Lq.ResServerTime) do
  @moduledoc false
  (
    ...
    (
      ...
      [
        defp(encode_server_time(acc, msg)) do
          try do
            if(msg.server_time == 0) do
              acc
            else
              [acc, "\b", Protox.Encode.encode_uint32(msg.server_time)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:server_time, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResServerTime))
          end
        )
      )
