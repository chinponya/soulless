...
defmodule(Soulless.Lq.ActionChiPengGang) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionChiPengGang))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {8, _, bytes} ->
                ...
                {[tingpais: msg.tingpais ++ [Soulless.Lq.TingPaiDiscardInfo.decode!(delimited)]],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:operation, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        7 => {:zhenting, {:scalar, false}, :bool},
        8 => {:tingpais, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
    ...
    def(defs_by_name()) do
      %{
        ...
        operation: {6, {:scalar, nil}, {:message, Soulless.Lq.OptionalOperationList}},
        seat: {1, {:scalar, 0}, :uint32},
        tile_states: {9, :packed, :uint32},
        tiles: {3, :unpacked, :string},
        tingpais: {8, :unpacked, {:message, Soulless.Lq.TingPaiDiscardInfo}},
