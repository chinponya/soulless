...
defmodule(Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic) do
  @moduledoc false
  (
      ...
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(
              bytes,
              struct(Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic)
            )
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.AccountDetailStatisticV2.CustomizedContestStatistic,
    ...
    def(defs()) do
      %{
        1 => {:total_statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        2 => {:month_statistic, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
    ...
    def(defs_by_name()) do
      %{
        ...
        month_statistic: {2, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}},
        total_statistic: {1, {:scalar, nil}, {:message, Soulless.Lq.AccountDetailStatistic}}
      }
    end
