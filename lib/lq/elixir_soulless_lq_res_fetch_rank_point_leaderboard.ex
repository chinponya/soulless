...
defmodule(Soulless.Lq.ResFetchRankPointLeaderboard) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResFetchRankPointLeaderboard))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   items:
                     msg.items ++
                       [Soulless.Lq.ResFetchRankPointLeaderboard.Item.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResFetchRankPointLeaderboard,
    ...
    def(defs()) do
      %{
        ...
        2 => {:items, :unpacked, {:message, Soulless.Lq.ResFetchRankPointLeaderboard.Item}},
    ...
    def(defs_by_name()) do
      %{
        ...
        items: {2, :unpacked, {:message, Soulless.Lq.ResFetchRankPointLeaderboard.Item}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :items,
          tag: 2,
          type: {:message, Soulless.Lq.ResFetchRankPointLeaderboard.Item}
        },
        %{
          __struct__: Protox.Field,
