...
defmodule(Soulless.Lq.ResRichmanNextMove.RewardData) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResRichmanNextMove.RewardData))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ResRichmanNextMove.RewardData,
    ...
    def(defs()) do
      %{
        ...
        3 => {:origin_count, {:scalar, 0}, :uint32},
        5 => {:type, {:scalar, 0}, :uint32}
      }
    end
