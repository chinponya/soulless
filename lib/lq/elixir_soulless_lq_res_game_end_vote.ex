...
defmodule(Soulless.Lq.ResGameEndVote) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResGameEndVote))
          end
        )
      )
    ...
    def(defs_by_name()) do
      %{
        ...
        vote_cd_end_time: {2, {:scalar, 0}, :uint32}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "voteCdEndTime",
          kind: {:scalar, 0},
          label: :optional,
          name: :vote_cd_end_time,
          tag: 2,
          type: :uint32
        },
        %{
