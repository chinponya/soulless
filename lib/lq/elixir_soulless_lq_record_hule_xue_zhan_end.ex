...
defmodule(Soulless.Lq.RecordHuleXueZhanEnd) do
  @moduledoc false
  (
    defstruct(
      hules: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.RecordHuleXueZhanEnd))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[hules: msg.hules ++ [Soulless.Lq.HuInfoXueZhanMid.decode!(delimited)]], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.RecordHuleXueZhanEnd,
    ...
    def(defs()) do
      %{
        1 => {:hules, :unpacked, {:message, Soulless.Lq.HuInfoXueZhanMid}},
    ...
    def(defs_by_name()) do
      %{
        ...
        hules: {1, :unpacked, {:message, Soulless.Lq.HuInfoXueZhanMid}},
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :hules,
          tag: 1,
          type: {:message, Soulless.Lq.HuInfoXueZhanMid}
        },
        %{
          __struct__: Protox.Field,
          json_name: "oldScores",
