...
defmodule(Soulless.Lq.ContestDetailRuleV2) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ContestDetailRuleV2))
          end
        )
      )
                ...
                {[
                   game_rule:
                     Protox.Message.merge(
                       msg.game_rule,
                       Soulless.Lq.ContestDetailRule.decode!(delimited)
                     )
                 ], rest}
              ...
              {2, _, bytes} ->
                ...
                {[
                   extra_rule:
                     Protox.Message.merge(
                       msg.extra_rule,
                       Soulless.Lq.ContestDetailRuleV2.ExtraRule.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ContestDetailRuleV2,
    ...
    def(defs()) do
      %{
        1 => {:game_rule, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRule}},
        2 => {:extra_rule, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRuleV2.ExtraRule}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        extra_rule: {2, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRuleV2.ExtraRule}},
        game_rule: {1, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRule}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :game_rule,
          tag: 1,
          type: {:message, Soulless.Lq.ContestDetailRule}
        },
        %{
          __struct__: Protox.Field,
          json_name: "extraRule",
          ...
          name: :extra_rule,
          tag: 2,
          type: {:message, Soulless.Lq.ContestDetailRuleV2.ExtraRule}
        }
      ]
    end
