...
defmodule(Soulless.Lq.GameRuleSetting) do
  @moduledoc false
  (
    defstruct(
      round_type: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameRuleSetting))
          end
        )
      )
                ...
                {[
                   detail_rule_v2:
                     Protox.Message.merge(
                       msg.detail_rule_v2,
                       Soulless.Lq.ContestDetailRuleV2.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:detail_rule_v2, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRuleV2}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        detail_rule_v2: {6, {:scalar, nil}, {:message, Soulless.Lq.ContestDetailRuleV2}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :detail_rule_v2,
          tag: 6,
          type: {:message, Soulless.Lq.ContestDetailRuleV2}
        }
      ]
    end
