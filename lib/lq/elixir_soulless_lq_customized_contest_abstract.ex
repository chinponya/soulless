...
defmodule(Soulless.Lq.CustomizedContestAbstract) do
  @moduledoc false
  (
    defstruct(
      unique_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.CustomizedContestAbstract))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.CustomizedContestAbstract,
