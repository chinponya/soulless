...
defmodule(Soulless.Lq.GameMode) do
  @moduledoc false
  (
    defstruct(
      mode: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameMode))
          end
        )
      )
                ...
                {[
                   detail_rule:
                     Protox.Message.merge(
                       msg.detail_rule,
                       Soulless.Lq.GameDetailRule.decode!(delimited)
                     )
                 ], rest}
                ...
                {[
                   testing_environment:
                     Protox.Message.merge(
                       ...
                       Soulless.Lq.GameTestingEnvironmentSet.decode!(delimited)
                     )
                 ], rest}
              ...
              {8, _, bytes} ->
                ...
                {[
                   game_setting:
                     Protox.Message.merge(
                       msg.game_setting,
                       Soulless.Lq.GameSetting.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:detail_rule, {:scalar, nil}, {:message, Soulless.Lq.GameDetailRule}},
        7 =>
          {:testing_environment, {:scalar, nil},
           {:message, Soulless.Lq.GameTestingEnvironmentSet}},
        8 => {:game_setting, {:scalar, nil}, {:message, Soulless.Lq.GameSetting}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        detail_rule: {6, {:scalar, nil}, {:message, Soulless.Lq.GameDetailRule}},
        extendinfo: {5, {:scalar, ""}, :string},
        game_setting: {8, {:scalar, nil}, {:message, Soulless.Lq.GameSetting}},
        mode: {1, {:scalar, 0}, :uint32},
        testing_environment:
          {7, {:scalar, nil}, {:message, Soulless.Lq.GameTestingEnvironmentSet}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :detail_rule,
          tag: 6,
          type: {:message, Soulless.Lq.GameDetailRule}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 7,
          type: {:message, Soulless.Lq.GameTestingEnvironmentSet}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :game_setting,
          tag: 8,
          type: {:message, Soulless.Lq.GameSetting}
        }
      ]
    end
