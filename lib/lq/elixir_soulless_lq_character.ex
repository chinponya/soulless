...
defmodule(Soulless.Lq.Character) do
  @moduledoc false
  (
    defstruct(
      charid: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.Character))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        4 => {:views, :unpacked, {:message, Soulless.Lq.ViewSlot}},
    ...
    def(defs_by_name()) do
      %{
        ...
        views: {4, :unpacked, {:message, Soulless.Lq.ViewSlot}}
      }
    end
