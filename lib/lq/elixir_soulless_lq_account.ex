...
defmodule(Soulless.Lq.Account) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
        ...
        defp(encode_frozen_state(acc, msg)) do
          try do
            if(msg.frozen_state == 0) do
              ...
              [acc, <<232, 1>>, Protox.Encode.encode_uint32(msg.frozen_state)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:frozen_state, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.Account))
          end
        )
      )
                ...
                {[
                   anti_addiction:
                     Protox.Message.merge(
                       msg.anti_addiction,
                       Soulless.Lq.AntiAddiction.decode!(delimited)
                     )
                 ], rest}
                ...
                {[
                   platform_diamond:
                     msg.platform_diamond ++
                       [Soulless.Lq.Account.PlatformDiamond.decode!(delimited)]
                 ], rest}
                ...
                {[
                   platform_skin_ticket:
                     msg.platform_skin_ticket ++
                       [Soulless.Lq.Account.PlatformSkinTicket.decode!(delimited)]
                 ], rest}
                ...
                {[
                   challenge_levels:
                     msg.challenge_levels ++
                       [Soulless.Lq.Account.ChallengeLevel.decode!(delimited)]
                 ], rest}
                ...
                {[
                   achievement_count:
                     msg.achievement_count ++
                       [Soulless.Lq.Account.AchievementCount.decode!(delimited)]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:anti_addiction, {:scalar, nil}, {:message, Soulless.Lq.AntiAddiction}},
        ...
        18 => {:platform_diamond, :unpacked, {:message, Soulless.Lq.Account.PlatformDiamond}},
        21 => {:level, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        22 => {:level3, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        23 => {:avatar_frame, {:scalar, 0}, :uint32},
        24 => {:skin_ticket, {:scalar, 0}, :uint32},
        25 =>
          {:platform_skin_ticket, :unpacked, {:message, Soulless.Lq.Account.PlatformSkinTicket}},
        26 => {:verified, {:scalar, 0}, :uint32},
        27 => {:challenge_levels, :unpacked, {:message, Soulless.Lq.Account.ChallengeLevel}},
        28 => {:achievement_count, :unpacked, {:message, Soulless.Lq.Account.AchievementCount}},
    ...
    def(defs_by_name()) do
      %{
        ...
        achievement_count: {28, :unpacked, {:message, Soulless.Lq.Account.AchievementCount}},
        anti_addiction: {6, {:scalar, nil}, {:message, Soulless.Lq.AntiAddiction}},
        avatar_frame: {23, {:scalar, 0}, :uint32},
        avatar_id: {13, {:scalar, 0}, :uint32},
        birthday: {15, {:scalar, 0}, :int32},
        challenge_levels: {27, :unpacked, {:message, Soulless.Lq.Account.ChallengeLevel}},
        diamond: {12, {:scalar, 0}, :uint32},
        email: {9, {:scalar, ""}, :string},
        email_verify: {10, {:scalar, 0}, :uint32},
        frozen_state: {29, {:scalar, 0}, :uint32},
        gold: {11, {:scalar, 0}, :uint32},
        level: {21, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        level3: {22, {:scalar, nil}, {:message, Soulless.Lq.AccountLevel}},
        ...
        platform_diamond: {18, :unpacked, {:message, Soulless.Lq.Account.PlatformDiamond}},
        platform_skin_ticket: {25, :unpacked, {:message, Soulless.Lq.Account.PlatformSkinTicket}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :anti_addiction,
          tag: 6,
          type: {:message, Soulless.Lq.AntiAddiction}
        },
        %{
          __struct__: Protox.Field,
          json_name: "title",
        ...
        %{
          ...
          tag: 18,
          type: {:message, Soulless.Lq.Account.PlatformDiamond}
        },
        %{
          __struct__: Protox.Field,
          json_name: "level",
        ...
        %{
          ...
          tag: 25,
          type: {:message, Soulless.Lq.Account.PlatformSkinTicket}
        },
        %{
          __struct__: Protox.Field,
          json_name: "verified",
        ...
        %{
          ...
          tag: 27,
          type: {:message, Soulless.Lq.Account.ChallengeLevel}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 28,
          type: {:message, Soulless.Lq.Account.AchievementCount}
        },
        %{
          __struct__: Protox.Field,
          json_name: "frozenState",
          kind: {:scalar, 0},
          label: :optional,
          name: :frozen_state,
          tag: 29,
