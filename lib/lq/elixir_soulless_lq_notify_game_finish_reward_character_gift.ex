...
defmodule(Soulless.Lq.NotifyGameFinishReward.CharacterGift) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.NotifyGameFinishReward.CharacterGift))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.NotifyGameFinishReward.CharacterGift,
