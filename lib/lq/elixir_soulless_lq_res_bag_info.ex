...
defmodule(Soulless.Lq.ResBagInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ResBagInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[bag: Protox.Message.merge(msg.bag, Soulless.Lq.Bag.decode!(delimited))], rest}
    ...
    def(defs()) do
      %{
        ...
        2 => {:bag, {:scalar, nil}, {:message, Soulless.Lq.Bag}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        bag: {2, {:scalar, nil}, {:message, Soulless.Lq.Bag}},
