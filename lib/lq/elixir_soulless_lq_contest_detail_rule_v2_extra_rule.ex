...
defmodule(Soulless.Lq.ContestDetailRuleV2.ExtraRule) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ContestDetailRuleV2.ExtraRule))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ContestDetailRuleV2.ExtraRule,
