...
defmodule(Soulless.Lq.ActionAnGangAddGang) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.ActionAnGangAddGang))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.ActionAnGangAddGang,
    ...
    def(defs()) do
      %{
        ...
        9 => {:muyu, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        muyu: {9, {:scalar, nil}, {:message, Soulless.Lq.MuyuInfo}},
