...
defmodule(Soulless.Lq.GameFinalSnapshot.FinalPlayer) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Lq.GameFinalSnapshot.FinalPlayer))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Lq.GameFinalSnapshot.FinalPlayer,
