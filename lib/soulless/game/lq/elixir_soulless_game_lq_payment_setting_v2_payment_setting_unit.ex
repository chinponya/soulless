...
defmodule(Soulless.Game.Lq.PaymentSettingV2.PaymentSettingUnit) do
  @moduledoc false
  (
    defstruct(
      platform: "",
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.PaymentSettingV2.PaymentSettingUnit))
          end
        )
      )
                ...
                {[
                   maintain:
                     Protox.Message.merge(
                       msg.maintain,
                       Soulless.Game.Lq.PaymentSettingV2.PaymentMaintain.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.PaymentSettingV2.PaymentSettingUnit,
    ...
    def(defs_by_name()) do
      %{
        ...
        maintain:
          {5, {:scalar, nil}, {:message, Soulless.Game.Lq.PaymentSettingV2.PaymentMaintain}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :maintain,
          tag: 5,
          type: {:message, Soulless.Game.Lq.PaymentSettingV2.PaymentMaintain}
        },
        %{
          __struct__: Protox.Field,
