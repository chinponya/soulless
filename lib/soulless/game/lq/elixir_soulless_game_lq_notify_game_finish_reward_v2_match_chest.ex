...
defmodule Soulless.Game.Lq.NotifyGameFinishRewardV2.MatchChest do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyGameFinishRewardV2.MatchChest))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.NotifyGameFinishRewardV2.MatchChest,
  ...
  (
    ...
    def defs() do
      %{
        ...
        5 => {:rewards, :unpacked, {:message, Soulless.Game.Lq.RewardSlot}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        rewards: {5, :unpacked, {:message, Soulless.Game.Lq.RewardSlot}}
      }
    end
  )
