  ...
  (
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[persons: msg.persons ++ [Soulless.Game.Lq.PlayerGameView.decode!(delimited)]],
                 rest}
    ...
    def(defs()) do
      %{
        ...
        3 => {:mode, {:scalar, nil}, {:message, Soulless.Game.Lq.GameMode}},
        4 => {:max_player_count, {:scalar, 0}, :uint32},
        5 => {:persons, :unpacked, {:message, Soulless.Game.Lq.PlayerGameView}},
