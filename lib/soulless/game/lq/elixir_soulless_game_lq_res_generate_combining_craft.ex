...
defmodule Soulless.Game.Lq.ResGenerateCombiningCraft do
  @moduledoc false
  defstruct error: nil, pos: 0, craft_id: 0, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResGenerateCombiningCraft))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResGenerateCombiningCraft,
