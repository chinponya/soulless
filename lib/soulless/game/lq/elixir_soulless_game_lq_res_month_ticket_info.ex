...
defmodule Soulless.Game.Lq.ResMonthTicketInfo do
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 month_ticket_info:
                   msg.month_ticket_info ++ [Soulless.Game.Lq.MonthTicketInfo.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        1 => {:month_ticket_info, :unpacked, {:message, Soulless.Game.Lq.MonthTicketInfo}},
    ...
    def defs_by_name() do
      %{
        ...
        month_ticket_info: {1, :unpacked, {:message, Soulless.Game.Lq.MonthTicketInfo}}
      }
    end
  )
