...
defmodule Soulless.Game.Lq.ReqReceiveVillageTripReward do
  @moduledoc false
  defstruct activity_id: 0, dest_id: 0, rewards: [], __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqReceiveVillageTripReward))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqReceiveVillageTripReward,
