...
defmodule Soulless.Game.Lq.ReqUseGiftCode do
  @moduledoc false
  defstruct code: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_code(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqUseGiftCode))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqUseGiftCode,
