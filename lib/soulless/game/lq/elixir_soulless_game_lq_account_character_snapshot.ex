...
defmodule Soulless.Game.Lq.AccountCharacterSnapshot do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.AccountCharacterSnapshot))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 removed_characters:
                   msg.removed_characters ++ [Soulless.Game.Lq.Character.decode!(delimited)]
               ], rest}
            ...
            {3, _, bytes} ->
              ...
              {[
                 modified_characters:
                   msg.modified_characters ++ [Soulless.Game.Lq.Character.decode!(delimited)]
               ], rest}
              ...
              {[
                 main_character:
                   Protox.MergeMessage.merge(
                     msg.main_character,
                     Soulless.Game.Lq.AccountCharacterSnapshot.MainCharacterSnapshot.decode!(
                       delimited
                     )
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 skins:
                   Protox.MergeMessage.merge(
                     msg.skins,
                     Soulless.Game.Lq.AccountCharacterSnapshot.SkinsSnapshot.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 hidden_characters:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Game.Lq.AccountCharacterSnapshot.HiddenCharacter.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountCharacterSnapshot,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:removed_characters, :unpacked, {:message, Soulless.Game.Lq.Character}},
        3 => {:modified_characters, :unpacked, {:message, Soulless.Game.Lq.Character}},
        4 =>
          {:main_character, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountCharacterSnapshot.MainCharacterSnapshot}},
        5 =>
          {:skins, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountCharacterSnapshot.SkinsSnapshot}},
        6 =>
          {:hidden_characters, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountCharacterSnapshot.HiddenCharacter}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        main_character:
          {4, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountCharacterSnapshot.MainCharacterSnapshot}},
        modified_characters: {3, :unpacked, {:message, Soulless.Game.Lq.Character}},
        removed_characters: {2, :unpacked, {:message, Soulless.Game.Lq.Character}},
        skins:
          {5, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountCharacterSnapshot.SkinsSnapshot}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :main_character,
          tag: 4,
          type: {:message, Soulless.Game.Lq.AccountCharacterSnapshot.MainCharacterSnapshot}
        },
        %{
          __struct__: Protox.Field,
          json_name: "skins",
          ...
          name: :skins,
          tag: 5,
          type: {:message, Soulless.Game.Lq.AccountCharacterSnapshot.SkinsSnapshot}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 6,
          type: {:message, Soulless.Game.Lq.AccountCharacterSnapshot.HiddenCharacter}
        }
      ]
    end
