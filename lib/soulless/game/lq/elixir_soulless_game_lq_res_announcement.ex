...
defmodule Soulless.Game.Lq.ResAnnouncement do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResAnnouncement))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResAnnouncement,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:announcements, :unpacked, {:message, Soulless.Game.Lq.Announcement}},
    ...
    def defs_by_name() do
      %{
        announcements: {2, :unpacked, {:message, Soulless.Game.Lq.Announcement}},
