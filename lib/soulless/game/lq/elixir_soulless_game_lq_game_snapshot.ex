...
defmodule Soulless.Game.Lq.GameSnapshot do
  @moduledoc false
  defstruct chang: 0,
            ju: 0,
            ben: 0,
    ...
    [
      ...
      defp encode_index_player(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:index_player, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.GameSnapshot))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {9, _, bytes} ->
              ...
              {[
                 players:
                   msg.players ++
                     [Soulless.Game.Lq.GameSnapshot.PlayerSnapshot.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        9 => {:players, :unpacked, {:message, Soulless.Game.Lq.GameSnapshot.PlayerSnapshot}},
    ...
    def defs_by_name() do
      %{
        ...
        players: {9, :unpacked, {:message, Soulless.Game.Lq.GameSnapshot.PlayerSnapshot}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :players,
          tag: 9,
          type: {:message, Soulless.Game.Lq.GameSnapshot.PlayerSnapshot}
        },
        %{
          __struct__: Protox.Field,
          json_name: "zhenting",
