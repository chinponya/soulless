...
defmodule Soulless.Game.Lq.NotifyClientMessage do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyClientMessage))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.NotifyClientMessage,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:sender, {:scalar, nil}, {:message, Soulless.Game.Lq.PlayerBaseView}},
    ...
    def defs_by_name() do
      %{
        ...
        sender: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.PlayerBaseView}},
