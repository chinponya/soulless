...
defmodule Soulless.Game.Lq.ResUpgradeCharacter do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResUpgradeCharacter))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResUpgradeCharacter,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:character, {:scalar, nil}, {:message, Soulless.Game.Lq.Character}}
      }
    end
    ...
    def defs_by_name() do
      %{
        character: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.Character}},
