...
defmodule(Soulless.Game.Lq.ContestDetailRule) do
  @moduledoc false
  (
    defstruct(
      init_point: 0,
        ...
        defp(encode_guyi_mode(acc, msg)) do
          try do
            if(msg.guyi_mode == 0) do
              ...
              [acc, <<200, 2>>, Protox.Encode.encode_uint32(msg.guyi_mode)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_disable_leijiyiman(acc, msg)) do
          try do
            if(msg.disable_leijiyiman == false) do
              ...
              [acc, <<208, 2>>, Protox.Encode.encode_bool(msg.disable_leijiyiman)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ContestDetailRule))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ContestDetailRule,
