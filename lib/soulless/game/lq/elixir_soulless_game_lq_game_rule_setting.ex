...
defmodule Soulless.Game.Lq.GameRuleSetting do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.GameRuleSetting))
        end
      )
    )
              ...
              {[
                 detail_rule_v2:
                   Protox.MergeMessage.merge(
                     msg.detail_rule_v2,
                     Soulless.Game.Lq.ContestDetailRuleV2.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.GameRuleSetting,
  ...
  (
    ...
    def defs() do
      %{
        ...
        6 => {:detail_rule_v2, {:scalar, nil}, {:message, Soulless.Game.Lq.ContestDetailRuleV2}}
      }
    end
    ...
    def defs_by_name() do
      %{
        detail_rule_v2: {6, {:scalar, nil}, {:message, Soulless.Game.Lq.ContestDetailRuleV2}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :detail_rule_v2,
          tag: 6,
          type: {:message, Soulless.Game.Lq.ContestDetailRuleV2}
        }
      ]
    end
