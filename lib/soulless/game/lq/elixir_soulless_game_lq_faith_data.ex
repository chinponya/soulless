...
defmodule(Soulless.Game.Lq.FaithData) do
  @moduledoc false
  (
      ...
      [
        ...
        defp(encode_modify_count(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:modify_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.FaithData))
          end
        )
      )
