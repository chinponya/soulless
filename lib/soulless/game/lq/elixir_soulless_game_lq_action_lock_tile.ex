...
defmodule(Soulless.Game.Lq.ActionLockTile) do
  @moduledoc false
  (
    defstruct(
      seat: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ActionLockTile))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ActionLockTile,
    ...
    def(defs()) do
      %{
        ...
        5 => {:operation, {:scalar, nil}, {:message, Soulless.Game.Lq.OptionalOperationList}},
    ...
    def(defs_by_name()) do
      %{
        ...
        operation: {5, {:scalar, nil}, {:message, Soulless.Game.Lq.OptionalOperationList}},
