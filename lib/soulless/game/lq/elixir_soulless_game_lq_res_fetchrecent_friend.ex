...
defmodule Soulless.Game.Lq.ResFetchrecentFriend do
  @moduledoc false
  defstruct error: nil, account_list: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_account_list(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchrecentFriend))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchrecentFriend,
