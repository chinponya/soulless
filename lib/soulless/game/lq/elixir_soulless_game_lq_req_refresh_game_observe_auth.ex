...
defmodule(Soulless.Game.Lq.ReqRefreshGameObserveAuth) do
  @moduledoc false
  (
    defstruct(token: "", __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_token(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqRefreshGameObserveAuth))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqRefreshGameObserveAuth,
