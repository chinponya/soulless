...
defmodule Soulless.Game.Lq.ResCreateJPCreditCardOrder do
  @moduledoc false
  (
    defstruct error: nil, order_id: "", __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_error(msg) |> encode_order_id(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResCreateJPCreditCardOrder))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResCreateJPCreditCardOrder,
