...
defmodule Soulless.Game.Lq.PlayerLeaving do
  @moduledoc false
  (
    defstruct seat: 0, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_seat(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.PlayerLeaving))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.PlayerLeaving,
