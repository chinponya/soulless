...
defmodule(Soulless.Game.Lq.AccountDetailStatisticByCategory) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.AccountDetailStatisticByCategory))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.AccountDetailStatisticByCategory,
    ...
    def(defs()) do
      %{
        ...
        2 =>
          {:detail_statistic, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountDetailStatistic}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        detail_statistic: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountDetailStatistic}}
      }
    end
