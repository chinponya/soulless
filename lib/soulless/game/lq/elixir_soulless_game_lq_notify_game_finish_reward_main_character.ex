...
defmodule(Soulless.Game.Lq.NotifyGameFinishReward.MainCharacter) do
  @moduledoc false
  (
    defstruct(level: 0, exp: 0, add: 0, __uf__: [])
        ...
        defp(encode_exp(acc, msg)) do
          try do
            if(msg.exp == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.exp)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_add(acc, msg)) do
          try do
            if(msg.add == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.add)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyGameFinishReward.MainCharacter))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.NotifyGameFinishReward.MainCharacter,
    ...
    def(defs()) do
      %{
        1 => {:level, {:scalar, 0}, :uint32},
        2 => {:exp, {:scalar, 0}, :uint32},
    ...
    def(defs_by_name()) do
      %{
        ...
        exp: {2, {:scalar, 0}, :uint32},
        level: {1, {:scalar, 0}, :uint32}
      }
    end
