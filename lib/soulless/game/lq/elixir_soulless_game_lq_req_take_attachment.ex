...
defmodule Soulless.Game.Lq.ReqTakeAttachment do
  @moduledoc false
  defstruct mail_id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_mail_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqTakeAttachment))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqTakeAttachment,
