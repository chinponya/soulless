  ...
  (
              ...
              {13, _, bytes} ->
                ...
                {[
                   mine_data:
                     msg.mine_data ++
                       [
                         Soulless.Game.Lq.ResAccountActivityData.MineActivityData.decode!(
                           delimited
                         )
                       ]
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        13 =>
          {:mine_data, :unpacked,
           {:message, Soulless.Game.Lq.ResAccountActivityData.MineActivityData}},
    ...
    def(defs_by_name()) do
      %{
        ...
        mine_data:
          {13, :unpacked, {:message, Soulless.Game.Lq.ResAccountActivityData.MineActivityData}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :mine_data,
          tag: 13,
          type: {:message, Soulless.Game.Lq.ResAccountActivityData.MineActivityData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "rpgData",
