...
defmodule(Soulless.Game.Lq.ResFetchOBToken) do
  @moduledoc false
  (
    defstruct(error: nil, token: "", create_time: 0, delay: 0, start_time: 0, __uf__: [])
        ...
        defp(encode_create_time(acc, msg)) do
          try do
            if(msg.create_time == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.create_time)]
            end
          rescue
            ArgumentError ->
              reraise(
        ...
        defp(encode_delay(acc, msg)) do
          try do
            if(msg.delay == 0) do
              ...
              [acc, " ", Protox.Encode.encode_uint32(msg.delay)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchOBToken))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResFetchOBToken,
