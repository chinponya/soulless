...
defmodule Soulless.Game.Lq.ResFeedActivityFeed do
  @moduledoc false
  defstruct error: nil, items: [], feed_count: 0, __uf__: []
      ...
      defp encode_feed_count(acc, msg) do
        try do
          if msg.feed_count == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.feed_count)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFeedActivityFeed))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 items:
                   msg.items ++
                     [Soulless.Game.Lq.ResFeedActivityFeed.RewardItem.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFeedActivityFeed,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:items, :unpacked, {:message, Soulless.Game.Lq.ResFeedActivityFeed.RewardItem}},
        3 => {:feed_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        feed_count: {3, {:scalar, 0}, :uint32},
        items: {2, :unpacked, {:message, Soulless.Game.Lq.ResFeedActivityFeed.RewardItem}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :items,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResFeedActivityFeed.RewardItem}
        },
        %{
          __struct__: Protox.Field,
          json_name: "feedCount",
