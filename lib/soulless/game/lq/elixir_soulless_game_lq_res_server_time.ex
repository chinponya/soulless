      ...
      [
        defp encode_server_time(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:server_time, "invalid field value"),
                      __STACKTRACE__
          end
        end
      ]
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResServerTime))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResServerTime,
