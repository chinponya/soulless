...
defmodule(Soulless.Game.Lq.ResRefreshZHPShop) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResRefreshZHPShop))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   zhp: Protox.Message.merge(msg.zhp, Soulless.Game.Lq.ZHPShop.decode!(delimited))
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResRefreshZHPShop,
    ...
    def(defs()) do
      %{
        ...
        2 => {:zhp, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        zhp: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop}}
      }
    end
