...
defmodule Soulless.Game.Lq.AccountDetailStatistic do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.AccountDetailStatistic))
          end
        )
      )
            ...
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   game_mode:
                     msg.game_mode ++
                       [Soulless.Game.Lq.AccountStatisticByGameMode.decode!(delimited)]
                 ], rest}
              ...
              {4, _, bytes} ->
                ...
                {[
                   fan_achieved:
                     msg.fan_achieved ++ [Soulless.Game.Lq.AccountFanAchieved.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.AccountDetailStatistic,
    ...
    def defs() do
      %{
        1 => {:game_mode, :unpacked, {:message, Soulless.Game.Lq.AccountStatisticByGameMode}},
        2 => {:fan, :unpacked, {:message, Soulless.Game.Lq.AccountStatisticByFan}},
        3 => {:liujumanguan, {:scalar, 0}, :uint32},
        4 => {:fan_achieved, :unpacked, {:message, Soulless.Game.Lq.AccountFanAchieved}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        fan_achieved: {4, :unpacked, {:message, Soulless.Game.Lq.AccountFanAchieved}},
        game_mode: {1, :unpacked, {:message, Soulless.Game.Lq.AccountStatisticByGameMode}},
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :game_mode,
          tag: 1,
          type: {:message, Soulless.Game.Lq.AccountStatisticByGameMode}
        },
        %{
          __struct__: Protox.Field,
          json_name: "fan",
        ...
        %{
          ...
          name: :fan_achieved,
          tag: 4,
          type: {:message, Soulless.Game.Lq.AccountFanAchieved}
        }
      ]
    end
