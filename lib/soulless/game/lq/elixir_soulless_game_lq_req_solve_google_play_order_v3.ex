...
defmodule Soulless.Game.Lq.ReqSolveGooglePlayOrderV3 do
  @moduledoc false
  defstruct order_id: "", transaction_id: "", token: "", account_id: 0, __uf__: []
      ...
      defp encode_token(acc, msg) do
        try do
          if msg.token == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.token)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqSolveGooglePlayOrderV3))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqSolveGooglePlayOrderV3,
