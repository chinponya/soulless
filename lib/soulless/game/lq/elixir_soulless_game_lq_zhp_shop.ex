...
defmodule Soulless.Game.Lq.ZHPShop do
  @moduledoc false
    ...
    [
      ...
      defp encode_free_refresh(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:free_refresh, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_cost_refresh(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:cost_refresh, "invalid field value"), __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ZHPShop))
        end
      )
    )
              ...
              {[
                 free_refresh:
                   Protox.MergeMessage.merge(
                     msg.free_refresh,
                     Soulless.Game.Lq.ZHPShop.RefreshCount.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:free_refresh, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop.RefreshCount}},
        4 => {:cost_refresh, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop.RefreshCount}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        cost_refresh: {4, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop.RefreshCount}},
        free_refresh: {3, {:scalar, nil}, {:message, Soulless.Game.Lq.ZHPShop.RefreshCount}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :free_refresh,
          tag: 3,
          type: {:message, Soulless.Game.Lq.ZHPShop.RefreshCount}
        },
        %{
          __struct__: Protox.Field,
