...
defmodule Soulless.Game.Lq.RecordRoundInfo do
  @moduledoc false
  defstruct name: "",
            chang: 0,
            ju: 0,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.RecordRoundInfo))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {7, _, bytes} ->
              ...
              {[
                 liqi_infos:
                   msg.liqi_infos ++ [Soulless.Game.Lq.RecordLiqiInfo.decode!(delimited)]
               ], rest}
            ...
            {8, _, bytes} ->
              ...
              {[
                 gang_infos:
                   msg.gang_infos ++ [Soulless.Game.Lq.RecordGangInfo.decode!(delimited)]
               ], rest}
            ...
            {9, _, bytes} ->
              ...
              {[
                 peipai_infos:
                   msg.peipai_infos ++ [Soulless.Game.Lq.RecordPeiPaiInfo.decode!(delimited)]
               ], rest}
            ...
            {10, _, bytes} ->
              ...
              {[
                 babai_infos:
                   msg.babai_infos ++ [Soulless.Game.Lq.RecordBaBeiInfo.decode!(delimited)]
               ], rest}
              ...
              {[
                 hules_info:
                   Protox.MergeMessage.merge(
                     msg.hules_info,
                     Soulless.Game.Lq.RecordHulesInfo.decode!(delimited)
                   )
               ], rest}
            ...
            {12, _, bytes} ->
              ...
              {[
                 liuju_info:
                   Protox.MergeMessage.merge(
                     msg.liuju_info,
                     Soulless.Game.Lq.RecordLiujuInfo.decode!(delimited)
                   )
               ], rest}
            ...
            {13, _, bytes} ->
              ...
              {[
                 no_tile_info:
                   Protox.MergeMessage.merge(
                     msg.no_tile_info,
                     Soulless.Game.Lq.RecordNoTileInfo.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.RecordRoundInfo,
  ...
  (
    ...
    def defs() do
      %{
        ...
        7 => {:liqi_infos, :unpacked, {:message, Soulless.Game.Lq.RecordLiqiInfo}},
        8 => {:gang_infos, :unpacked, {:message, Soulless.Game.Lq.RecordGangInfo}},
        9 => {:peipai_infos, :unpacked, {:message, Soulless.Game.Lq.RecordPeiPaiInfo}},
        10 => {:babai_infos, :unpacked, {:message, Soulless.Game.Lq.RecordBaBeiInfo}},
        11 => {:hules_info, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordHulesInfo}},
        12 => {:liuju_info, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordLiujuInfo}},
        13 => {:no_tile_info, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordNoTileInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        babai_infos: {10, :unpacked, {:message, Soulless.Game.Lq.RecordBaBeiInfo}},
        ben: {4, {:scalar, 0}, :uint32},
        chang: {2, {:scalar, 0}, :uint32},
        gang_infos: {8, :unpacked, {:message, Soulless.Game.Lq.RecordGangInfo}},
        hules_info: {11, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordHulesInfo}},
        ju: {3, {:scalar, 0}, :uint32},
        liqi_infos: {7, :unpacked, {:message, Soulless.Game.Lq.RecordLiqiInfo}},
        liuju_info: {12, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordLiujuInfo}},
        name: {1, {:scalar, ""}, :string},
        no_tile_info: {13, {:scalar, nil}, {:message, Soulless.Game.Lq.RecordNoTileInfo}},
        peipai_infos: {9, :unpacked, {:message, Soulless.Game.Lq.RecordPeiPaiInfo}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :liqi_infos,
          tag: 7,
          type: {:message, Soulless.Game.Lq.RecordLiqiInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gangInfos",
          ...
          name: :gang_infos,
          tag: 8,
          type: {:message, Soulless.Game.Lq.RecordGangInfo}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :peipai_infos,
          tag: 9,
          type: {:message, Soulless.Game.Lq.RecordPeiPaiInfo}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :babai_infos,
          tag: 10,
          type: {:message, Soulless.Game.Lq.RecordBaBeiInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "hulesInfo",
          ...
          name: :hules_info,
          tag: 11,
          type: {:message, Soulless.Game.Lq.RecordHulesInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "liujuInfo",
          ...
          name: :liuju_info,
          tag: 12,
          type: {:message, Soulless.Game.Lq.RecordLiujuInfo}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :no_tile_info,
          tag: 13,
          type: {:message, Soulless.Game.Lq.RecordNoTileInfo}
        }
      ]
    end
