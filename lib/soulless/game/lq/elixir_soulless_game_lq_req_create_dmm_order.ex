...
defmodule(Soulless.Game.Lq.ReqCreateDMMOrder) do
  @moduledoc false
  (
    defstruct(goods_id: 0, account_id: 0, client_type: 0, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreateDMMOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqCreateDMMOrder,
