  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountDetailStatisticV2.CustomizedContestStatistic,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 =>
          {:month_statistic, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountDetailStatistic}},
    ...
    def defs_by_name() do
      %{
        ...
        total_statistic: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountDetailStatistic}}
      }
    end
  )
