...
defmodule Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer do
  @moduledoc false
  defstruct seat: 0,
            total_point: 0,
            part_point_1: 0,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer,
