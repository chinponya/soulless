...
defmodule Soulless.Game.Lq.ResFetchShopInterval do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchShopInterval))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 result:
                   msg.result ++
                     [Soulless.Game.Lq.ResFetchShopInterval.ShopInterval.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchShopInterval,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:result, :unpacked, {:message, Soulless.Game.Lq.ResFetchShopInterval.ShopInterval}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        result: {2, :unpacked, {:message, Soulless.Game.Lq.ResFetchShopInterval.ShopInterval}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :result,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResFetchShopInterval.ShopInterval}
        }
      ]
    end
