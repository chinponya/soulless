...
defmodule Soulless.Game.Lq.ExecuteResult do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ExecuteResult))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ExecuteResult,
  ...
  (
    ...
    def defs() do
      %{1 => {:id, {:scalar, 0}, :uint32}, 2 => {:count, {:scalar, 0}, :int32}}
    end
    ...
    def defs_by_name() do
      %{count: {2, {:scalar, 0}, :int32}, id: {1, {:scalar, 0}, :uint32}}
    end
  )
