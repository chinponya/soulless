...
defmodule(Soulless.Game.Lq.ResBuyFromChestShop) do
  @moduledoc false
  (
    defstruct(error: nil, chest_id: 0, consume_count: 0, faith_count: 0, __uf__: [])
        ...
        defp(encode_chest_id(acc, msg)) do
          try do
            if(msg.chest_id == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.chest_id)]
            end
          rescue
            ArgumentError ->
        ...
        defp(encode_faith_count(acc, msg)) do
          try do
            if(msg.faith_count == 0) do
              ...
              [acc, " ", Protox.Encode.encode_int32(msg.faith_count)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResBuyFromChestShop))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResBuyFromChestShop,
    ...
    def(defs()) do
      %{
        ...
        2 => {:chest_id, {:scalar, 0}, :uint32},
        3 => {:consume_count, {:scalar, 0}, :uint32},
        4 => {:faith_count, {:scalar, 0}, :int32}
      }
    end
