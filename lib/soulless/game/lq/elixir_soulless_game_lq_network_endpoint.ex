...
defmodule Soulless.Game.Lq.NetworkEndpoint do
  @moduledoc false
      ...
      defp encode_address(acc, msg) do
        try do
          if msg.address == "" do
            ...
            [acc, "\x12", Protox.Encode.encode_string(msg.address)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_port(acc, msg) do
        try do
          if msg.port == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.port)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.NetworkEndpoint))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[family: Protox.Decode.validate_string(delimited)], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.NetworkEndpoint,
