...
defmodule Soulless.Game.Lq.RecordGame.AccountInfo do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.RecordGame.AccountInfo))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.RecordGame.AccountInfo,
    ...
    def defs() do
      %{
        ...
        5 => {:character, {:scalar, nil}, {:message, Soulless.Game.Lq.Character}},
        6 => {:title, {:scalar, 0}, :uint32},
        7 => {:level, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        8 => {:level3, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        9 => {:avatar_frame, {:scalar, 0}, :uint32},
        10 => {:verified, {:scalar, 0}, :uint32},
        11 => {:views, :unpacked, {:message, Soulless.Game.Lq.ViewSlot}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        character: {5, {:scalar, nil}, {:message, Soulless.Game.Lq.Character}},
        level: {7, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        level3: {8, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        nickname: {3, {:scalar, ""}, :string},
        seat: {2, {:scalar, 0}, :uint32},
        title: {6, {:scalar, 0}, :uint32},
        verified: {10, {:scalar, 0}, :uint32},
        views: {11, :unpacked, {:message, Soulless.Game.Lq.ViewSlot}}
      }
    end
