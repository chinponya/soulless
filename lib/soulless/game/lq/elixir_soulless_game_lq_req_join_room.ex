...
defmodule Soulless.Game.Lq.ReqJoinRoom do
  @moduledoc false
  defstruct room_id: 0, client_version_string: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqJoinRoom))
        end
      )
    )
  ...
  (
    ...
    def defs_by_name() do
      %{client_version_string: {2, {:scalar, ""}, :string}, room_id: {1, {:scalar, 0}, :uint32}}
    end
  )
