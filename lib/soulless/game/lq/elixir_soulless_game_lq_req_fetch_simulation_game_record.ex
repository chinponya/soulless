...
defmodule Soulless.Game.Lq.ReqFetchSimulationGameRecord do
  @moduledoc false
  defstruct game_uuid: "", activity_id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_game_uuid(msg) |> encode_activity_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqFetchSimulationGameRecord))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqFetchSimulationGameRecord,
  ...
  (
    ...
    def defs() do
      %{1 => {:game_uuid, {:scalar, ""}, :string}, 2 => {:activity_id, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{activity_id: {2, {:scalar, 0}, :uint32}, game_uuid: {1, {:scalar, ""}, :string}}
    end
  )
