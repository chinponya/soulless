...
defmodule Soulless.Game.Lq.ReqLogin do
  @moduledoc false
  defstruct account: "",
            password: "",
            reconnect: false,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqLogin))
        end
      )
    )
