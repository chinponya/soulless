...
defmodule(Soulless.Game.Lq.ResChallengeSeasonInfo.ChallengeInfo) do
  @moduledoc false
  (
    defstruct(season_id: 0, start_time: 0, end_time: 0, state: 0, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResChallengeSeasonInfo.ChallengeInfo))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResChallengeSeasonInfo.ChallengeInfo,
