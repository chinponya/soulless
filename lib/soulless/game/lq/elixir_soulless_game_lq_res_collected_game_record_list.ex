...
defmodule Soulless.Game.Lq.ResCollectedGameRecordList do
  @moduledoc false
  defstruct error: nil, record_list: [], record_collect_limit: 0, __uf__: []
    ...
    [
      ...
      defp encode_record_list(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:record_list, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_record_collect_limit(acc, msg) do
        try do
          if msg.record_collect_limit == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.record_collect_limit)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResCollectedGameRecordList))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 record_list:
                   msg.record_list ++ [Soulless.Game.Lq.RecordCollectedData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResCollectedGameRecordList,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:record_list, :unpacked, {:message, Soulless.Game.Lq.RecordCollectedData}},
        3 => {:record_collect_limit, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        record_collect_limit: {3, {:scalar, 0}, :uint32},
        record_list: {2, :unpacked, {:message, Soulless.Game.Lq.RecordCollectedData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :record_list,
          tag: 2,
          type: {:message, Soulless.Game.Lq.RecordCollectedData}
        },
        %{
          __struct__: Protox.Field,
