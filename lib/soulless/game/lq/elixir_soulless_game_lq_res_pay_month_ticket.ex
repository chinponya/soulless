...
defmodule Soulless.Game.Lq.ResPayMonthTicket do
  @moduledoc false
  defstruct error: nil, resource_id: 0, resource_count: 0, __uf__: []
      ...
      defp encode_resource_id(acc, msg) do
        try do
          if msg.resource_id == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.resource_id)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_resource_count(acc, msg) do
        try do
          if msg.resource_count == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.resource_count)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResPayMonthTicket))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResPayMonthTicket,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:resource_id, {:scalar, 0}, :uint32},
        3 => {:resource_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        resource_count: {3, {:scalar, 0}, :uint32},
        resource_id: {2, {:scalar, 0}, :uint32}
      }
    end
  )
