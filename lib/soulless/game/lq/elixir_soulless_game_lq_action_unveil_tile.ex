...
defmodule(Soulless.Game.Lq.ActionUnveilTile) do
  @moduledoc false
  (
    defstruct(seat: 0, scores: [], liqibang: 0, operation: nil, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ActionUnveilTile))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ActionUnveilTile,
