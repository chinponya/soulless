...
defmodule Soulless.Game.Lq.GameEnd do
  @moduledoc false
  defstruct scores: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_scores(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.GameEnd))
        end
      )
    )
