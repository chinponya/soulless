...
defmodule Soulless.Game.Lq.ReqBuyInABMatch do
  @moduledoc false
  (
    defstruct match_id: 0, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_match_id(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqBuyInABMatch))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqBuyInABMatch,
