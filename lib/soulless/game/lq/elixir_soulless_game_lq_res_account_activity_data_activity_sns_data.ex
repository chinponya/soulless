  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResAccountActivityData.ActivitySNSData))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[blog: msg.blog ++ [Soulless.Game.Lq.SNSBlog.decode!(delimited)]], rest}
            ...
            {3, _, bytes} ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[reply: msg.reply ++ [Soulless.Game.Lq.SNSReply.decode!(delimited)]], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResAccountActivityData.ActivitySNSData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:reply, :unpacked, {:message, Soulless.Game.Lq.SNSReply}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        reply: {3, :unpacked, {:message, Soulless.Game.Lq.SNSReply}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :blog,
          tag: 1,
          type: {:message, Soulless.Game.Lq.SNSBlog}
        },
        %{
          __struct__: Protox.Field,
          json_name: "likedId",
