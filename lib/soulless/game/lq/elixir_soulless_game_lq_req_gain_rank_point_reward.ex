...
defmodule(Soulless.Game.Lq.ReqGainRankPointReward) do
  @moduledoc false
  (
    defstruct(leaderboard_id: 0, activity_id: 0, __uf__: [])
        ...
        defp(encode_activity_id(acc, msg)) do
          try do
            if(msg.activity_id == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.activity_id)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqGainRankPointReward))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqGainRankPointReward,
    ...
    def(defs()) do
      %{1 => {:leaderboard_id, {:scalar, 0}, :uint32}, 2 => {:activity_id, {:scalar, 0}, :uint32}}
    end
    ...
    def(defs_by_name()) do
      %{activity_id: {2, {:scalar, 0}, :uint32}, leaderboard_id: {1, {:scalar, 0}, :uint32}}
    end
