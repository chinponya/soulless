...
defmodule(Soulless.Game.Lq.PlayerBaseView) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.PlayerBaseView))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.PlayerBaseView,
    ...
    def(defs()) do
      %{
        ...
        6 => {:level3, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
    ...
    def(defs_by_name()) do
      %{
        ...
        level3: {6, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
