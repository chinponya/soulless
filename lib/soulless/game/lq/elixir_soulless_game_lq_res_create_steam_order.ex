...
defmodule Soulless.Game.Lq.ResCreateSteamOrder do
  @moduledoc false
  defstruct error: nil, order_id: "", platform_order_id: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_platform_order_id(acc, msg) do
        try do
          if msg.platform_order_id == "" do
            acc
          else
            [acc, "\x1A", Protox.Encode.encode_string(msg.platform_order_id)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:platform_order_id, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResCreateSteamOrder))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[platform_order_id: Protox.Decode.validate_string(delimited)], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResCreateSteamOrder,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:platform_order_id, {:scalar, ""}, :string}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        platform_order_id: {3, {:scalar, ""}, :string}
      }
    end
  )
  ...
  (
    ...
    [
      ...
      (
        def field_def(:platform_order_id) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "platformOrderId",
        ...
        def field_def("platformOrderId") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "platformOrderId",
  ...
  [
    ...
    def default(:platform_order_id) do
      {:ok, ""}
    end,
    def default(_) do
      {:error, :no_such_field}
