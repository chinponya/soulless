...
defmodule Soulless.Game.Lq.ResMultiAccountBrief do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResMultiAccountBrief))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[players: msg.players ++ [Soulless.Game.Lq.PlayerBaseView.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResMultiAccountBrief,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:players, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        players: {2, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}}
      }
    end
  )
