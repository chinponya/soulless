...
defmodule Soulless.Game.Lq.ReqFetchJPCommonCreditCardOrder do
  @moduledoc false
  defstruct order_id: "", account_id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_order_id(msg) |> encode_account_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqFetchJPCommonCreditCardOrder))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqFetchJPCommonCreditCardOrder,
  ...
  (
    ...
    def defs() do
      %{1 => {:order_id, {:scalar, ""}, :string}, 2 => {:account_id, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{account_id: {2, {:scalar, 0}, :uint32}, order_id: {1, {:scalar, ""}, :string}}
    end
  )
