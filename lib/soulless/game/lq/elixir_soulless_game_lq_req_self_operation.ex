...
defmodule Soulless.Game.Lq.ReqSelfOperation do
  @moduledoc false
  defstruct type: 0,
            index: 0,
            tile: "",
      ...
      defp encode_tile(acc, msg) do
        try do
          if msg.tile == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.tile)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqSelfOperation))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {9, 2, bytes} ->
              ...
              {[
                 tile_states: msg.tile_states ++ Protox.Decode.parse_repeated_int32([], delimited)
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqSelfOperation,
