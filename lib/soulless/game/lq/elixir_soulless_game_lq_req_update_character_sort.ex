...
defmodule Soulless.Game.Lq.ReqUpdateCharacterSort do
  @moduledoc false
  defstruct sort: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_sort(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqUpdateCharacterSort))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqUpdateCharacterSort,
