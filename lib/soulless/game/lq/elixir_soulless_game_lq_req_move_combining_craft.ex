...
defmodule Soulless.Game.Lq.ReqMoveCombiningCraft do
  @moduledoc false
  defstruct activity_id: 0, from: 0, to: 0, __uf__: []
      ...
      defp encode_from(acc, msg) do
        try do
          if msg.from == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.from)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_to(acc, msg) do
        try do
          if msg.to == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.to)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqMoveCombiningCraft))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqMoveCombiningCraft,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:from, {:scalar, 0}, :uint32},
        3 => {:to, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        from: {2, {:scalar, 0}, :uint32},
        to: {3, {:scalar, 0}, :uint32}
      }
    end
  )
