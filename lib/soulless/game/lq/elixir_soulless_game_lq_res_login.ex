...
defmodule Soulless.Game.Lq.ResLogin do
  @moduledoc false
  defstruct error: nil,
            account_id: 0,
            account: nil,
    ...
    [
      ...
      defp encode_account(acc, msg) do
        try do
          if msg.account == nil do
            ...
            [acc, "\x1A", Protox.Encode.encode_message(msg.account)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_has_unread_announcement(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:has_unread_announcement, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_signup_time(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:signup_time, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_is_id_card_authed(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:is_id_card_authed, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      ...
      defp encode_logined_version(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:logined_version, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_rewarded_version(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:rewarded_version, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResLogin))
        end
      )
    )
              ...
              {[
                 account:
                   Protox.MergeMessage.merge(
                     msg.account,
                     Soulless.Game.Lq.Account.decode!(delimited)
                   )
               ], rest}
            ...
            {4, _, bytes} ->
              ...
              {[
                 game_info:
                   Protox.MergeMessage.merge(
                     msg.game_info,
                     Soulless.Game.Lq.GameConnectInfo.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:account, {:scalar, nil}, {:message, Soulless.Game.Lq.Account}},
        4 => {:game_info, {:scalar, nil}, {:message, Soulless.Game.Lq.GameConnectInfo}},
    ...
    def defs_by_name() do
      %{
        ...
        account: {3, {:scalar, nil}, {:message, Soulless.Game.Lq.Account}},
        account_id: {2, {:scalar, 0}, :uint32},
        country: {9, {:scalar, ""}, :string},
        error: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.Error}},
        game_info: {4, {:scalar, nil}, {:message, Soulless.Game.Lq.GameConnectInfo}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :account,
          tag: 3,
          type: {:message, Soulless.Game.Lq.Account}
        },
        %{
          __struct__: Protox.Field,
          json_name: "gameInfo",
          ...
          name: :game_info,
          tag: 4,
          type: {:message, Soulless.Game.Lq.GameConnectInfo}
        },
        %{
          __struct__: Protox.Field,
