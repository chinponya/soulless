    ...
    [
      ...
      defp encode_babei_count(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:babei_count, "invalid field value"), __STACKTRACE__
        end
      end,
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[fans: msg.fans ++ [Soulless.Game.Lq.GameRoundHuData.Fan.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.GameRoundHuData,
  ...
  (
    ...
    def defs_by_name() do
      %{
        ...
        fans: {2, :unpacked, {:message, Soulless.Game.Lq.GameRoundHuData.Fan}},
        fu_sum: {7, {:scalar, 0}, :uint32},
        hupai: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.GameRoundHuData.HuPai}},
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :hupai,
          tag: 1,
          type: {:message, Soulless.Game.Lq.GameRoundHuData.HuPai}
        },
        %{
          __struct__: Protox.Field,
          json_name: "fans",
          ...
          name: :fans,
          tag: 2,
          type: {:message, Soulless.Game.Lq.GameRoundHuData.Fan}
        },
        %{
          __struct__: Protox.Field,
          json_name: "score",
