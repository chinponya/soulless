...
defmodule Soulless.Game.Lq.ResFetchChallengeInfo do
  @moduledoc false
  defstruct error: nil,
            task_progress: [],
            refresh_count: 0,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchChallengeInfo))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 task_progress:
                   msg.task_progress ++ [Soulless.Game.Lq.TaskProgress.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchChallengeInfo,
  ...
  (
    ...
    def defs_by_name() do
      %{
        ...
        task_progress: {2, :unpacked, {:message, Soulless.Game.Lq.TaskProgress}},
