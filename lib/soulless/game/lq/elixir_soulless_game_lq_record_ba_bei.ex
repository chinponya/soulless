...
defmodule Soulless.Game.Lq.RecordBaBei do
  @moduledoc false
  defstruct seat: 0, doras: [], operations: [], moqie: false, tile_state: 0, muyu: nil, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.RecordBaBei))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        7 => {:operations, :unpacked, {:message, Soulless.Game.Lq.OptionalOperationList}},
        8 => {:moqie, {:scalar, false}, :bool},
    ...
    def defs_by_name() do
      %{
        ...
        moqie: {8, {:scalar, false}, :bool},
        muyu: {11, {:scalar, nil}, {:message, Soulless.Game.Lq.MuyuInfo}},
        operations: {7, :unpacked, {:message, Soulless.Game.Lq.OptionalOperationList}},
