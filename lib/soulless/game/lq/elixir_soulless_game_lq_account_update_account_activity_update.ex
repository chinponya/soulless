...
defmodule Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate))
          end
        )
      )
              ...
              {1, _, bytes} ->
                ...
                {[
                   mine_data:
                     msg.mine_data ++
                       [
                         Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate.MineActivityData.decode!(
                           delimited
                         )
                       ]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate,
    ...
    def defs() do
      %{
        1 =>
          {:mine_data, :unpacked,
           {:message, Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate.MineActivityData}},
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :mine_data,
          tag: 1,
          type: {:message, Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate.MineActivityData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "rpgData",
