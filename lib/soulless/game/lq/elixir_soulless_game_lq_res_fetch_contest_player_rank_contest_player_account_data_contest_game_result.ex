...
defmodule Soulless.Game.Lq.ResFetchContestPlayerRank.ContestPlayerAccountData.ContestGameResult do
  @moduledoc false
  defstruct rank: 0, total_point: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_rank(msg) |> encode_total_point(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    ...
    def defs() do
      %{1 => {:rank, {:scalar, 0}, :uint32}, 2 => {:total_point, {:scalar, 0}, :int32}}
    end
    ...
    def defs_by_name() do
      %{rank: {1, {:scalar, 0}, :uint32}, total_point: {2, {:scalar, 0}, :int32}}
    end
  )
