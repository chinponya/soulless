...
defmodule Soulless.Game.Lq.ActionSelectGap do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ActionSelectGap))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ActionSelectGap,
    ...
    def defs() do
      %{
        ...
        2 => {:tingpais0, :unpacked, {:message, Soulless.Game.Lq.TingPaiDiscardInfo}},
        3 => {:tingpais1, :unpacked, {:message, Soulless.Game.Lq.TingPaiInfo}},
    ...
    def defs_by_name() do
      %{
        ...
        tingpais0: {2, :unpacked, {:message, Soulless.Game.Lq.TingPaiDiscardInfo}},
        tingpais1: {3, :unpacked, {:message, Soulless.Game.Lq.TingPaiInfo}}
      }
    end
