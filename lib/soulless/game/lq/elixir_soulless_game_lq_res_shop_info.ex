...
defmodule Soulless.Game.Lq.ResShopInfo do
  @moduledoc false
  (
        ...
        defp encode_shop_info(acc, msg) do
          try do
            if msg.shop_info == nil do
              ...
              [acc, "\x12", Protox.Encode.encode_message(msg.shop_info)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResShopInfo))
          end
        )
      )
    ...
    def defs() do
      %{
        ...
        2 => {:shop_info, {:scalar, nil}, {:message, Soulless.Game.Lq.ShopInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        shop_info: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.ShopInfo}}
      }
    end
