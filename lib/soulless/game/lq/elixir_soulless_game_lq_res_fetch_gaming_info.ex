...
defmodule Soulless.Game.Lq.ResFetchGamingInfo do
  @moduledoc false
  defstruct error: nil, game_info: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_game_info(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchGamingInfo))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchGamingInfo,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:game_info, {:scalar, nil}, {:message, Soulless.Game.Lq.GameConnectInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        game_info: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.GameConnectInfo}}
      }
    end
  )
