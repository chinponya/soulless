...
defmodule Soulless.Game.Lq.ResGameRecordList do
  @moduledoc false
  defstruct error: nil, total_count: 0, record_list: [], __uf__: []
      ...
      defp encode_total_count(acc, msg) do
        try do
          if msg.total_count == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.total_count)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResGameRecordList))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              ...
              {[record_list: msg.record_list ++ [Soulless.Game.Lq.RecordGame.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResGameRecordList,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:total_count, {:scalar, 0}, :uint32},
        3 => {:record_list, :unpacked, {:message, Soulless.Game.Lq.RecordGame}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        record_list: {3, :unpacked, {:message, Soulless.Game.Lq.RecordGame}},
        total_count: {2, {:scalar, 0}, :uint32}
      }
    end
  )
