...
defmodule Soulless.Game.Lq.ResFetchSimulationGameRecord do
  @moduledoc false
  defstruct error: nil, messages: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_messages(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchSimulationGameRecord))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchSimulationGameRecord,
  ...
  (
    ...
    def defs_by_name() do
      %{
        ...
        messages: {2, :unpacked, {:message, Soulless.Game.Lq.ActivitySimulationGameRecordMessage}}
      }
    end
  )
