...
defmodule Soulless.Game.Lq.ReqReceiveRPGReward do
  @moduledoc false
  defstruct activity_id: 0, monster_seq: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_activity_id(msg) |> encode_monster_seq(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_monster_seq(acc, msg) do
        try do
          if msg.monster_seq == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.monster_seq)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqReceiveRPGReward))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqReceiveRPGReward,
  ...
  (
    ...
    def defs() do
      %{1 => {:activity_id, {:scalar, 0}, :uint32}, 2 => {:monster_seq, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{activity_id: {1, {:scalar, 0}, :uint32}, monster_seq: {2, {:scalar, 0}, :uint32}}
    end
  )
