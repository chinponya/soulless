...
defmodule(Soulless.Game.Lq.ReqChallangeLeaderboard) do
  @moduledoc false
  (
    defstruct(season: 0, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_season(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqChallangeLeaderboard))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqChallangeLeaderboard,
