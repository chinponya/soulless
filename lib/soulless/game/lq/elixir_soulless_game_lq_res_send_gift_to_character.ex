...
defmodule Soulless.Game.Lq.ResSendGiftToCharacter do
  @moduledoc false
  (
    defstruct error: nil, level: 0, exp: 0, __uf__: []
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResSendGiftToCharacter))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResSendGiftToCharacter,
