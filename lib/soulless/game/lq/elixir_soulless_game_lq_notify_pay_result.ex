...
defmodule(Soulless.Game.Lq.NotifyPayResult) do
  @moduledoc false
  (
    defstruct(
      pay_result: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyPayResult))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {5, _, bytes} ->
                ...
                {[
                   resource_modify:
                     msg.resource_modify ++
                       [Soulless.Game.Lq.NotifyPayResult.ResourceModify.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.NotifyPayResult,
      ...
      %{
        ...
        5 =>
          {:resource_modify, :unpacked,
           {:message, Soulless.Game.Lq.NotifyPayResult.ResourceModify}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        resource_modify:
          {5, :unpacked, {:message, Soulless.Game.Lq.NotifyPayResult.ResourceModify}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 5,
          type: {:message, Soulless.Game.Lq.NotifyPayResult.ResourceModify}
        }
      ]
    end
