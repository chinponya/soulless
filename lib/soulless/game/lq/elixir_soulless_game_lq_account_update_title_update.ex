...
defmodule Soulless.Game.Lq.AccountUpdate.TitleUpdate do
  @moduledoc false
    ...
    [
      defp encode_new_titles(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:new_titles, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_remove_titles(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:remove_titles, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.AccountUpdate.TitleUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, 2, bytes} ->
              ...
              {[new_titles: msg.new_titles ++ Protox.Decode.parse_repeated_uint32([], delimited)],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountUpdate.TitleUpdate,
