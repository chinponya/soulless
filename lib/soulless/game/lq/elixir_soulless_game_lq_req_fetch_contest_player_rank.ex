...
defmodule Soulless.Game.Lq.ReqFetchContestPlayerRank do
  @moduledoc false
  defstruct unique_id: 0, limit: 0, offset: 0, __uf__: []
      ...
      defp encode_limit(acc, msg) do
        try do
          if msg.limit == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.limit)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_offset(acc, msg) do
        try do
          if msg.offset == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.offset)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqFetchContestPlayerRank))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqFetchContestPlayerRank,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:limit, {:scalar, 0}, :uint32},
        3 => {:offset, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        limit: {2, {:scalar, 0}, :uint32},
        offset: {3, {:scalar, 0}, :uint32},
