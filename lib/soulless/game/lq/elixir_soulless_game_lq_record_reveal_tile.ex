...
defmodule Soulless.Game.Lq.RecordRevealTile do
  @moduledoc false
  defstruct seat: 0,
            is_liqi: false,
            is_wliqi: false,
      ...
      defp encode_is_liqi(acc, msg) do
        try do
          if msg.is_liqi == false do
            ...
            [acc, "\x10", Protox.Encode.encode_bool(msg.is_liqi)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_is_wliqi(acc, msg) do
        try do
          if msg.is_wliqi == false do
            ...
            [acc, "\x18", Protox.Encode.encode_bool(msg.is_wliqi)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.RecordRevealTile))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.RecordRevealTile,
