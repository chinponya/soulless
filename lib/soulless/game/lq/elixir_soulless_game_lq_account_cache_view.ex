  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountCacheView,
  ...
  (
    ...
    def defs() do
      %{
        ...
        11 => {:level, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        12 => {:playing_game, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountPlayingGame}},
        13 => {:level3, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
    ...
    def defs_by_name() do
      %{
        ...
        level: {11, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        level3: {13, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        login_time: {4, {:scalar, 0}, :uint32},
        logout_time: {5, {:scalar, 0}, :uint32},
        nickname: {3, {:scalar, ""}, :string},
        playing_game: {12, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountPlayingGame}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :playing_game,
          tag: 12,
          type: {:message, Soulless.Game.Lq.AccountPlayingGame}
        },
        %{
          __struct__: Protox.Field,
          json_name: "level3",
