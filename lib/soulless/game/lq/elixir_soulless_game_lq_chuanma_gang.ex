...
defmodule Soulless.Game.Lq.ChuanmaGang do
  @moduledoc false
  (
    defstruct old_scores: [],
              delta_scores: [],
              scores: [],
              gameend: nil,
              hules_history: [],
        ...
        defp encode_gameend(acc, msg) do
          try do
            if msg.gameend == nil do
              ...
              [acc, "\"", Protox.Encode.encode_message(msg.gameend)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ChuanmaGang))
          end
        )
      )
    ...
    def defs() do
      %{
        1 => {:old_scores, :packed, :int32},
        2 => {:delta_scores, :packed, :int32},
        3 => {:scores, :packed, :int32},
        4 => {:gameend, {:scalar, nil}, {:message, Soulless.Game.Lq.GameEnd}},
        5 => {:hules_history, :unpacked, {:message, Soulless.Game.Lq.HuleInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        delta_scores: {2, :packed, :int32},
        gameend: {4, {:scalar, nil}, {:message, Soulless.Game.Lq.GameEnd}},
        hules_history: {5, :unpacked, {:message, Soulless.Game.Lq.HuleInfo}},
        old_scores: {1, :packed, :int32},
        scores: {3, :packed, :int32}
      }
    end
