          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {7, _, bytes} ->
              ...
              {[
                 match_max_point:
                   msg.match_max_point ++
                     [Soulless.Game.Lq.ResFetchABMatch.MatchPoint.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchABMatch,
  ...
  (
    ...
    def defs() do
      %{
        ...
        7 =>
          {:match_max_point, :unpacked, {:message, Soulless.Game.Lq.ResFetchABMatch.MatchPoint}},
    ...
    def defs_by_name() do
      %{
        ...
        match_max_point: {7, :unpacked, {:message, Soulless.Game.Lq.ResFetchABMatch.MatchPoint}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          tag: 7,
          type: {:message, Soulless.Game.Lq.ResFetchABMatch.MatchPoint}
        },
        %{
          __struct__: Protox.Field,
          json_name: "quit",
