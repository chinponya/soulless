...
defmodule Soulless.Game.Lq.GameRoundPlayerResult do
  @moduledoc false
  defstruct type: 0,
            hands: [],
            ming: [],
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.GameRoundPlayerResult))
        end
      )
    )
              ...
              {[
                 hu:
                   Protox.MergeMessage.merge(
                     msg.hu,
                     Soulless.Game.Lq.GameRoundHuData.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.GameRoundPlayerResult,
  ...
  (
    ...
    def defs() do
      %{
        ...
        8 => {:hu, {:scalar, nil}, {:message, Soulless.Game.Lq.GameRoundHuData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        hu: {8, {:scalar, nil}, {:message, Soulless.Game.Lq.GameRoundHuData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :hu,
          tag: 8,
          type: {:message, Soulless.Game.Lq.GameRoundHuData}
        }
      ]
    end
