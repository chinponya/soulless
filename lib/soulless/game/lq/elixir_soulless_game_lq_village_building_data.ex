...
defmodule Soulless.Game.Lq.VillageBuildingData do
  @moduledoc false
  defstruct id: 0, reward: [], workers: [], __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_workers(acc, msg) do
        try do
          case msg.workers do
            [] ->
              acc
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:workers, "invalid field value"), __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.VillageBuildingData))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {4, 2, bytes} ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[workers: msg.workers ++ Protox.Decode.parse_repeated_uint32([], delimited)], rest}

            {4, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[workers: msg.workers ++ [value]], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.VillageBuildingData,
