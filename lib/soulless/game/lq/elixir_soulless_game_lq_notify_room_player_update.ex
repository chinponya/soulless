...
defmodule(Soulless.Game.Lq.NotifyRoomPlayerUpdate) do
  @moduledoc false
  (
    defstruct(
      update_list: [],
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyRoomPlayerUpdate))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   update_list:
                     msg.update_list ++ [Soulless.Game.Lq.PlayerBaseView.decode!(delimited)]
                 ], rest}
              ...
              {5, _, bytes} ->
                ...
                {[
                   player_list:
                     msg.player_list ++ [Soulless.Game.Lq.PlayerBaseView.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.NotifyRoomPlayerUpdate,
    ...
    def(defs()) do
      %{
        1 => {:update_list, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}},
        2 => {:remove_list, :packed, :uint32},
        3 => {:owner_id, {:scalar, 0}, :uint32},
        4 => {:robot_count, {:scalar, 0}, :uint32},
        5 => {:player_list, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        player_list: {5, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}},
        remove_list: {2, :packed, :uint32},
        robot_count: {4, {:scalar, 0}, :uint32},
        seq: {6, {:scalar, 0}, :uint32},
        update_list: {1, :unpacked, {:message, Soulless.Game.Lq.PlayerBaseView}}
      }
    end
