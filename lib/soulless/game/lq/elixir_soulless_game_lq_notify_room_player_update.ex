    ...
    [
      defp encode_update_list(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:update_list, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_remove_list(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:remove_list, "invalid field value"), __STACKTRACE__
        end
      end,
