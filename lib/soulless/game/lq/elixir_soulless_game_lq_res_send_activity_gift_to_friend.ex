...
defmodule Soulless.Game.Lq.ResSendActivityGiftToFriend do
  @moduledoc false
  defstruct error: nil, send_gift_count: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_send_gift_count(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_send_gift_count(acc, msg) do
        try do
          if msg.send_gift_count == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.send_gift_count)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResSendActivityGiftToFriend))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResSendActivityGiftToFriend,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:send_gift_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        send_gift_count: {2, {:scalar, 0}, :uint32}
      }
    end
  )
