...
defmodule Soulless.Game.Lq.ReqDigMine do
  @moduledoc false
  defstruct activity_id: 0, point: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_activity_id(msg) |> encode_point(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_point(acc, msg) do
        try do
          if msg.point == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.point)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqDigMine))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:point, {:scalar, nil}, {:message, Soulless.Game.Lq.Point}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        point: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.Point}}
      }
    end
  )
