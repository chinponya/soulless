...
defmodule(Soulless.Game.Lq.ReqOauth2Check) do
  @moduledoc false
  (
    defstruct(type: 0, access_token: "", __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_type(msg) |> encode_access_token(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqOauth2Check))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqOauth2Check,
    ...
    def(defs()) do
      %{1 => {:type, {:scalar, 0}, :uint32}, 2 => {:access_token, {:scalar, ""}, :string}}
    end
    ...
    def(defs_by_name()) do
      %{access_token: {2, {:scalar, ""}, :string}, type: {1, {:scalar, 0}, :uint32}}
    end
