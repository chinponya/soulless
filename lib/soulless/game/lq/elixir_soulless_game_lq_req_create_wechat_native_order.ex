...
defmodule Soulless.Game.Lq.ReqCreateWechatNativeOrder do
  @moduledoc false
  defstruct goods_id: 0, client_type: 0, account_id: 0, account_ip: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_account_ip(acc, msg) do
        try do
          if msg.account_ip == "" do
            acc
          else
            [acc, "\"", Protox.Encode.encode_string(msg.account_ip)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:account_ip, "invalid field value"), __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreateWechatNativeOrder))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqCreateWechatNativeOrder,
