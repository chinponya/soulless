...
defmodule Soulless.Game.Lq.SignedTimeCounterData do
  @moduledoc false
      ...
      defp encode_count(acc, msg) do
        try do
          if msg.count == 0 do
            ...
            [acc, "\b", Protox.Encode.encode_int32(msg.count)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.SignedTimeCounterData))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.SignedTimeCounterData,
  ...
  (
    ...
    def defs() do
      %{1 => {:count, {:scalar, 0}, :int32}, 2 => {:update_time, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{count: {1, {:scalar, 0}, :int32}, update_time: {2, {:scalar, 0}, :uint32}}
    end
  )
