...
defmodule Soulless.Game.Lq.ActionAnGangAddGang do
  @moduledoc false
  defstruct seat: 0,
            type: 0,
            tiles: "",
      ...
      defp encode_tiles(acc, msg) do
        try do
          if msg.tiles == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.tiles)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_muyu(acc, msg) do
        try do
          if msg.muyu == nil do
            ...
            [acc, "J", Protox.Encode.encode_message(msg.muyu)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ActionAnGangAddGang))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ActionAnGangAddGang,
  ...
  (
    ...
    def defs() do
      %{
        ...
        9 => {:muyu, {:scalar, nil}, {:message, Soulless.Game.Lq.MuyuInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        muyu: {9, {:scalar, nil}, {:message, Soulless.Game.Lq.MuyuInfo}},
