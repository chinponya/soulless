...
defmodule Soulless.Game.Lq.AccountUpdate.AccountChallengeUpdate do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.AccountUpdate.AccountChallengeUpdate))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[progresses: msg.progresses ++ [Soulless.Game.Lq.TaskProgress.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountUpdate.AccountChallengeUpdate,
