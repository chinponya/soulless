...
defmodule Soulless.Game.Lq.ReqCreateGameObserveAuth do
  @moduledoc false
  (
    defstruct game_uuid: "", __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_game_uuid(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreateGameObserveAuth))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqCreateGameObserveAuth,
