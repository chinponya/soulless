...
defmodule(Soulless.Game.Lq.GameFinalSnapshot) do
  @moduledoc false
  (
    defstruct(
      uuid: "",
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.GameFinalSnapshot))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {6, _, bytes} ->
                ...
                {[
                   calculate_param:
                     Protox.Message.merge(
                       msg.calculate_param,
                       Soulless.Game.Lq.GameFinalSnapshot.CalculateParam.decode!(delimited)
                     )
                 ], rest}
              ...
              {10, _, bytes} ->
                ...
                {[
                   seats:
                     msg.seats ++ [Soulless.Game.Lq.GameFinalSnapshot.GameSeat.decode!(delimited)]
                 ], rest}
              ...
              {11, _, bytes} ->
                ...
                {[rounds: msg.rounds ++ [Soulless.Game.Lq.GameRoundSnapshot.decode!(delimited)]],
                 rest}
              ...
              {12, _, bytes} ->
                ...
                {[
                   account_views:
                     msg.account_views ++ [Soulless.Game.Lq.PlayerGameView.decode!(delimited)]
                 ], rest}
              ...
              {13, _, bytes} ->
                ...
                {[
                   final_players:
                     msg.final_players ++
                       [Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer.decode!(delimited)]
                 ], rest}
              ...
              {14, _, bytes} ->
                ...
                {[
                   afk_info:
                     msg.afk_info ++
                       [Soulless.Game.Lq.GameFinalSnapshot.AFKInfo.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.GameFinalSnapshot,
    ...
    def(defs()) do
      %{
        ...
        4 => {:mode, {:scalar, nil}, {:message, Soulless.Game.Lq.GameMode}},
        5 => {:meta, {:scalar, nil}, {:message, Soulless.Game.Lq.GameMetaData}},
        6 =>
          {:calculate_param, {:scalar, nil},
           {:message, Soulless.Game.Lq.GameFinalSnapshot.CalculateParam}},
        7 => {:create_time, {:scalar, 0}, :uint32},
        8 => {:start_time, {:scalar, 0}, :uint32},
        9 => {:finish_time, {:scalar, 0}, :uint32},
        10 => {:seats, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.GameSeat}},
        11 => {:rounds, :unpacked, {:message, Soulless.Game.Lq.GameRoundSnapshot}},
        12 => {:account_views, :unpacked, {:message, Soulless.Game.Lq.PlayerGameView}},
        13 =>
          {:final_players, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer}},
        14 => {:afk_info, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.AFKInfo}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        account_views: {12, :unpacked, {:message, Soulless.Game.Lq.PlayerGameView}},
        afk_info: {14, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.AFKInfo}},
        calculate_param:
          {6, {:scalar, nil}, {:message, Soulless.Game.Lq.GameFinalSnapshot.CalculateParam}},
        category: {3, {:scalar, 0}, :uint32},
        create_time: {7, {:scalar, 0}, :uint32},
        final_players:
          {13, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer}},
        finish_time: {9, {:scalar, 0}, :uint32},
        meta: {5, {:scalar, nil}, {:message, Soulless.Game.Lq.GameMetaData}},
        mode: {4, {:scalar, nil}, {:message, Soulless.Game.Lq.GameMode}},
        rounds: {11, :unpacked, {:message, Soulless.Game.Lq.GameRoundSnapshot}},
        seats: {10, :unpacked, {:message, Soulless.Game.Lq.GameFinalSnapshot.GameSeat}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 6,
          type: {:message, Soulless.Game.Lq.GameFinalSnapshot.CalculateParam}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :seats,
          tag: 10,
          type: {:message, Soulless.Game.Lq.GameFinalSnapshot.GameSeat}
        },
        %{
          __struct__: Protox.Field,
          json_name: "rounds",
          ...
          name: :rounds,
          tag: 11,
          type: {:message, Soulless.Game.Lq.GameRoundSnapshot}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :final_players,
          tag: 13,
          type: {:message, Soulless.Game.Lq.GameFinalSnapshot.FinalPlayer}
        },
        %{
          __struct__: Protox.Field,
          json_name: "afkInfo",
          ...
          name: :afk_info,
          tag: 14,
          type: {:message, Soulless.Game.Lq.GameFinalSnapshot.AFKInfo}
        }
      ]
    end
