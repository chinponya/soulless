  ...
  (
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {5, _, bytes} ->
                ...
                {[
                   operation:
                     msg.operation ++ [Soulless.Game.Lq.OptionalOperationList.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.RecordLockTile,
    ...
    def defs() do
      %{
        ...
        5 => {:operation, :unpacked, {:message, Soulless.Game.Lq.OptionalOperationList}},
    ...
    def defs_by_name() do
      %{
        ...
        operation: {5, :unpacked, {:message, Soulless.Game.Lq.OptionalOperationList}},
