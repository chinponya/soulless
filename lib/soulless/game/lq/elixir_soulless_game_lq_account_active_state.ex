  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountActiveState,
  ...
  (
    ...
    def defs() do
      %{
        ...
        5 => {:playing, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountPlayingGame}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        playing: {5, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountPlayingGame}}
      }
    end
  )
