...
defmodule(Soulless.Game.Lq.ResChallengeLeaderboard.Item) do
  @moduledoc false
  (
    defstruct(account_id: 0, level: 0, nickname: "", __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResChallengeLeaderboard.Item))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResChallengeLeaderboard.Item,
