...
defmodule Soulless.Game.Lq.ResResolveFestivalActivityEvent do
  @moduledoc false
  defstruct error: nil, effected_buff: [], reward_items: [], ending_id: 0, level: 0, __uf__: []
      ...
      defp encode_ending_id(acc, msg) do
        try do
          if msg.ending_id == 0 do
            ...
            [acc, "(", Protox.Encode.encode_uint32(msg.ending_id)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_level(acc, msg) do
        try do
          if msg.level == 0 do
            ...
            [acc, "0", Protox.Encode.encode_uint32(msg.level)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResResolveFestivalActivityEvent))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResResolveFestivalActivityEvent,
  ...
  (
    ...
    def defs() do
      %{
        ...
        5 => {:ending_id, {:scalar, 0}, :uint32},
        6 => {:level, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        ending_id: {5, {:scalar, 0}, :uint32},
        error: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.Error}},
        level: {6, {:scalar, 0}, :uint32},
