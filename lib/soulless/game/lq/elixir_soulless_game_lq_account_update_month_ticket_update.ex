...
defmodule Soulless.Game.Lq.AccountUpdate.MonthTicketUpdate do
  @moduledoc false
  defstruct end_time: 0, last_pay_time: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_end_time(msg) |> encode_last_pay_time(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.AccountUpdate.MonthTicketUpdate))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountUpdate.MonthTicketUpdate,
  ...
  (
    ...
    def defs() do
      %{1 => {:end_time, {:scalar, 0}, :uint32}, 2 => {:last_pay_time, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{end_time: {1, {:scalar, 0}, :uint32}, last_pay_time: {2, {:scalar, 0}, :uint32}}
    end
  )
