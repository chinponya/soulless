...
defmodule Soulless.Game.Lq.ResCreateENJCBOrder do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResCreateENJCBOrder))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResCreateENJCBOrder,
