              ...
              {[
                 recent_10_game_result:
                   msg.recent_10_game_result ++
                     [Soulless.Game.Lq.AccountMahjongStatistic.GameResult.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountMahjongStatistic,
      ...
      %{
        ...
        2 =>
          {:recent_round, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.RoundSummary}},
        3 =>
          {:recent_hu, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.HuSummary}},
        4 =>
          {:highest_hu, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.HighestHuRecord}},
        6 =>
          {:recent_20_hu_summary, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.Liqi20Summary}},
        7 =>
          {:recent_10_hu_summary, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.LiQi10Summary}},
        8 =>
          {:recent_10_game_result, :unpacked,
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.GameResult}}
      }
    end
      ...
      %{
        ...
        highest_hu:
          {4, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountMahjongStatistic.HighestHuRecord}},
        recent_10_game_result:
          {8, :unpacked, {:message, Soulless.Game.Lq.AccountMahjongStatistic.GameResult}},
        recent_10_hu_summary:
          {7, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountMahjongStatistic.LiQi10Summary}},
        recent_20_hu_summary:
          {6, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountMahjongStatistic.Liqi20Summary}},
        recent_hu:
          {3, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountMahjongStatistic.HuSummary}},
        recent_round:
          {2, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountMahjongStatistic.RoundSummary}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :recent_round,
          tag: 2,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.RoundSummary}
        },
        %{
          __struct__: Protox.Field,
          json_name: "recentHu",
          ...
          name: :recent_hu,
          tag: 3,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.HuSummary}
        },
        %{
          __struct__: Protox.Field,
          json_name: "highestHu",
          ...
          name: :highest_hu,
          tag: 4,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.HighestHuRecord}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 6,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.Liqi20Summary}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 7,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.LiQi10Summary}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 8,
          type: {:message, Soulless.Game.Lq.AccountMahjongStatistic.GameResult}
        }
      ]
    end
