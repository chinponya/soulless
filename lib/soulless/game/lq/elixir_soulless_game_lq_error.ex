...
defmodule Soulless.Game.Lq.Error do
  @moduledoc false
        ...
        try do
          if msg.code == :OK do
            ...
            [
              acc,
              "\b",
              msg.code |> Soulless.Game.Lq.ErrorCode.encode() |> Protox.Encode.encode_enum()
            ]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.Error))
        end
      )
    )
      ...
      defp parse_key_value(bytes, msg) do
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              {value, rest} = Protox.Decode.parse_enum(bytes, Soulless.Game.Lq.ErrorCode)
              {[code: value], rest}
            ...
            {2, 2, bytes} ->
              ...
              {[u32_params: msg.u32_params ++ Protox.Decode.parse_repeated_uint32([], delimited)],
               rest}
  ...
  (
    ...
    def defs() do
      %{
        1 => {:code, {:scalar, :OK}, {:enum, Soulless.Game.Lq.ErrorCode}},
    ...
    def defs_by_name() do
      %{
        code: {1, {:scalar, :OK}, {:enum, Soulless.Game.Lq.ErrorCode}},
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :code,
          tag: 1,
          type: {:enum, Soulless.Game.Lq.ErrorCode}
        },
        %{
          __struct__: Protox.Field,
          json_name: "u32Params",
