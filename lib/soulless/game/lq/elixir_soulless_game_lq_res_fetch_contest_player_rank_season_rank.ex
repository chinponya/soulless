...
defmodule Soulless.Game.Lq.ResFetchContestPlayerRank.SeasonRank do
  @moduledoc false
  defstruct account_id: 0, nickname: "", data: nil, __uf__: []
      ...
      defp encode_data(acc, msg) do
        try do
          if msg.data == nil do
            ...
            [acc, "\x1A", Protox.Encode.encode_message(msg.data)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchContestPlayerRank.SeasonRank))
        end
      )
    )
              ...
              {[
                 data:
                   Protox.MergeMessage.merge(
                     msg.data,
                     Soulless.Game.Lq.ResFetchContestPlayerRank.ContestPlayerAccountData.decode!(
                       delimited
                     )
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchContestPlayerRank.SeasonRank,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 =>
          {:data, {:scalar, nil},
           {:message, Soulless.Game.Lq.ResFetchContestPlayerRank.ContestPlayerAccountData}}
      }
    end
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :data,
          tag: 3,
          type: {:message, Soulless.Game.Lq.ResFetchContestPlayerRank.ContestPlayerAccountData}
        }
      ]
    end
