...
defmodule(Soulless.Game.Lq.ResGameLiveInfo) do
  @moduledoc false
  (
    defstruct(
      error: nil,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResGameLiveInfo))
          end
        )
      )
                ...
                {[
                   live_head:
                     Protox.Message.merge(
                       msg.live_head,
                       Soulless.Game.Lq.GameLiveHead.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResGameLiveInfo,
    ...
    def(defs()) do
      %{
        ...
        3 => {:live_head, {:scalar, nil}, {:message, Soulless.Game.Lq.GameLiveHead}},
    ...
    def(defs_by_name()) do
      %{
        ...
        live_head: {3, {:scalar, nil}, {:message, Soulless.Game.Lq.GameLiveHead}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :live_head,
          tag: 3,
          type: {:message, Soulless.Game.Lq.GameLiveHead}
        },
        %{
          __struct__: Protox.Field,
          json_name: "segments",
