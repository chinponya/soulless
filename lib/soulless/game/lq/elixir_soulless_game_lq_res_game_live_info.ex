        ...
        defp encode_left_start_seconds(acc, msg) do
          try do
            if msg.left_start_seconds == 0 do
              ...
              [acc, "\x10", Protox.Encode.encode_uint32(msg.left_start_seconds)]
            end
          rescue
            ArgumentError ->
              reraise Protox.EncodingError.new(:left_start_seconds, "invalid field value"),
                      __STACKTRACE__
          end
        end,
        defp encode_live_head(acc, msg) do
          try do
            if msg.live_head == nil do
              ...
              [acc, "\x1A", Protox.Encode.encode_message(msg.live_head)]
            end
          rescue
            ArgumentError ->
