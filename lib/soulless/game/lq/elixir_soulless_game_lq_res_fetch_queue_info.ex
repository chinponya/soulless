...
defmodule Soulless.Game.Lq.ResFetchQueueInfo do
  @moduledoc false
  defstruct error: nil, remain: 0, rank: 0, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchQueueInfo))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchQueueInfo,
