...
defmodule Soulless.Game.Lq.ReqCreateAlipayOrder do
  @moduledoc false
  ...
  (
    ...
    [
      ...
      defp encode_alipay_trade_type(acc, msg) do
        try do
          if msg.alipay_trade_type == "" do
            acc
          else
            [acc, "\"", Protox.Encode.encode_string(msg.alipay_trade_type)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:alipay_trade_type, "invalid field value"),
                    __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreateAlipayOrder))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {4, _, bytes} ->
              ...
              {[alipay_trade_type: Protox.Decode.validate_string(delimited)], rest}

            {5, _, bytes} ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[return_url: Protox.Decode.validate_string(delimited)], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqCreateAlipayOrder,
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:alipay_trade_type, {:scalar, ""}, :string},
        5 => {:return_url, {:scalar, ""}, :string},
  ...
  (
    ...
    def fields_defs() do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "alipayTradeType",
          kind: {:scalar, ""},
          label: :optional,
          name: :alipay_trade_type,
          tag: 4,
          type: :string
        },
        %{
    ...
    [
      ...
      (
        def field_def(:alipay_trade_type) do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "alipayTradeType",
        ...
        def field_def("alipayTradeType") do
          {:ok,
           %{
             __struct__: Protox.Field,
             json_name: "alipayTradeType",
  ...
  [
    ...
    def default(:alipay_trade_type) do
      {:ok, ""}
    end,
