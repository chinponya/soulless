...
defmodule(Soulless.Game.Lq.ReqGameRecordList) do
  @moduledoc false
  (
    defstruct(start: 0, count: 0, type: 0, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqGameRecordList))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqGameRecordList,
