...
defmodule(Soulless.Game.Lq.ReqChiPengGang) do
  @moduledoc false
  (
        ...
        defp(encode_cancel_operation(acc, msg)) do
          try do
            if(msg.cancel_operation == false) do
              ...
              [acc, <<24>>, Protox.Encode.encode_bool(msg.cancel_operation)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqChiPengGang))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqChiPengGang,
