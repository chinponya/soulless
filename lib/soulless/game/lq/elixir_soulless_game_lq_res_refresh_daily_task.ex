...
defmodule Soulless.Game.Lq.ResRefreshDailyTask do
  @moduledoc false
  defstruct error: nil, progress: nil, refresh_count: 0, __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_progress(acc, msg) do
        try do
          if msg.progress == nil do
            acc
          else
            [acc, "\x12", Protox.Encode.encode_message(msg.progress)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResRefreshDailyTask))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResRefreshDailyTask,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:progress, {:scalar, nil}, {:message, Soulless.Game.Lq.TaskProgress}},
    ...
    def defs_by_name() do
      %{
        ...
        progress: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.TaskProgress}},
