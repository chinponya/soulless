    ...
    [
      ...
      defp encode_point_rong(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:point_rong, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_point_zimo_qin(acc, msg) do
        try do
          if msg.point_zimo_qin == 0 do
            ...
            [acc, "\x80\x01", Protox.Encode.encode_uint32(msg.point_zimo_qin)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_point_zimo_xian(acc, msg) do
        try do
          if msg.point_zimo_xian == 0 do
            ...
            [acc, "\x88\x01", Protox.Encode.encode_uint32(msg.point_zimo_xian)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_title_id(acc, msg) do
        try do
          if msg.title_id == 0 do
            ...
            [acc, "\x90\x01", Protox.Encode.encode_uint32(msg.title_id)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_point_sum(acc, msg) do
        try do
          if msg.point_sum == 0 do
            ...
            [acc, "\x98\x01", Protox.Encode.encode_uint32(msg.point_sum)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_dadian(acc, msg) do
        try do
          if msg.dadian == 0 do
            ...
            [acc, "\xA0\x01", Protox.Encode.encode_uint32(msg.dadian)]
          end
        rescue
          ArgumentError ->
