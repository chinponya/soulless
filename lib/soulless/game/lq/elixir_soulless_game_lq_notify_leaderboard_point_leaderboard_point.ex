...
defmodule(Soulless.Game.Lq.NotifyLeaderboardPoint.LeaderboardPoint) do
  @moduledoc false
  (
      ...
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(
              bytes,
              struct(Soulless.Game.Lq.NotifyLeaderboardPoint.LeaderboardPoint)
            )
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.NotifyLeaderboardPoint.LeaderboardPoint,
