...
defmodule Soulless.Game.Lq.ResRecoverCombiningRecycle do
  @moduledoc false
  defstruct error: nil, craft_id: 0, pos: 0, __uf__: []
      ...
      defp encode_craft_id(acc, msg) do
        try do
          if msg.craft_id == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.craft_id)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResRecoverCombiningRecycle))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResRecoverCombiningRecycle,
