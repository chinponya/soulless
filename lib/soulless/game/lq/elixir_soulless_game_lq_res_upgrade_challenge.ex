...
defmodule Soulless.Game.Lq.ResUpgradeChallenge do
  @moduledoc false
  defstruct error: nil,
            task_progress: [],
            refresh_count: 0,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResUpgradeChallenge))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResUpgradeChallenge,
