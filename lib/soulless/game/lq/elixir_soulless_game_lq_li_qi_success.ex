...
defmodule Soulless.Game.Lq.LiQiSuccess do
  @moduledoc false
  (
    defstruct seat: 0, score: 0, liqibang: 0, failed: false, __uf__: []
        ...
        defp encode_score(acc, msg) do
          try do
            if msg.score == 0 do
              ...
              [acc, "\x10", Protox.Encode.encode_int32(msg.score)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.LiQiSuccess))
          end
        )
      )
    ...
    def defs() do
      %{
        ...
        2 => {:score, {:scalar, 0}, :int32},
        3 => {:liqibang, {:scalar, 0}, :uint32},
        4 => {:failed, {:scalar, false}, :bool}
      }
    end
    ...
    def defs_by_name() do
      %{
        failed: {4, {:scalar, false}, :bool},
        liqibang: {3, {:scalar, 0}, :uint32},
        score: {2, {:scalar, 0}, :int32},
