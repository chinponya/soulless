...
defmodule Soulless.Game.Lq.ResCreatePaypalOrder do
  @moduledoc false
  defstruct error: nil, order_id: "", url: "", __uf__: []
      ...
      defp encode_url(acc, msg) do
        try do
          if msg.url == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.url)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResCreatePaypalOrder))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResCreatePaypalOrder,
