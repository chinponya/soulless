  ...
  (
            ...
            case Protox.Decode.parse_key(bytes) do
              ...
              {7, _, bytes} ->
                ...
                {[
                   buff:
                     msg.buff ++
                       [Soulless.Game.Lq.ResAccountActivityData.BuffData.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResAccountActivityData.ActivityRichmanData,
    ...
    def defs() do
      %{
        ...
        7 => {:buff, :unpacked, {:message, Soulless.Game.Lq.ResAccountActivityData.BuffData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        buff: {7, :unpacked, {:message, Soulless.Game.Lq.ResAccountActivityData.BuffData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :buff,
          tag: 7,
          type: {:message, Soulless.Game.Lq.ResAccountActivityData.BuffData}
        }
      ]
    end
