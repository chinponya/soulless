...
defmodule Soulless.Game.Lq.ResNextRoundVillage do
  @moduledoc false
  defstruct error: nil, activity_data: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_activity_data(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_activity_data(acc, msg) do
        try do
          if msg.activity_data == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.activity_data)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResNextRoundVillage))
        end
      )
    )
              ...
              {[
                 activity_data:
                   Protox.MergeMessage.merge(
                     msg.activity_data,
                     Soulless.Game.Lq.ActivityVillageData.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResNextRoundVillage,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:activity_data, {:scalar, nil}, {:message, Soulless.Game.Lq.ActivityVillageData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        activity_data: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.ActivityVillageData}},
