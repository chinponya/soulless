    ...
    [
      ...
      defp encode_rank_points(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:rank_points, "invalid field value"), __STACKTRACE__
        end
      end
    ]
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, 2, bytes} ->
              ...
              {[
                 rank_points: msg.rank_points ++ Protox.Decode.parse_repeated_int32([], delimited)
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.GameFinalSnapshot.CalculateParam,
