...
defmodule Soulless.Game.Lq.ResReceiveVillageBuildingReward do
  @moduledoc false
  defstruct error: nil, reward_items: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_reward_items(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResReceiveVillageBuildingReward))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResReceiveVillageBuildingReward,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:reward_items, :unpacked, {:message, Soulless.Game.Lq.ExecuteReward}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        reward_items: {2, :unpacked, {:message, Soulless.Game.Lq.ExecuteReward}}
      }
    end
  )
