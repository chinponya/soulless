...
defmodule Soulless.Game.Lq.ResFetchFriendGiftActivityData do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchFriendGiftActivityData))
        end
      )
    )
            ...
            {2, _, bytes} ->
              ...
              {[
                 list:
                   msg.list ++
                     [
                       Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData.decode!(
                         delimited
                       )
                     ]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchFriendGiftActivityData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 =>
          {:list, :unpacked,
           {:message, Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        list:
          {2, :unpacked, {:message, Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :list,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData}
        }
      ]
    end
