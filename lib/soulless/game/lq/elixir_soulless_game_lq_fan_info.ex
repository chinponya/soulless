...
defmodule Soulless.Game.Lq.FanInfo do
  @moduledoc false
  defstruct name: "", val: 0, id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_name(msg) |> encode_val(msg) |> encode_id(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_val(acc, msg) do
        try do
          if msg.val == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.val)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.FanInfo))
        end
      )
    )
