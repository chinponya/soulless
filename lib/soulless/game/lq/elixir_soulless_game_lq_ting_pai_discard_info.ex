        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              {len, bytes} = Protox.Varint.decode(bytes)
              {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
              {[infos: msg.infos ++ [Soulless.Game.Lq.TingPaiInfo.decode!(delimited)]], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.TingPaiDiscardInfo,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:infos, :unpacked, {:message, Soulless.Game.Lq.TingPaiInfo}}
      }
    end
