...
defmodule(Soulless.Game.Lq.ResTitleList) do
  @moduledoc false
  (
    defstruct(error: nil, title_list: [], __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_title_list(msg) |> encode_unknown_fields(msg)
        end
      )
      ...
      [
        ...
        defp(encode_title_list(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:title_list, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResTitleList))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {2, 2, bytes} ->
                ...
                {[
                   title_list:
                     msg.title_list ++ Protox.Decode.parse_repeated_uint32([], delimited)
                 ], rest}
