    ...
    [
      ...
      defp encode_detail_info(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:detail_info, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResEnterCustomizedContest,
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :detail_info,
          tag: 2,
          type: {:message, Soulless.Game.Lq.CustomizedContestDetail}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :player_report,
          tag: 3,
          type: {:message, Soulless.Game.Lq.CustomizedContestPlayerReport}
        },
        %{
          __struct__: Protox.Field,
