...
defmodule Soulless.Game.Lq.ResLevelLeaderboard.Item do
  @moduledoc false
  defstruct account_id: 0, level: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_account_id(msg) |> encode_level(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_level(acc, msg) do
        try do
          if msg.level == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.level)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResLevelLeaderboard.Item))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResLevelLeaderboard.Item,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:level, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        level: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}}
      }
    end
  )
