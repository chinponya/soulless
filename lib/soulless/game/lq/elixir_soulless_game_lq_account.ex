  ...
  (
    ...
    def(defs()) do
      %{
        ...
        6 => {:anti_addiction, {:scalar, nil}, {:message, Soulless.Game.Lq.AntiAddiction}},
        ...
        18 =>
          {:platform_diamond, :unpacked, {:message, Soulless.Game.Lq.Account.PlatformDiamond}},
        21 => {:level, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        22 => {:level3, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        23 => {:avatar_frame, {:scalar, 0}, :uint32},
        24 => {:skin_ticket, {:scalar, 0}, :uint32},
        25 =>
          {:platform_skin_ticket, :unpacked,
           {:message, Soulless.Game.Lq.Account.PlatformSkinTicket}},
        26 => {:verified, {:scalar, 0}, :uint32},
        27 => {:challenge_levels, :unpacked, {:message, Soulless.Game.Lq.Account.ChallengeLevel}},
        28 =>
          {:achievement_count, :unpacked, {:message, Soulless.Game.Lq.Account.AchievementCount}},
    ...
    def(defs_by_name()) do
      %{
        ...
        achievement_count: {28, :unpacked, {:message, Soulless.Game.Lq.Account.AchievementCount}},
        anti_addiction: {6, {:scalar, nil}, {:message, Soulless.Game.Lq.AntiAddiction}},
        avatar_frame: {23, {:scalar, 0}, :uint32},
        avatar_id: {13, {:scalar, 0}, :uint32},
        birthday: {15, {:scalar, 0}, :int32},
        challenge_levels: {27, :unpacked, {:message, Soulless.Game.Lq.Account.ChallengeLevel}},
        ...
        level: {21, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        level3: {22, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountLevel}},
        ...
        platform_diamond: {18, :unpacked, {:message, Soulless.Game.Lq.Account.PlatformDiamond}},
        platform_skin_ticket:
          {25, :unpacked, {:message, Soulless.Game.Lq.Account.PlatformSkinTicket}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :anti_addiction,
          tag: 6,
          type: {:message, Soulless.Game.Lq.AntiAddiction}
        },
        %{
          __struct__: Protox.Field,
          json_name: "title",
        ...
        %{
          ...
          tag: 18,
          type: {:message, Soulless.Game.Lq.Account.PlatformDiamond}
        },
        %{
          __struct__: Protox.Field,
          json_name: "level",
        ...
        %{
          ...
          tag: 25,
          type: {:message, Soulless.Game.Lq.Account.PlatformSkinTicket}
        },
        %{
          __struct__: Protox.Field,
          json_name: "verified",
        ...
        %{
          ...
          tag: 27,
          type: {:message, Soulless.Game.Lq.Account.ChallengeLevel}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 28,
          type: {:message, Soulless.Game.Lq.Account.AchievementCount}
        },
        %{
          __struct__: Protox.Field,
