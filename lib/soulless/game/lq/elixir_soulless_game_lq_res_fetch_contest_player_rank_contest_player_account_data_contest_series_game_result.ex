...
defmodule Soulless.Game.Lq.ResFetchContestPlayerRank.ContestPlayerAccountData.ContestSeriesGameResult do
  @moduledoc false
  defstruct key: 0, results: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_key(msg) |> encode_results(msg) |> encode_unknown_fields(msg)
      end
    )
