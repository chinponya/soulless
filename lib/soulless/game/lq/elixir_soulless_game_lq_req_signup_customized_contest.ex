...
defmodule Soulless.Game.Lq.ReqSignupCustomizedContest do
  @moduledoc false
  defstruct unique_id: 0, client_version_string: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqSignupCustomizedContest))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqSignupCustomizedContest,
  ...
  (
    ...
    def defs_by_name() do
      %{client_version_string: {2, {:scalar, ""}, :string}, unique_id: {1, {:scalar, 0}, :uint32}}
    end
  )
