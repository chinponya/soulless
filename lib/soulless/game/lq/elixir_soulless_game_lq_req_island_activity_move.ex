...
defmodule Soulless.Game.Lq.ReqIslandActivityMove do
  @moduledoc false
  defstruct activity_id: 0, zone_id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_activity_id(msg) |> encode_zone_id(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_zone_id(acc, msg) do
        try do
          if msg.zone_id == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.zone_id)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqIslandActivityMove))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqIslandActivityMove,
  ...
  (
    ...
    def defs() do
      %{1 => {:activity_id, {:scalar, 0}, :uint32}, 2 => {:zone_id, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{activity_id: {1, {:scalar, 0}, :uint32}, zone_id: {2, {:scalar, 0}, :uint32}}
    end
  )
