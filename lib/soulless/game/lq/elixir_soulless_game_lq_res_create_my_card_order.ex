...
defmodule Soulless.Game.Lq.ResCreateMyCardOrder do
  @moduledoc false
  defstruct error: nil, auth_code: "", order_id: "", __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_auth_code(acc, msg) do
        try do
          if msg.auth_code == "" do
            acc
          else
            [acc, "\x12", Protox.Encode.encode_string(msg.auth_code)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:auth_code, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResCreateMyCardOrder))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResCreateMyCardOrder,
