...
defmodule Soulless.Game.Lq.ResBagInfo do
  @moduledoc false
  defstruct error: nil, bag: nil, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_bag(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_bag(acc, msg) do
        try do
          if msg.bag == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.bag)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResBagInfo))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[bag: Protox.MergeMessage.merge(msg.bag, Soulless.Game.Lq.Bag.decode!(delimited))],
               rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:bag, {:scalar, nil}, {:message, Soulless.Game.Lq.Bag}}
      }
    end
    ...
    def defs_by_name() do
      %{
        bag: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.Bag}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :bag,
          tag: 2,
          type: {:message, Soulless.Game.Lq.Bag}
        }
      ]
    end
