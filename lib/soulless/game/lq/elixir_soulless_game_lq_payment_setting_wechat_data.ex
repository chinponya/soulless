...
defmodule Soulless.Game.Lq.PaymentSetting.WechatData do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.PaymentSetting.WechatData))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[disable_create: value], rest}

            {2, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[payment_source_platform: value], rest}

            {3, _, bytes} ->
              {value, rest} = Protox.Decode.parse_bool(bytes)
              {[enable_credit: value], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.PaymentSetting.WechatData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:enable_credit, {:scalar, false}, :bool}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        payment_source_platform: {2, {:scalar, 0}, :uint32}
      }
    end
  )
  ...
  (
    ...
    def fields_defs() do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "paymentSourcePlatform",
          kind: {:scalar, 0},
          label: :optional,
          name: :payment_source_platform,
          tag: 2,
          type: :uint32
        },
        %{
          __struct__: Protox.Field,
          json_name: "enableCredit",
          kind: {:scalar, false},
          label: :optional,
          name: :enable_credit,
          tag: 3,
