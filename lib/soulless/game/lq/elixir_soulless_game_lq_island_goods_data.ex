...
defmodule Soulless.Game.Lq.IslandGoodsData do
  @moduledoc false
  defstruct goods_id: 0, count: 0, update_time: 0, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.IslandGoodsData))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.IslandGoodsData,
