...
defmodule Soulless.Game.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Game.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData)
          )
        end
      )
    )
