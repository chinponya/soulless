...
defmodule Soulless.Game.Lq.ReqClientMessage do
  @moduledoc false
  (
    defstruct timestamp: 0, message: "", __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_timestamp(msg) |> encode_message(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqClientMessage))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqClientMessage,
    ...
    def defs() do
      %{1 => {:timestamp, {:scalar, 0}, :uint32}, 2 => {:message, {:scalar, ""}, :string}}
    end
    ...
    def defs_by_name() do
      %{message: {2, {:scalar, ""}, :string}, timestamp: {1, {:scalar, 0}, :uint32}}
    end
