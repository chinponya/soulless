...
defmodule Soulless.Game.Lq.NotifyActivityChange do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyActivityChange))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 new_activities:
                   msg.new_activities ++ [Soulless.Game.Lq.Activity.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.NotifyActivityChange,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:new_activities, :unpacked, {:message, Soulless.Game.Lq.Activity}},
    ...
    def defs_by_name() do
      %{
        ...
        new_activities: {1, :unpacked, {:message, Soulless.Game.Lq.Activity}}
      }
    end
  )
