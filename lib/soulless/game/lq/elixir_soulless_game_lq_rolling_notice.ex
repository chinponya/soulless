...
defmodule Soulless.Game.Lq.RollingNotice do
  @moduledoc false
  (
    defstruct id: 0,
              content: "",
      ...
      [
        ...
        defp encode_repeat_interval(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:repeat_interval, "invalid field value"),
                      __STACKTRACE__
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.RollingNotice))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.RollingNotice,
