...
defmodule Soulless.Game.Lq.RecordChangeTile.TingPai do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.RecordChangeTile.TingPai))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.RecordChangeTile.TingPai,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:tingpais1, :unpacked, {:message, Soulless.Game.Lq.TingPaiInfo}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        tingpais1: {2, :unpacked, {:message, Soulless.Game.Lq.TingPaiInfo}}
      }
    end
  )
