...
defmodule(Soulless.Game.Lq.ReqCreatePaypalOrder) do
  @moduledoc false
  (
    defstruct(goods_id: 0, client_type: 0, account_id: 0, debt_order_id: "", __uf__: [])
      ...
      [
        ...
        defp(encode_debt_order_id(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:debt_order_id, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreatePaypalOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqCreatePaypalOrder,
