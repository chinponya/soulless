...
defmodule Soulless.Game.Lq.ResGetFriendVillageData.FriendVillageData do
  @moduledoc false
  defstruct account_id: 0, level: 0, __uf__: []
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Game.Lq.ResGetFriendVillageData.FriendVillageData)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResGetFriendVillageData.FriendVillageData,
  ...
  (
    ...
    def defs() do
      %{1 => {:account_id, {:scalar, 0}, :uint32}, 2 => {:level, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{account_id: {1, {:scalar, 0}, :uint32}, level: {2, {:scalar, 0}, :uint32}}
    end
  )
