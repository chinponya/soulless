...
defmodule Soulless.Game.Lq.GameSnapshot.PlayerSnapshot.Fulu do
  @moduledoc false
  (
    defstruct type: 0, tile: [], from: [], __uf__: []
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.GameSnapshot.PlayerSnapshot.Fulu))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {3, 2, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[from: msg.from ++ Protox.Decode.parse_repeated_uint32([], delimited)], rest}

              {3, _, bytes} ->
                {value, rest} = Protox.Decode.parse_uint32(bytes)
                {[from: msg.from ++ [value]], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.GameSnapshot.PlayerSnapshot.Fulu,
    ...
    def defs() do
      %{
        ...
        2 => {:tile, :unpacked, :string},
        3 => {:from, :packed, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        from: {3, :packed, :uint32},
        tile: {2, :unpacked, :string},
