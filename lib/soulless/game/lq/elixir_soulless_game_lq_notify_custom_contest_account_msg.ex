...
defmodule Soulless.Game.Lq.NotifyCustomContestAccountMsg do
  @moduledoc false
  defstruct unique_id: 0, account_id: 0, sender: "", content: "", verified: 0, __uf__: []
      ...
      defp encode_sender(acc, msg) do
        try do
          if msg.sender == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.sender)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyCustomContestAccountMsg))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              ...
              {[sender: Protox.Decode.validate_string(delimited)], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.NotifyCustomContestAccountMsg,
