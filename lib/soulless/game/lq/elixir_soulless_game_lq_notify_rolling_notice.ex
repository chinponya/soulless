...
defmodule Soulless.Game.Lq.NotifyRollingNotice do
              ...
              {[
                 notice:
                   Protox.MergeMessage.merge(
                     msg.notice,
                     Soulless.Game.Lq.RollingNotice.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def defs() do
      %{1 => {:notice, {:scalar, nil}, {:message, Soulless.Game.Lq.RollingNotice}}}
    end
    ...
    def defs_by_name() do
      %{notice: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.RollingNotice}}}
    end
  )
