...
defmodule Soulless.Game.Lq.ResSetVillageWorker do
  @moduledoc false
  defstruct error: nil, building: nil, update_time: 0, __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_building(acc, msg) do
        try do
          if msg.building == nil do
            acc
          else
            [acc, "\x12", Protox.Encode.encode_message(msg.building)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:building, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResSetVillageWorker))
        end
      )
    )
              ...
              {[
                 building:
                   Protox.MergeMessage.merge(
                     msg.building,
                     Soulless.Game.Lq.VillageBuildingData.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResSetVillageWorker,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:building, {:scalar, nil}, {:message, Soulless.Game.Lq.VillageBuildingData}},
    ...
    def defs_by_name() do
      %{
        building: {2, {:scalar, nil}, {:message, Soulless.Game.Lq.VillageBuildingData}},
