...
defmodule Soulless.Game.Lq.BillingProduct do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        ...
        |> encode_currency_price(msg)
        |> encode_sort_weight(msg)
    ...
    [
      ...
      defp encode_sort_weight(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:sort_weight, "invalid field value"), __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.BillingProduct))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
              ...
              {[
                 goods:
                   Protox.MergeMessage.merge(
                     msg.goods,
                     Soulless.Game.Lq.BillingGoods.decode!(delimited)
                   )
               ], rest}
            ...
            {3, _, bytes} ->
              ...
              {[currency_price: value], rest}

            {4, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[sort_weight: value], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.BillingProduct,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:goods, {:scalar, nil}, {:message, Soulless.Game.Lq.BillingGoods}},
        2 => {:currency_code, {:scalar, ""}, :string},
        3 => {:currency_price, {:scalar, 0}, :uint32},
        4 => {:sort_weight, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        goods: {1, {:scalar, nil}, {:message, Soulless.Game.Lq.BillingGoods}},
        sort_weight: {4, {:scalar, 0}, :uint32}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :goods,
          tag: 1,
          type: {:message, Soulless.Game.Lq.BillingGoods}
        },
        %{
          __struct__: Protox.Field,
