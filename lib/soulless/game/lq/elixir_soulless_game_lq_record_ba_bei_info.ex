...
defmodule Soulless.Game.Lq.RecordBaBeiInfo do
  @moduledoc false
      ...
      defp encode_is_zi_mo(acc, msg) do
        try do
          if msg.is_zi_mo == false do
            ...
            [acc, "\x10", Protox.Encode.encode_bool(msg.is_zi_mo)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_is_chong(acc, msg) do
        try do
          if msg.is_chong == false do
            ...
            [acc, "\x18", Protox.Encode.encode_bool(msg.is_chong)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.RecordBaBeiInfo))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.RecordBaBeiInfo,
