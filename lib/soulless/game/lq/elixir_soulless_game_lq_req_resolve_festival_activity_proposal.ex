...
defmodule Soulless.Game.Lq.ReqResolveFestivalActivityProposal do
  @moduledoc false
  defstruct activity_id: 0, id: 0, select: 0, __uf__: []
      ...
      defp encode_select(acc, msg) do
        try do
          if msg.select == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.select)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqResolveFestivalActivityProposal))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqResolveFestivalActivityProposal,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:id, {:scalar, 0}, :uint32},
        3 => {:select, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        id: {2, {:scalar, 0}, :uint32},
        select: {3, {:scalar, 0}, :uint32}
      }
    end
  )
