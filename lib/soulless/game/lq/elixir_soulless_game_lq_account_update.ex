  ...
  (
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {3, _, bytes} ->
                ...
                {[
                   bag:
                     Protox.Message.merge(msg.bag, Soulless.Game.Lq.BagUpdate.decode!(delimited))
                 ], rest}
              ...
              {15, _, bytes} ->
                ...
                {[
                   activity:
                     Protox.Message.merge(
                       msg.activity,
                       Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        15 =>
          {:activity, {:scalar, nil},
           {:message, Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        activity:
          {15, {:scalar, nil}, {:message, Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate}},
        activity_flip_task:
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :activity,
          tag: 15,
          type: {:message, Soulless.Game.Lq.AccountUpdate.AccountActivityUpdate}
        }
      ]
    end
