...
defmodule Soulless.Game.Lq.ReqAccountStatisticInfo do
  @moduledoc false
  (
    defstruct account_id: 0, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_account_id(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqAccountStatisticInfo))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqAccountStatisticInfo,
