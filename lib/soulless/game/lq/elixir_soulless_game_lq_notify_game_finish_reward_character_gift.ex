...
defmodule(Soulless.Game.Lq.NotifyGameFinishReward.CharacterGift) do
  @moduledoc false
  (
        ...
        defp(encode_final(acc, msg)) do
          try do
            if(msg.final == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.final)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.NotifyGameFinishReward.CharacterGift))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.NotifyGameFinishReward.CharacterGift,
