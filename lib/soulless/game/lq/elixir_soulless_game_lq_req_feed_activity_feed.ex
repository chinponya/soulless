...
defmodule Soulless.Game.Lq.ReqFeedActivityFeed do
  @moduledoc false
  defstruct activity_id: 0, count: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_activity_id(msg) |> encode_count(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqFeedActivityFeed))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqFeedActivityFeed,
  ...
  (
    ...
    def defs() do
      %{1 => {:activity_id, {:scalar, 0}, :uint32}, 2 => {:count, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{activity_id: {1, {:scalar, 0}, :uint32}, count: {2, {:scalar, 0}, :uint32}}
    end
  )
