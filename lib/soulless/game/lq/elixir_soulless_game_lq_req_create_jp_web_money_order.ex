...
defmodule(Soulless.Game.Lq.ReqCreateJPWebMoneyOrder) do
  @moduledoc false
  (
    defstruct(
      goods_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqCreateJPWebMoneyOrder))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ReqCreateJPWebMoneyOrder,
