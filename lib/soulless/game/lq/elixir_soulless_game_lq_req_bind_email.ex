...
defmodule(Soulless.Game.Lq.ReqBindEmail) do
  @moduledoc false
  (
    defstruct(email: "", code: "", password: "", __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ReqBindEmail))
          end
        )
      )
