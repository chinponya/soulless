...
defmodule Soulless.Game.Lq.ActivitySimulationGameRecordMessage do
  @moduledoc false
  defstruct type: 0, args: [], xun: 0, __uf__: []
      ...
      defp encode_xun(acc, msg) do
        try do
          if msg.xun == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.xun)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ActivitySimulationGameRecordMessage))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, 2, bytes} ->
              ...
              {[args: msg.args ++ Protox.Decode.parse_repeated_uint32([], delimited)], rest}

            {2, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[args: msg.args ++ [value]], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ActivitySimulationGameRecordMessage,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:args, :packed, :uint32},
        3 => {:xun, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        args: {2, :packed, :uint32},
        type: {1, {:scalar, 0}, :uint32},
        xun: {3, {:scalar, 0}, :uint32}
      }
    end
  )
