...
defmodule Soulless.Game.Lq.ResMutiChallengeLevel do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResMutiChallengeLevel))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[
                 items:
                   msg.items ++ [Soulless.Game.Lq.ResMutiChallengeLevel.Item.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResMutiChallengeLevel,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:items, :unpacked, {:message, Soulless.Game.Lq.ResMutiChallengeLevel.Item}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        items: {2, :unpacked, {:message, Soulless.Game.Lq.ResMutiChallengeLevel.Item}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :items,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResMutiChallengeLevel.Item}
        }
      ]
    end
