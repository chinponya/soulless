...
defmodule Soulless.Game.Lq.ResRichmanChestInfo do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResRichmanChestInfo))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 items:
                   msg.items ++ [Soulless.Game.Lq.ResRichmanChestInfo.ItemData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResRichmanChestInfo,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:items, :unpacked, {:message, Soulless.Game.Lq.ResRichmanChestInfo.ItemData}},
    ...
    def defs_by_name() do
      %{
        ...
        items: {1, :unpacked, {:message, Soulless.Game.Lq.ResRichmanChestInfo.ItemData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :items,
          tag: 1,
          type: {:message, Soulless.Game.Lq.ResRichmanChestInfo.ItemData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "error",
