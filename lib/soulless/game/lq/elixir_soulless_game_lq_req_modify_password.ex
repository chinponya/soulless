      ...
      [
        defp encode_new_password(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:new_password, "invalid field value"),
                      __STACKTRACE__
          end
        end,
        defp encode_old_password(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:old_password, "invalid field value"),
                      __STACKTRACE__
          end
        end,
        defp encode_secure_token(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:secure_token, "invalid field value"),
                      __STACKTRACE__
          end
        end
      ]
