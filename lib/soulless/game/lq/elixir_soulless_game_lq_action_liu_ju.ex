...
defmodule Soulless.Game.Lq.ActionLiuJu do
  @moduledoc false
  defstruct type: 0,
            gameend: nil,
            seat: 0,
    ...
    [
      ...
      defp encode_gameend(acc, msg) do
        try do
          if msg.gameend == nil do
            ...
            [acc, "\x12", Protox.Encode.encode_message(msg.gameend)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_allplayertiles(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:allplayertiles, "invalid field value"),
                    __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ActionLiuJu))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:gameend, {:scalar, nil}, {:message, Soulless.Game.Lq.GameEnd}},
        ...
        7 => {:muyu, {:scalar, nil}, {:message, Soulless.Game.Lq.MuyuInfo}},
