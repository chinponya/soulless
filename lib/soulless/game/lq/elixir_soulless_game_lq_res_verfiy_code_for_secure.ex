...
defmodule Soulless.Game.Lq.ResVerfiyCodeForSecure do
  @moduledoc false
  defstruct error: nil, secure_token: "", __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_secure_token(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_secure_token(acc, msg) do
        try do
          if msg.secure_token == "" do
            ...
            [acc, "\x12", Protox.Encode.encode_string(msg.secure_token)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResVerfiyCodeForSecure))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResVerfiyCodeForSecure,
