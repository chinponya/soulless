...
defmodule Soulless.Game.Lq.ReqIslandActivityUnlockBagGrid do
  @moduledoc false
  defstruct activity_id: 0, bag_id: 0, pos: [], __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqIslandActivityUnlockBagGrid))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqIslandActivityUnlockBagGrid,
