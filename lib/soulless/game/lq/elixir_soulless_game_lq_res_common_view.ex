...
defmodule Soulless.Game.Lq.ResCommonView do
  @moduledoc false
  defstruct error: nil, slots: [], __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_slots(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResCommonView))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              ...
              {[slots: msg.slots ++ [Soulless.Game.Lq.ResCommonView.Slot.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResCommonView,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:slots, :unpacked, {:message, Soulless.Game.Lq.ResCommonView.Slot}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        slots: {2, :unpacked, {:message, Soulless.Game.Lq.ResCommonView.Slot}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :slots,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResCommonView.Slot}
        }
      ]
    end
