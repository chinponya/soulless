...
defmodule Soulless.Game.Lq.SegmentTaskProgress do
  @moduledoc false
  defstruct id: 0,
            counter: 0,
            achieved: false,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.SegmentTaskProgress))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.SegmentTaskProgress,
