...
defmodule Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData)
          )
        end
      )
    )
            ...
            {2, _, bytes} ->
              ...
              {[
                 items:
                   msg.items ++
                     [
                       Soulless.Game.Lq.ResFetchFriendGiftActivityData.ItemCountData.decode!(
                         delimited
                       )
                     ]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchFriendGiftActivityData.FriendData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 =>
          {:items, :unpacked,
           {:message, Soulless.Game.Lq.ResFetchFriendGiftActivityData.ItemCountData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :items,
          tag: 2,
          type: {:message, Soulless.Game.Lq.ResFetchFriendGiftActivityData.ItemCountData}
        },
        %{
          __struct__: Protox.Field,
