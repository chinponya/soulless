...
defmodule Soulless.Game.Lq.ResChangeCollectedGameRecordRemarks do
  @moduledoc false
  (
    defstruct error: nil, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_error(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResChangeCollectedGameRecordRemarks))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResChangeCollectedGameRecordRemarks,
