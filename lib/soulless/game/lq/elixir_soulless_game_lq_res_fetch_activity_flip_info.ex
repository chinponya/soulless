...
defmodule Soulless.Game.Lq.ResFetchActivityFlipInfo do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ResFetchActivityFlipInfo))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, 2, bytes} ->
              ...
              {[rewards: msg.rewards ++ Protox.Decode.parse_repeated_uint32([], delimited)], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ResFetchActivityFlipInfo,
