...
defmodule Soulless.Game.Lq.AccountMiscSnapshot.AccountRechargeInfo.RechargeRecord do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Game.Lq.AccountMiscSnapshot.AccountRechargeInfo.RechargeRecord)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.AccountMiscSnapshot.AccountRechargeInfo.RechargeRecord,
