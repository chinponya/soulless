...
defmodule Soulless.Game.Lq.RecordHule do
  @moduledoc false
  (
    defstruct hules: [],
              old_scores: [],
      ...
      [
        ...
        defp encode_wait_timeout(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:wait_timeout, "invalid field value"),
                      __STACKTRACE__
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.RecordHule))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                ...
                {[hules: msg.hules ++ [Soulless.Game.Lq.HuleInfo.decode!(delimited)]], rest}
    ...
    def defs() do
      %{
        1 => {:hules, :unpacked, {:message, Soulless.Game.Lq.HuleInfo}},
