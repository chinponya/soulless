...
defmodule(Soulless.Game.Lq.ResAchievement) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Game.Lq.ResAchievement))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Game.Lq.ResAchievement,
    ...
    def(defs()) do
      %{
        ...
        2 => {:progresses, :unpacked, {:message, Soulless.Game.Lq.AchievementProgress}},
    ...
    def(defs_by_name()) do
      %{
        ...
        progresses: {2, :unpacked, {:message, Soulless.Game.Lq.AchievementProgress}},
