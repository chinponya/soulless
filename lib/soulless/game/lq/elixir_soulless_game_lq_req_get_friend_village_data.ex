...
defmodule Soulless.Game.Lq.ReqGetFriendVillageData do
  @moduledoc false
  defstruct account_list: [], activity_id: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_account_list(msg) |> encode_activity_id(msg) |> encode_unknown_fields(msg)
      end
    )
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqGetFriendVillageData))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqGetFriendVillageData,
  ...
  (
    ...
    def defs() do
      %{1 => {:account_list, :packed, :uint32}, 2 => {:activity_id, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{account_list: {1, :packed, :uint32}, activity_id: {2, {:scalar, 0}, :uint32}}
    end
  )
