...
defmodule Soulless.Game.Lq.ReqIslandActivityTidyBag.BagData.ITemData do
  @moduledoc false
  defstruct id: 0, pos: [], rotate: 0, __uf__: []
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Game.Lq.ReqIslandActivityTidyBag.BagData.ITemData)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqIslandActivityTidyBag.BagData.ITemData,
