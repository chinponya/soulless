...
defmodule Soulless.Game.Lq.ReqUpdateManagerCustomizedContest do
  @moduledoc false
  defstruct name: "",
            open_show: 0,
      ...
      defp encode_unique_id(acc, msg) do
        try do
          if msg.unique_id == 0 do
            ...
            [acc, "0", Protox.Encode.encode_uint32(msg.unique_id)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_contest_setting(acc, msg) do
        try do
          if msg.contest_setting == nil do
            ...
            [acc, "J", Protox.Encode.encode_message(msg.contest_setting)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Game.Lq.ReqUpdateManagerCustomizedContest))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Game.Lq.ReqUpdateManagerCustomizedContest,
  ...
  (
    ...
    def defs() do
      %{
        ...
        6 => {:unique_id, {:scalar, 0}, :uint32},
        7 => {:auto_match, {:scalar, 0}, :uint32},
        8 => {:rank_rule, {:scalar, 0}, :uint32},
        9 => {:contest_setting, {:scalar, nil}, {:message, Soulless.Game.Lq.ContestSetting}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        contest_setting: {9, {:scalar, nil}, {:message, Soulless.Game.Lq.ContestSetting}},
