...
defmodule(Soulless.Tourney.Lq.NotifyVipLevelChange) do
  @moduledoc false
  (
    defstruct(
      gift_limit: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyVipLevelChange))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyVipLevelChange,
