...
defmodule Soulless.Tourney.Lq.AccountMahjongStatistic do
  @moduledoc false
    ...
    [
      ...
      defp encode_recent_round(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:recent_round, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountMahjongStatistic))
        end
      )
    )
            ...
            {1, 2, bytes} ->
              ...
              {[
                 final_position_counts:
                   msg.final_position_counts ++ Protox.Decode.parse_repeated_uint32([], delimited)
               ], rest}
              ...
              {[
                 recent_round:
                   Protox.MergeMessage.merge(
                     msg.recent_round,
                     Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary.decode!(delimited)
                   )
               ], rest}
            ...
            {3, _, bytes} ->
              ...
              {[
                 recent_hu:
                   Protox.MergeMessage.merge(
                     msg.recent_hu,
                     Soulless.Tourney.Lq.AccountMahjongStatistic.HuSummary.decode!(delimited)
                   )
               ], rest}
            ...
            {4, _, bytes} ->
              ...
              {[
                 highest_hu:
                   Protox.MergeMessage.merge(
                     msg.highest_hu,
                     Soulless.Tourney.Lq.AccountMahjongStatistic.HighestHuRecord.decode!(
                       delimited
                     )
                   )
               ], rest}
              ...
              {[
                 recent_20_hu_summary:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountMahjongStatistic.Liqi20Summary.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 recent_10_hu_summary:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountMahjongStatistic.LiQi10Summary.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 recent_10_game_result:
                   msg.recent_10_game_result ++
                     [Soulless.Tourney.Lq.AccountMahjongStatistic.GameResult.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountMahjongStatistic,
      ...
      %{
        ...
        2 =>
          {:recent_round, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary}},
        3 =>
          {:recent_hu, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HuSummary}},
        4 =>
          {:highest_hu, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HighestHuRecord}},
        6 =>
          {:recent_20_hu_summary, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.Liqi20Summary}},
        7 =>
          {:recent_10_hu_summary, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.LiQi10Summary}},
        8 =>
          {:recent_10_game_result, :unpacked,
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.GameResult}}
      }
    end
      ...
      %{
        ...
        highest_hu:
          {4, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HighestHuRecord}},
        recent_10_game_result:
          {8, :unpacked, {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.GameResult}},
        recent_10_hu_summary:
          {7, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.LiQi10Summary}},
        recent_20_hu_summary:
          {6, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.Liqi20Summary}},
        recent_hu:
          {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HuSummary}},
        recent_round:
          {2, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary}}
      }
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :recent_round,
          tag: 2,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary}
        },
        %{
          __struct__: Protox.Field,
          json_name: "recentHu",
          ...
          name: :recent_hu,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HuSummary}
        },
        %{
          __struct__: Protox.Field,
          json_name: "highestHu",
          ...
          name: :highest_hu,
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.HighestHuRecord}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 6,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.Liqi20Summary}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 7,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.LiQi10Summary}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 8,
          type: {:message, Soulless.Tourney.Lq.AccountMahjongStatistic.GameResult}
        }
      ]
    end
