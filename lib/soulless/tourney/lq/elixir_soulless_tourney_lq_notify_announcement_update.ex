            ...
            {1, _, bytes} ->
              ...
              {[
                 update_list:
                   msg.update_list ++
                     [
                       Soulless.Tourney.Lq.NotifyAnnouncementUpdate.AnnouncementUpdate.decode!(
                         delimited
                       )
                     ]
               ], rest}
      ...
      %{
        1 =>
          {:update_list, :unpacked,
           {:message, Soulless.Tourney.Lq.NotifyAnnouncementUpdate.AnnouncementUpdate}}
      }
    end
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :update_list,
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.NotifyAnnouncementUpdate.AnnouncementUpdate}
        }
      ]
    end
