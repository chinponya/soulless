...
defmodule(Soulless.Tourney.Lq.Activity) do
  @moduledoc false
  (
    defstruct(activity_id: 0, start_time: 0, end_time: 0, type: "", __uf__: [])
        ...
        defp(encode_type(acc, msg)) do
          try do
            if(msg.type == "") do
              ...
              [acc, "\"", Protox.Encode.encode_string(msg.type)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.Activity))
          end
        )
      )
