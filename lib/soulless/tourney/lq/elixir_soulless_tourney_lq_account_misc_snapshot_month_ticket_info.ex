...
defmodule Soulless.Tourney.Lq.AccountMiscSnapshot.MonthTicketInfo do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountMiscSnapshot.MonthTicketInfo))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountMiscSnapshot.MonthTicketInfo,
