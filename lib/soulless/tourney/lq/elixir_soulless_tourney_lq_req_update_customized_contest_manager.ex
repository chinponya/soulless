...
defmodule Soulless.Tourney.Lq.ReqUpdateCustomizedContestManager do
  @moduledoc false
  (
    defstruct setting_type: 0, nicknames: [], account_ids: [], __uf__: []
      ...
      [
        defp encode_setting_type(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:setting_type, "invalid field value"),
                      __STACKTRACE__
          end
        end,
        ...
        defp encode_account_ids(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:account_ids, "invalid field value"),
                      __STACKTRACE__
          end
        end
      ]
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ReqUpdateCustomizedContestManager))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ReqUpdateCustomizedContestManager,
