...
defmodule Soulless.Tourney.Lq.ActivityFriendGiftData do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.ActivityFriendGiftData))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
              ...
              {[
                 receive_data:
                   Protox.MergeMessage.merge(
                     msg.receive_data,
                     Soulless.Tourney.Lq.ActivityFriendGiftData.CountWithTimeData.decode!(
                       delimited
                     )
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 gift_inbox:
                   msg.gift_inbox ++
                     [Soulless.Tourney.Lq.ActivityFriendGiftData.GiftBoxData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ActivityFriendGiftData,
  ...
  (
      ...
      %{
        ...
        3 =>
          {:receive_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.CountWithTimeData}},
        4 =>
          {:send_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.CountWithTimeData}},
        5 =>
          {:gift_inbox, :unpacked,
           {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.GiftBoxData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        gift_inbox:
          {5, :unpacked, {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.GiftBoxData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :receive_data,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.CountWithTimeData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "sendData",
        ...
        %{
          ...
          name: :gift_inbox,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.ActivityFriendGiftData.GiftBoxData}
        }
      ]
    end
