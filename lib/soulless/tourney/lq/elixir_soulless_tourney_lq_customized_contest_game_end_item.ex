...
defmodule Soulless.Tourney.Lq.CustomizedContestGameEnd.Item do
  @moduledoc false
  defstruct account_id: 0, nickname: "", total_point: 0, __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.CustomizedContestGameEnd.Item))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.CustomizedContestGameEnd.Item,
