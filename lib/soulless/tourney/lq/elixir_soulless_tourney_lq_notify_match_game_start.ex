...
defmodule Soulless.Tourney.Lq.NotifyMatchGameStart do
  @moduledoc false
  (
    defstruct game_url: "",
              connect_token: "",
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyMatchGameStart))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyMatchGameStart,
