...
defmodule(Soulless.Tourney.Lq.GameRoundPlayer) do
  @moduledoc false
  (
    defstruct(score: 0, rank: 0, result: nil, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameRoundPlayer))
          end
        )
      )
                ...
                {[
                   result:
                     Protox.Message.merge(
                       msg.result,
                       Soulless.Tourney.Lq.GameRoundPlayerResult.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.GameRoundPlayer,
    ...
    def(defs()) do
      %{
        ...
        3 => {:result, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRoundPlayerResult}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        result: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRoundPlayerResult}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :result,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.GameRoundPlayerResult}
        }
      ]
    end
