...
defmodule Soulless.Tourney.Lq.GameLiveHead do
  @moduledoc false
    ...
    [
      ...
      defp encode_game_config(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:game_config, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameLiveHead))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {4, _, bytes} ->
              ...
              {[players: msg.players ++ [Soulless.Tourney.Lq.PlayerGameView.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.GameLiveHead,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:game_config, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameConfig}},
        4 => {:players, :unpacked, {:message, Soulless.Tourney.Lq.PlayerGameView}},
        5 => {:seat_list, :packed, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        game_config: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameConfig}},
        players: {4, :unpacked, {:message, Soulless.Tourney.Lq.PlayerGameView}},
        seat_list: {5, :packed, :uint32},
