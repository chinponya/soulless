...
defmodule Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData do
  @moduledoc false
  defstruct count: 0, last_update_time: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_count(msg) |> encode_last_update_time(msg) |> encode_unknown_fields(msg)
      end
    )
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData)
          )
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{1 => {:count, {:scalar, 0}, :uint32}, 2 => {:last_update_time, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{count: {1, {:scalar, 0}, :uint32}, last_update_time: {2, {:scalar, 0}, :uint32}}
    end
  )
