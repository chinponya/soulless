...
defmodule(Soulless.Tourney.Lq.GameMode) do
  @moduledoc false
  (
    defstruct(
      mode: 0,
      ...
      [
        ...
        defp(encode_extendinfo(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:extendinfo, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_detail_rule(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:detail_rule, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_testing_environment(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:testing_environment, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_game_setting(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:game_setting, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameMode))
          end
        )
      )
                ...
                {[
                   detail_rule:
                     Protox.Message.merge(
                       msg.detail_rule,
                       Soulless.Tourney.Lq.GameDetailRule.decode!(delimited)
                     )
                 ], rest}
                ...
                {[
                   testing_environment:
                     Protox.Message.merge(
                       ...
                       Soulless.Tourney.Lq.GameTestingEnvironmentSet.decode!(delimited)
                     )
                 ], rest}
              ...
              {8, _, bytes} ->
                ...
                {[
                   game_setting:
                     Protox.Message.merge(
                       msg.game_setting,
                       Soulless.Tourney.Lq.GameSetting.decode!(delimited)
                     )
                 ], rest}
    ...
    def(defs()) do
      %{
        ...
        6 => {:detail_rule, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameDetailRule}},
        7 =>
          {:testing_environment, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.GameTestingEnvironmentSet}},
        8 => {:game_setting, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameSetting}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        detail_rule: {6, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameDetailRule}},
        extendinfo: {5, {:scalar, ""}, :string},
        game_setting: {8, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameSetting}},
        mode: {1, {:scalar, 0}, :uint32},
        testing_environment:
          {7, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameTestingEnvironmentSet}}
      }
    end
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :detail_rule,
          tag: 6,
          type: {:message, Soulless.Tourney.Lq.GameDetailRule}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 7,
          type: {:message, Soulless.Tourney.Lq.GameTestingEnvironmentSet}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :game_setting,
          tag: 8,
          type: {:message, Soulless.Tourney.Lq.GameSetting}
        }
      ]
    end
