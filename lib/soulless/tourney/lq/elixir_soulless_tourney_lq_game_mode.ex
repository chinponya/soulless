    ...
    [
      ...
      defp encode_detail_rule(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:detail_rule, "invalid field value"), __STACKTRACE__
        end
      end,
      ...
      defp encode_game_setting(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:game_setting, "invalid field value"), __STACKTRACE__
        end
      end
    ]
