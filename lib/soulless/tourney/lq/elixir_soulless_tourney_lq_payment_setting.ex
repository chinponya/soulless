...
defmodule Soulless.Tourney.Lq.PaymentSetting do
  @moduledoc false
  defstruct open_payment: 0,
    ...
    [
      defp encode_open_payment(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:open_payment, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_payment_info_show_type(acc, msg) do
        try do
          if msg.payment_info_show_type == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.payment_info_show_type)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:payment_info_show_type, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_payment_info(acc, msg) do
        try do
          if msg.payment_info == "" do
            ...
            [acc, "\x1A", Protox.Encode.encode_string(msg.payment_info)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:payment_info, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.PaymentSetting))
        end
      )
    )
              ...
              {[
                 wechat:
                   Protox.MergeMessage.merge(
                     msg.wechat,
                     Soulless.Tourney.Lq.PaymentSetting.WechatData.decode!(delimited)
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 alipay:
                   Protox.MergeMessage.merge(
                     msg.alipay,
                     Soulless.Tourney.Lq.PaymentSetting.AlipayData.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.PaymentSetting,
  ...
  (
    ...
    def defs() do
      %{
        ...
        4 => {:wechat, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting.WechatData}},
        5 => {:alipay, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting.AlipayData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        alipay: {5, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting.AlipayData}},
        open_payment: {1, {:scalar, 0}, :uint32},
        payment_info: {3, {:scalar, ""}, :string},
        payment_info_show_type: {2, {:scalar, 0}, :uint32},
        wechat: {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting.WechatData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :wechat,
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.PaymentSetting.WechatData}
        },
        %{
          __struct__: Protox.Field,
          json_name: "alipay",
          ...
          name: :alipay,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.PaymentSetting.AlipayData}
        }
      ]
    end
