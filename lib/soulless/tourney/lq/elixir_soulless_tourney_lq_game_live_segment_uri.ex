...
defmodule(Soulless.Tourney.Lq.GameLiveSegmentUri) do
  @moduledoc false
  (
      ...
      [
        defp(encode_segment_id(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:segment_id, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_segment_uri(acc, msg)) do
          try do
            if(msg.segment_uri == "") do
              ...
              [acc, <<18>>, Protox.Encode.encode_string(msg.segment_uri)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:segment_uri, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameLiveSegmentUri))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.GameLiveSegmentUri,
