          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 numerical:
                   msg.numerical ++
                     [Soulless.Tourney.Lq.AccountUpdate.NumericalUpdate.decode!(delimited)]
               ], rest}
            ...
            {15, _, bytes} ->
              ...
              {[
                 activity:
                   Protox.MergeMessage.merge(
                     msg.activity,
                     Soulless.Tourney.Lq.AccountActivityUpdate.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 activity_segment_task:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountUpdate.SegmentTaskUpdate.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountUpdate,
  ...
  (
      ...
      %{
        ...
        2 =>
          {:character, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.CharacterUpdate}},
        3 => {:bag, {:scalar, nil}, {:message, Soulless.Tourney.Lq.BagUpdate}},
        4 =>
          {:achievement, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.AchievementUpdate}},
        5 => {:shilian, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountShiLian}},
        6 =>
          {:daily_task, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.DailyTaskUpdate}},
        7 => {:title, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TitleUpdate}},
        8 => {:new_recharged_list, :packed, :uint32},
        9 =>
          {:activity_task, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}},
        10 =>
        ...
        13 =>
          {:challenge, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.AccountChallengeUpdate}},
        14 =>
          {:ab_match, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate}},
        15 => {:activity, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountActivityUpdate}},
        16 =>
          {:activity_segment_task, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.SegmentTaskUpdate}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        achievement:
          {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.AchievementUpdate}},
        activity: {15, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountActivityUpdate}},
        activity_flip_task:
          {10, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}},
        activity_period_task:
          {11, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}},
        activity_random_task:
          {12, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}},
        activity_segment_task:
          {16, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.SegmentTaskUpdate}},
        activity_task:
          {9, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}},
        bag: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.BagUpdate}},
        challenge:
          {13, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountUpdate.AccountChallengeUpdate}},
        character:
          {2, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.CharacterUpdate}},
        daily_task:
          {6, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.DailyTaskUpdate}},
        new_recharged_list: {8, :packed, :uint32},
        numerical: {1, :unpacked, {:message, Soulless.Tourney.Lq.AccountUpdate.NumericalUpdate}},
        shilian: {5, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountShiLian}},
        title: {7, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountUpdate.TitleUpdate}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :numerical,
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.NumericalUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "character",
          ...
          name: :character,
          tag: 2,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.CharacterUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "bag",
          ...
          name: :bag,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.BagUpdate}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :achievement,
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.AchievementUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "shilian",
          ...
          name: :shilian,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.AccountShiLian}
        },
        %{
          __struct__: Protox.Field,
          json_name: "dailyTask",
          ...
          name: :daily_task,
          tag: 6,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.DailyTaskUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "title",
          ...
          name: :title,
          tag: 7,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.TitleUpdate}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :activity_task,
          tag: 9,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.TaskUpdate}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :challenge,
          tag: 13,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.AccountChallengeUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "abMatch",
          ...
          name: :ab_match,
          tag: 14,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate}
        },
        %{
          __struct__: Protox.Field,
          json_name: "activity",
          ...
          name: :activity,
          tag: 15,
          type: {:message, Soulless.Tourney.Lq.AccountActivityUpdate}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 16,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.SegmentTaskUpdate}
        }
      ]
    end
