...
defmodule Soulless.Tourney.Lq.NotifyCaptcha do
  @moduledoc false
  defstruct check_id: 0, start_time: 0, random_str: "", type: 0, __uf__: []
  ...
  (
    ...
    [
      ...
      defp encode_random_str(acc, msg) do
        try do
          if msg.random_str == "" do
            acc
          else
            [acc, "\x1A", Protox.Encode.encode_string(msg.random_str)]
          end
        rescue
          ArgumentError ->
            reraise Protox.EncodingError.new(:random_str, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyCaptcha))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyCaptcha,
