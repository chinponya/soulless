...
defmodule Soulless.Tourney.Lq.NotifyGameFinishRewardV2 do
  @moduledoc false
  defstruct mode_id: 0,
            level_change: nil,
            match_chest: nil,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyGameFinishRewardV2))
        end
      )
    )
              ...
              {[
                 level_change:
                   Protox.MergeMessage.merge(
                     msg.level_change,
                     Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange.decode!(delimited)
                   )
               ], rest}
            ...
            {3, _, bytes} ->
              ...
              {[
                 match_chest:
                   Protox.MergeMessage.merge(
                     msg.match_chest,
                     Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest.decode!(delimited)
                   )
               ], rest}
            ...
            {4, _, bytes} ->
              ...
              {[
                 main_character:
                   Protox.MergeMessage.merge(
                     msg.main_character,
                     Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MainCharacter.decode!(delimited)
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 character_gift:
                   Protox.MergeMessage.merge(
                     msg.character_gift,
                     Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyGameFinishRewardV2,
      ...
      %{
        ...
        2 =>
          {:level_change, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange}},
        3 =>
          {:match_chest, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest}},
        4 =>
          {:main_character, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MainCharacter}},
        5 =>
          {:character_gift, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift}}
      }
    end
      ...
      %{
        ...
        main_character:
          {4, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MainCharacter}},
        match_chest:
          {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :level_change,
          tag: 2,
          type: {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :match_chest,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :main_character,
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MainCharacter}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :character_gift,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift}
        }
      ]
    end
