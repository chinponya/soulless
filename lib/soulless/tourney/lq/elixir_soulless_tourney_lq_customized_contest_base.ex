...
defmodule(Soulless.Tourney.Lq.CustomizedContestBase) do
  @moduledoc false
  (
    defstruct(
      unique_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.CustomizedContestBase))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.CustomizedContestBase,
