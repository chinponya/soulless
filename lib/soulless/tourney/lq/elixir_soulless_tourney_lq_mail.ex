        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {10, _, bytes} ->
              ...
              {[
                 title_i18n:
                   msg.title_i18n ++ [Soulless.Tourney.Lq.I18nContext.decode!(delimited)]
               ], rest}
            ...
            {11, _, bytes} ->
              ...
              {[
                 content_i18n:
                   msg.content_i18n ++ [Soulless.Tourney.Lq.I18nContext.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def defs() do
      %{
        ...
        10 => {:title_i18n, :unpacked, {:message, Soulless.Tourney.Lq.I18nContext}},
        11 => {:content_i18n, :unpacked, {:message, Soulless.Tourney.Lq.I18nContext}},
    ...
    def defs_by_name() do
      %{
        ...
        content_i18n: {11, :unpacked, {:message, Soulless.Tourney.Lq.I18nContext}},
        ...
        title_i18n: {10, :unpacked, {:message, Soulless.Tourney.Lq.I18nContext}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :title_i18n,
          tag: 10,
          type: {:message, Soulless.Tourney.Lq.I18nContext}
        },
        %{
          __struct__: Protox.Field,
