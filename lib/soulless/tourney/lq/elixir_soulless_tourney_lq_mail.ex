...
defmodule Soulless.Tourney.Lq.Mail do
  @moduledoc false
  (
    defstruct mail_id: 0,
              state: 0,
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.Mail))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {10, _, bytes} ->
                ...
                {[
                   title_i18n:
                     msg.title_i18n ++ [Soulless.Tourney.Lq.Mail.I18nContext.decode!(delimited)]
                 ], rest}
              ...
              {11, _, bytes} ->
                ...
                {[
                   content_i18n:
                     msg.content_i18n ++ [Soulless.Tourney.Lq.Mail.I18nContext.decode!(delimited)]
                 ], rest}
    ...
    def defs() do
      %{
        ...
        10 => {:title_i18n, :unpacked, {:message, Soulless.Tourney.Lq.Mail.I18nContext}},
        11 => {:content_i18n, :unpacked, {:message, Soulless.Tourney.Lq.Mail.I18nContext}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        content_i18n: {11, :unpacked, {:message, Soulless.Tourney.Lq.Mail.I18nContext}},
        ...
        title_i18n: {10, :unpacked, {:message, Soulless.Tourney.Lq.Mail.I18nContext}}
      }
    end
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :title_i18n,
          tag: 10,
          type: {:message, Soulless.Tourney.Lq.Mail.I18nContext}
        },
        %{
          __struct__: Protox.Field,
