...
defmodule Soulless.Tourney.Lq.ResFetchContestChatHistory do
  @moduledoc false
  (
      ...
      [
        ...
        defp encode_chat_history(acc, msg) do
          try do
            ...
            ArgumentError ->
              reraise Protox.EncodingError.new(:chat_history, "invalid field value"),
                      __STACKTRACE__
          end
        end
      ]
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResFetchContestChatHistory))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {2, _, bytes} ->
                ...
                {[
                   chat_history:
                     msg.chat_history ++ [Soulless.Tourney.Lq.Wrapper.decode!(delimited)]
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ResFetchContestChatHistory,
    ...
    def defs() do
      %{
        ...
        2 => {:chat_history, :unpacked, {:message, Soulless.Tourney.Lq.Wrapper}}
      }
    end
    ...
    def defs_by_name() do
      %{
        chat_history: {2, :unpacked, {:message, Soulless.Tourney.Lq.Wrapper}},
