...
defmodule Soulless.Tourney.Lq.FeedActivityData do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.FeedActivityData))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
              ...
              {[
                 friend_receive_data:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData.decode!(delimited)
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 gift_inbox:
                   msg.gift_inbox ++
                     [Soulless.Tourney.Lq.FeedActivityData.GiftBoxData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.FeedActivityData,
  ...
  (
      ...
      %{
        ...
        3 =>
          {:friend_receive_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData}},
        4 =>
          {:friend_send_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData}},
        5 =>
          {:gift_inbox, :unpacked, {:message, Soulless.Tourney.Lq.FeedActivityData.GiftBoxData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        friend_receive_data:
          {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData}},
        friend_send_data:
          {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData}},
        gift_inbox: {5, :unpacked, {:message, Soulless.Tourney.Lq.FeedActivityData.GiftBoxData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.FeedActivityData.CountWithTimeData}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :gift_inbox,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.FeedActivityData.GiftBoxData}
        }
      ]
    end
