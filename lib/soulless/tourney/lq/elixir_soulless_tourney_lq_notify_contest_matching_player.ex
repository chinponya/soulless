...
defmodule Soulless.Tourney.Lq.NotifyContestMatchingPlayer do
  @moduledoc false
  defstruct unique_id: 0, type: 0, account_id: 0, nickname: "", __uf__: []
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyContestMatchingPlayer))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyContestMatchingPlayer,
