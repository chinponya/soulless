...
defmodule(Soulless.Tourney.Lq.MonthTicketInfo) do
  @moduledoc false
  (
        ...
        defp(encode_last_pay_time(acc, msg)) do
          try do
            if(msg.last_pay_time == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.last_pay_time)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:last_pay_time, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.MonthTicketInfo))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.MonthTicketInfo,
