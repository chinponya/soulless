...
defmodule Soulless.Tourney.Lq.AccountResourceSnapshot.BagItemSnapshot do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Tourney.Lq.AccountResourceSnapshot.BagItemSnapshot)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountResourceSnapshot.BagItemSnapshot,
