...
defmodule Soulless.Tourney.Lq.AccountDetailStatisticV2.CustomizedContestStatistic do
  @moduledoc false
  (
      ...
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(
              bytes,
              struct(Soulless.Tourney.Lq.AccountDetailStatisticV2.CustomizedContestStatistic)
            )
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.AccountDetailStatisticV2.CustomizedContestStatistic,
