...
defmodule(Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate) do
  @moduledoc false
  (
    defstruct(
      match_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate))
          end
        )
      )
              ...
              {6, _, bytes} ->
                ...
                {[
                   match_max_point:
                     msg.match_max_point ++
                       [
                         Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint.decode!(
                           delimited
                         )
                       ]
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate,
      ...
      %{
        ...
        6 =>
          {:match_max_point, :unpacked,
           {:message, Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          tag: 6,
          type: {:message, Soulless.Tourney.Lq.AccountUpdate.AccountABMatchUpdate.MatchPoint}
        },
        %{
          __struct__: Protox.Field,
          json_name: "quit",
