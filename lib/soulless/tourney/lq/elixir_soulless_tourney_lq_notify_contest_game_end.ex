...
defmodule Soulless.Tourney.Lq.NotifyContestGameEnd do
  @moduledoc false
  (
    defstruct unique_id: 0, game_uuid: "", __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_unique_id(msg) |> encode_game_uuid(msg) |> encode_unknown_fields(msg)
        end
      )
        ...
        defp encode_game_uuid(acc, msg) do
          try do
            if msg.game_uuid == "" do
              ...
              [acc, "\x12", Protox.Encode.encode_string(msg.game_uuid)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyContestGameEnd))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyContestGameEnd,
    ...
    def defs() do
      %{1 => {:unique_id, {:scalar, 0}, :uint32}, 2 => {:game_uuid, {:scalar, ""}, :string}}
    end
    ...
    def defs_by_name() do
      %{game_uuid: {2, {:scalar, ""}, :string}, unique_id: {1, {:scalar, 0}, :uint32}}
    end
