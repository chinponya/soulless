...
defmodule Soulless.Tourney.Lq.ResFetchCurrentRankList.AccountRankData do
  @moduledoc false
  defstruct account_id: 0, nickname: "", total_point: 0, total_count: 0, __uf__: []
      ...
      defp encode_total_point(acc, msg) do
        try do
          if msg.total_point == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_int32(msg.total_point)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_total_count(acc, msg) do
        try do
          if msg.total_count == 0 do
            ...
            [acc, " ", Protox.Encode.encode_uint32(msg.total_count)]
          end
        rescue
          ArgumentError ->
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Tourney.Lq.ResFetchCurrentRankList.AccountRankData)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ResFetchCurrentRankList.AccountRankData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:total_point, {:scalar, 0}, :int32},
        4 => {:total_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        total_count: {4, {:scalar, 0}, :uint32},
        total_point: {3, {:scalar, 0}, :int32}
      }
    end
  )
