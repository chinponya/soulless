...
defmodule Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift)
          )
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyGameFinishRewardV2.CharacterGift,
