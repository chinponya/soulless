...
defmodule Soulless.Tourney.Lq.NotifyAccountChallengeTaskUpdate do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyAccountChallengeTaskUpdate))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyAccountChallengeTaskUpdate,
    ...
    def defs() do
      %{
        ...
        6 => {:rewarded_season, :packed, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        rewarded_season: {6, :packed, :uint32},
