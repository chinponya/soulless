...
defmodule(Soulless.Tourney.Lq.ShopInfo) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ShopInfo))
          end
        )
      )
          ...
          {field, rest} =
            case(Protox.Decode.parse_key(bytes)) do
              ...
              {1, _, bytes} ->
                ...
                {[
                   zhp:
                     Protox.Message.merge(msg.zhp, Soulless.Tourney.Lq.ZHPShop.decode!(delimited))
                 ], rest}
    ...
    def(defs()) do
      %{
        1 => {:zhp, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ZHPShop}},
    ...
    def(defs_by_name()) do
      %{
        ...
        zhp: {1, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ZHPShop}}
      }
    end
    ...
    def(fields_defs()) do
      [
        %{
          ...
          name: :zhp,
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.ZHPShop}
        },
        %{
          __struct__: Protox.Field,
