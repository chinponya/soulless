...
defmodule Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary do
  @moduledoc false
  ...
  (
    (
      ...
      def encode!(msg) do
        ...
        |> encode_zimo_count(msg)
        |> encode_fangchong_count(msg)
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary))
        end
      )
    )
      ...
      defp parse_key_value(bytes, msg) do
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {2, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[rong_count: value], rest}

            {3, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[zimo_count: value], rest}

            {4, _, bytes} ->
              {value, rest} = Protox.Decode.parse_uint32(bytes)
              {[fangchong_count: value], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountMahjongStatistic.RoundSummary,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:zimo_count, {:scalar, 0}, :uint32},
        4 => {:fangchong_count, {:scalar, 0}, :uint32}
      }
    end
  ...
  (
    ...
    def fields_defs() do
      [
        ...
        %{
          __struct__: Protox.Field,
          json_name: "fangchongCount",
          kind: {:scalar, 0},
          label: :optional,
          name: :fangchong_count,
          tag: 4,
          type: :uint32
        }
      ]
