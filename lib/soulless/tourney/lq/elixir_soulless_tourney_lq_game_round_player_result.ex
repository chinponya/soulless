...
defmodule Soulless.Tourney.Lq.GameRoundPlayerResult do
  @moduledoc false
  defstruct type: 0,
            hands: [],
            ming: [],
    ...
    [
      ...
      defp encode_is_liujumanguan(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:is_liujumanguan, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_lian_zhuang(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:lian_zhuang, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameRoundPlayerResult))
        end
      )
    )
              ...
              {[
                 hu:
                   Protox.MergeMessage.merge(
                     msg.hu,
                     Soulless.Tourney.Lq.GameRoundHuData.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.GameRoundPlayerResult,
  ...
  (
    ...
    def defs() do
      %{
        ...
        8 => {:hu, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRoundHuData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        hu: {8, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRoundHuData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :hu,
          tag: 8,
          type: {:message, Soulless.Tourney.Lq.GameRoundHuData}
        }
      ]
    end
