...
defmodule Soulless.Tourney.Lq.ActivitySpotData do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.ActivitySpotData))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {3, _, bytes} ->
              ...
              {[
                 spots:
                   msg.spots ++ [Soulless.Tourney.Lq.ActivitySpotData.SpotData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ActivitySpotData,
  ...
  (
    ...
    def defs() do
      %{
        ...
        3 => {:spots, :unpacked, {:message, Soulless.Tourney.Lq.ActivitySpotData.SpotData}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        spots: {3, :unpacked, {:message, Soulless.Tourney.Lq.ActivitySpotData.SpotData}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :spots,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.ActivitySpotData.SpotData}
        }
      ]
    end
