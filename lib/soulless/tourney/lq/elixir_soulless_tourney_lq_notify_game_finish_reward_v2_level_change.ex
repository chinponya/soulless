...
defmodule Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyGameFinishRewardV2.LevelChange,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:origin, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        2 => {:final, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
    ...
    def defs_by_name() do
      %{
        final: {2, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        origin: {1, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
