...
defmodule(Soulless.Tourney.Lq.NotifyDailyTaskUpdate) do
  @moduledoc false
  (
        ...
        defp(encode_max_daily_task_count(acc, msg)) do
          try do
            if(msg.max_daily_task_count == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.max_daily_task_count)]
            end
          rescue
            ArgumentError ->
              reraise(
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyDailyTaskUpdate))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyDailyTaskUpdate,
