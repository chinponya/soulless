...
defmodule Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic do
  @moduledoc false
  (
      ...
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(
              bytes,
              struct(Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic)
            )
          end
        )
      )
                ...
                {[
                   total_statistic:
                     Protox.MergeMessage.merge(
                       msg.total_statistic,
                       Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic.RankData.decode!(
                         delimited
                       )
                     )
                 ], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic,
      ...
      %{
        1 =>
          {:total_statistic, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic.RankData}},
        2 =>
    ...
    def fields_defs() do
      [
        %{
          ...
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic.RankData}
        },
        %{
          __struct__: Protox.Field,
