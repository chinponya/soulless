...
defmodule Soulless.Tourney.Lq.AccSnDa do
  @moduledoc false
  defstruct account_id: 0, time: 0, snapshot: nil, __uf__: []
      ...
      defp encode_time(acc, msg) do
        try do
          if msg.time == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.time)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_snapshot(acc, msg) do
        try do
          if msg.snapshot == nil do
            ...
            [acc, "\x1A", Protox.Encode.encode_message(msg.snapshot)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccSnDa))
        end
      )
    )
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:time, {:scalar, 0}, :uint32},
        3 => {:snapshot, {:scalar, nil}, {:message, Soulless.Tourney.Lq.Wrapper}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        snapshot: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.Wrapper}},
        time: {2, {:scalar, 0}, :uint32}
      }
    end
  )
