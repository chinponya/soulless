...
defmodule Soulless.Tourney.Lq.ServerSettings do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.ServerSettings))
        end
      )
    )
              ...
              {[
                 payment_setting:
                   Protox.MergeMessage.merge(
                     msg.payment_setting,
                     Soulless.Tourney.Lq.PaymentSetting.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 payment_setting_v2:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.PaymentSettingV2.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 nickname_setting:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.NicknameSetting.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ServerSettings,
  ...
  (
    ...
    def defs() do
      %{
        3 => {:payment_setting, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting}},
        4 =>
          {:payment_setting_v2, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSettingV2}},
        5 => {:nickname_setting, {:scalar, nil}, {:message, Soulless.Tourney.Lq.NicknameSetting}}
      }
    end
    ...
    def defs_by_name() do
      %{
        nickname_setting: {5, {:scalar, nil}, {:message, Soulless.Tourney.Lq.NicknameSetting}},
        payment_setting: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSetting}},
        payment_setting_v2: {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PaymentSettingV2}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.PaymentSetting}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.PaymentSettingV2}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.NicknameSetting}
        }
      ]
    end
