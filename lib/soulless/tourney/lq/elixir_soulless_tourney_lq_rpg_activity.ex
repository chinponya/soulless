...
defmodule Soulless.Tourney.Lq.RPGActivity do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.RPGActivity))
        end
      )
    )
              ...
              {[
                 current_state:
                   Protox.MergeMessage.merge(
                     msg.current_state,
                     Soulless.Tourney.Lq.RPGState.decode!(delimited)
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.RPGActivity,
  ...
  (
    ...
    def defs() do
      %{
        ...
        7 => {:current_state, {:scalar, nil}, {:message, Soulless.Tourney.Lq.RPGState}},
        8 => {:last_show_state, {:scalar, nil}, {:message, Soulless.Tourney.Lq.RPGState}},
    ...
    def defs_by_name() do
      %{
        ...
        current_state: {7, {:scalar, nil}, {:message, Soulless.Tourney.Lq.RPGState}},
        last_played_uuid: {6, {:scalar, ""}, :string},
        last_show_id: {10, {:scalar, 0}, :uint32},
        last_show_state: {8, {:scalar, nil}, {:message, Soulless.Tourney.Lq.RPGState}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :current_state,
          tag: 7,
          type: {:message, Soulless.Tourney.Lq.RPGState}
        },
        %{
          __struct__: Protox.Field,
