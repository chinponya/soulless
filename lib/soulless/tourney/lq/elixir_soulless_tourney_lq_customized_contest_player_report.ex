...
defmodule Soulless.Tourney.Lq.CustomizedContestPlayerReport do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.CustomizedContestPlayerReport))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {4, 2, bytes} ->
              ...
              {[game_ranks: msg.game_ranks ++ Protox.Decode.parse_repeated_uint32([], delimited)],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.CustomizedContestPlayerReport,
