...
defmodule Soulless.Tourney.Lq.AccountDetailStatisticV2 do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountDetailStatisticV2))
        end
      )
    )
            ...
            {2, _, bytes} ->
              ...
              {[
                 rank_statistic:
                   Protox.MergeMessage.merge(
                     msg.rank_statistic,
                     Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 customized_contest_statistic:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountDetailStatisticV2.CustomizedContestStatistic.decode!(
                       delimited
                     )
                   )
               ], rest}
              ...
              {[
                 challenge_match_statistic:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountDetailStatisticV2.ChallengeStatistic.decode!(
                       delimited
                     )
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountDetailStatisticV2,
  ...
  (
      ...
      %{
        ...
        2 =>
          {:rank_statistic, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic}},
        3 =>
          {:customized_contest_statistic, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.CustomizedContestStatistic}},
        4 =>
          {:leisure_match_statistic, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatistic}},
        5 =>
          {:challenge_match_statistic, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.ChallengeStatistic}},
        6 =>
    ...
    def defs_by_name() do
      %{
        ab_match_statistic:
          {7, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountDetailStatistic}},
        activity_match_statistic:
          {6, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountDetailStatistic}},
        challenge_match_statistic:
          {5, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.ChallengeStatistic}},
        customized_contest_statistic:
        ...
        leisure_match_statistic:
          {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountDetailStatistic}},
        rank_statistic:
          {2, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic}}
      }
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :rank_statistic,
          tag: 2,
          type: {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.RankStatistic}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.AccountDetailStatisticV2.ChallengeStatistic}
        },
        %{
          __struct__: Protox.Field,
