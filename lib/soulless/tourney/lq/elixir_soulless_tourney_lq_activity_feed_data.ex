...
defmodule Soulless.Tourney.Lq.ActivityFeedData do
  @moduledoc false
      ...
      defp encode_max_inbox_id(acc, msg) do
        try do
          if msg.max_inbox_id == 0 do
            ...
            [acc, "0", Protox.Encode.encode_uint32(msg.max_inbox_id)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.ActivityFeedData))
        end
      )
    )
          ...
          case Protox.Decode.parse_key(bytes) do
              ...
              {[
                 friend_receive_data:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData.decode!(delimited)
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 gift_inbox:
                   msg.gift_inbox ++
                     [Soulless.Tourney.Lq.ActivityFeedData.GiftBoxData.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ActivityFeedData,
  ...
  (
      ...
      %{
        ...
        3 =>
          {:friend_receive_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData}},
        4 =>
          {:friend_send_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData}},
        5 =>
          {:gift_inbox, :unpacked, {:message, Soulless.Tourney.Lq.ActivityFeedData.GiftBoxData}},
        6 => {:max_inbox_id, {:scalar, 0}, :uint32}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        friend_receive_data:
          {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData}},
        friend_send_data:
          {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData}},
        gift_inbox: {5, :unpacked, {:message, Soulless.Tourney.Lq.ActivityFeedData.GiftBoxData}},
        max_inbox_id: {6, {:scalar, 0}, :uint32}
      }
    end
  )
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.ActivityFeedData.CountWithTimeData}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :gift_inbox,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.ActivityFeedData.GiftBoxData}
        },
        %{
          __struct__: Protox.Field,
