...
defmodule Soulless.Tourney.Lq.ResCreateContestGame do
  @moduledoc false
  (
    defstruct error: nil, game_uuid: "", __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_error(msg) |> encode_game_uuid(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResCreateContestGame))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ResCreateContestGame,
