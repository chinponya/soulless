...
defmodule Soulless.Tourney.Lq.ResProlongContest do
  @moduledoc false
  defstruct error: nil, deadline: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_error(msg) |> encode_deadline(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_deadline(acc, msg) do
        try do
          if msg.deadline == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.deadline)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResProlongContest))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.ResProlongContest,
