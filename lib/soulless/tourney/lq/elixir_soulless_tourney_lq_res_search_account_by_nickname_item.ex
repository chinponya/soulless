...
defmodule Soulless.Tourney.Lq.ResSearchAccountByNickname.Item do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResSearchAccountByNickname.Item))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ResSearchAccountByNickname.Item,
