...
defmodule Soulless.Tourney.Lq.NotifyContestMatchingPlayerLock do
  @moduledoc false
  (
    defstruct unique_id: 0, type: 0, account_id: 0, manager_id: 0, __uf__: []
    ...
    (
      ...
      [
        ...
        defp encode_manager_id(acc, msg) do
          try do
            if msg.manager_id == 0 do
              acc
            else
              [acc, " ", Protox.Encode.encode_uint32(msg.manager_id)]
            end
          rescue
            ArgumentError ->
              reraise Protox.EncodingError.new(:manager_id, "invalid field value"), __STACKTRACE__
          end
        end
      ]
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyContestMatchingPlayerLock))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyContestMatchingPlayerLock,
