...
defmodule Soulless.Tourney.Lq.AccountMiscSnapshot do
  @moduledoc false
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountMiscSnapshot))
        end
      )
    )
              ...
              {[
                 faith_data:
                   Protox.MergeMessage.merge(
                     msg.faith_data,
                     Soulless.Tourney.Lq.FaithData.decode!(delimited)
                   )
               ], rest}
              ...
              {[
                 vip_reward_gained:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIPRewardSnapshot.decode!(
                       delimited
                     )
                   )
               ], rest}
            ...
            {3, _, bytes} ->
              ...
              {[
                 vip:
                   Protox.MergeMessage.merge(
                     msg.vip,
                     Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIP.decode!(delimited)
                   )
               ], rest}
            ...
            {4, _, bytes} ->
              ...
              {[
                 shop_info:
                   Protox.MergeMessage.merge(
                     msg.shop_info,
                     Soulless.Tourney.Lq.ShopInfo.decode!(delimited)
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 month_ticket:
                   Protox.MergeMessage.merge(
                     msg.month_ticket,
                     Soulless.Tourney.Lq.AccountMiscSnapshot.AccountMonthTicketSnapshot.decode!(
                       delimited
                     )
                   )
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountMiscSnapshot,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:faith_data, {:scalar, nil}, {:message, Soulless.Tourney.Lq.FaithData}},
        2 =>
          {:vip_reward_gained, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIPRewardSnapshot}},
        3 =>
          {:vip, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIP}},
        4 => {:shop_info, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ShopInfo}},
        5 =>
          {:month_ticket, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountMonthTicketSnapshot}}
      }
    end
    ...
    def defs_by_name() do
      %{
        faith_data: {1, {:scalar, nil}, {:message, Soulless.Tourney.Lq.FaithData}},
        month_ticket:
          {5, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountMonthTicketSnapshot}},
        shop_info: {4, {:scalar, nil}, {:message, Soulless.Tourney.Lq.ShopInfo}},
        vip: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIP}},
        vip_reward_gained:
          {2, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIPRewardSnapshot}}
      }
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :faith_data,
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.FaithData}
        },
        %{
          __struct__: Protox.Field,
          ...
          tag: 2,
          type: {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIPRewardSnapshot}
        },
        %{
          __struct__: Protox.Field,
          json_name: "vip",
          ...
          name: :vip,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountVIP}
        },
        %{
          __struct__: Protox.Field,
          json_name: "shopInfo",
          ...
          name: :shop_info,
          tag: 4,
          type: {:message, Soulless.Tourney.Lq.ShopInfo}
        },
        %{
          __struct__: Protox.Field,
          ...
          name: :month_ticket,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.AccountMiscSnapshot.AccountMonthTicketSnapshot}
        }
      ]
    end
