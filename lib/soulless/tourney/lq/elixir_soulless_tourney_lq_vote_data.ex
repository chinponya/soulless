...
defmodule Soulless.Tourney.Lq.VoteData do
  @moduledoc false
  defstruct activity_id: 0, vote: 0, count: 0, __uf__: []
      ...
      defp encode_vote(acc, msg) do
        try do
          if msg.vote == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.vote)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.VoteData))
        end
      )
    )
