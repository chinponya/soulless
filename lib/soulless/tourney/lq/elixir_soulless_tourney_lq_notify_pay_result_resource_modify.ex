...
defmodule Soulless.Tourney.Lq.NotifyPayResult.ResourceModify do
  @moduledoc false
  (
    defstruct id: 0, count: 0, final: 0, __uf__: []
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyPayResult.ResourceModify))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyPayResult.ResourceModify,
