...
defmodule Soulless.Tourney.Lq.GameRoundHuData.Fan do
  @moduledoc false
  defstruct id: 0, count: 0, fan: 0, __uf__: []
  ...
  (
    (
      ...
      def encode!(msg) do
        [] |> encode_id(msg) |> encode_count(msg) |> encode_fan(msg) |> encode_unknown_fields(msg)
      end
    )
      ...
      defp encode_fan(acc, msg) do
        try do
          if msg.fan == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.fan)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameRoundHuData.Fan))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.GameRoundHuData.Fan,
