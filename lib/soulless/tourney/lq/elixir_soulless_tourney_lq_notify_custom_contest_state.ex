...
defmodule Soulless.Tourney.Lq.NotifyCustomContestState do
  @moduledoc false
  (
    defstruct unique_id: 0, state: 0, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_unique_id(msg) |> encode_state(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyCustomContestState))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyCustomContestState,
    ...
    def defs() do
      %{1 => {:unique_id, {:scalar, 0}, :uint32}, 2 => {:state, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{state: {2, {:scalar, 0}, :uint32}, unique_id: {1, {:scalar, 0}, :uint32}}
    end
