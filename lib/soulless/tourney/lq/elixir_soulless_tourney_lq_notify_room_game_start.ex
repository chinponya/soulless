...
defmodule Soulless.Tourney.Lq.NotifyRoomGameStart do
  @moduledoc false
  (
    defstruct game_url: "", connect_token: "", game_uuid: "", location: "", __uf__: []
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyRoomGameStart))
          end
        )
      )
          ...
          {field, rest} =
            case Protox.Decode.parse_key(bytes) do
              ...
              {1, _, bytes} ->
                ...
                {[game_url: delimited], rest}

              {2, _, bytes} ->
                {len, bytes} = Protox.Varint.decode(bytes)
                {delimited, rest} = Protox.Decode.parse_delimited(bytes, len)
                {[connect_token: delimited], rest}
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyRoomGameStart,
