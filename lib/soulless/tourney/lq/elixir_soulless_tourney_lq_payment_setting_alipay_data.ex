...
defmodule(Soulless.Tourney.Lq.PaymentSetting.AlipayData) do
  @moduledoc false
  (
    defstruct(disable_create: false, payment_source_platform: 0, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.PaymentSetting.AlipayData))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.PaymentSetting.AlipayData,
