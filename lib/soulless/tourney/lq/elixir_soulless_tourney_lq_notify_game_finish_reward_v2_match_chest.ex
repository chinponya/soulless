...
defmodule Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest do
  @moduledoc false
  defstruct chest_id: 0, origin: 0, final: 0, is_graded: false, rewards: [], __uf__: []
      ...
      defp encode_origin(acc, msg) do
        try do
          if msg.origin == 0 do
            ...
            [acc, "\x10", Protox.Encode.encode_uint32(msg.origin)]
          end
        rescue
          ArgumentError ->
      ...
      defp encode_final(acc, msg) do
        try do
          if msg.final == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.final)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {5, _, bytes} ->
              ...
              {[rewards: msg.rewards ++ [Soulless.Tourney.Lq.RewardSlot.decode!(delimited)]],
               rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyGameFinishRewardV2.MatchChest,
  ...
  (
    ...
    def defs() do
      %{
        ...
        2 => {:origin, {:scalar, 0}, :uint32},
        3 => {:final, {:scalar, 0}, :uint32},
        4 => {:is_graded, {:scalar, false}, :bool},
        5 => {:rewards, :unpacked, {:message, Soulless.Tourney.Lq.RewardSlot}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        final: {3, {:scalar, 0}, :uint32},
        is_graded: {4, {:scalar, false}, :bool},
        origin: {2, {:scalar, 0}, :uint32},
        rewards: {5, :unpacked, {:message, Soulless.Tourney.Lq.RewardSlot}}
      }
    end
  )
