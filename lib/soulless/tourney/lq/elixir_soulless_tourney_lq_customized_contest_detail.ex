  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.CustomizedContestDetail,
  ...
  (
    ...
    def defs() do
      %{
        ...
        11 => {:game_mode, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMode}},
    ...
    def defs_by_name() do
      %{
        ...
        game_mode: {11, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMode}},
