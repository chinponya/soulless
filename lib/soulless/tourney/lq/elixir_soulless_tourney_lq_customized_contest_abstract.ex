...
defmodule Soulless.Tourney.Lq.CustomizedContestAbstract do
  @moduledoc false
      ...
      defp encode_public_notice(acc, msg) do
        try do
          if msg.public_notice == "" do
            ...
            [acc, "R", Protox.Encode.encode_string(msg.public_notice)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.CustomizedContestAbstract))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.CustomizedContestAbstract,
  ...
  (
    ...
    def defs() do
      %{
        ...
        10 => {:public_notice, {:scalar, ""}, :string},
        11 => {:contest_type, {:scalar, 0}, :uint32}
      }
    end
