...
defmodule Soulless.Tourney.Lq.NotifyActivityChange do
  @moduledoc false
    ...
    [
      defp encode_new_activities(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:new_activities, "invalid field value"),
                    __STACKTRACE__
        end
      end,
      defp encode_end_activities(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:end_activities, "invalid field value"),
                    __STACKTRACE__
        end
      end
    ]
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyActivityChange))
        end
      )
    )
        ...
        {field, rest} =
          case Protox.Decode.parse_key(bytes) do
            ...
            {1, _, bytes} ->
              ...
              {[
                 new_activities:
                   msg.new_activities ++ [Soulless.Tourney.Lq.Activity.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyActivityChange,
  ...
  (
    ...
    def defs() do
      %{
        1 => {:new_activities, :unpacked, {:message, Soulless.Tourney.Lq.Activity}},
    ...
    def defs_by_name() do
      %{
        ...
        new_activities: {1, :unpacked, {:message, Soulless.Tourney.Lq.Activity}}
      }
    end
  )
    ...
    def fields_defs() do
      [
        %{
          ...
          name: :new_activities,
          tag: 1,
          type: {:message, Soulless.Tourney.Lq.Activity}
        },
        %{
          __struct__: Protox.Field,
