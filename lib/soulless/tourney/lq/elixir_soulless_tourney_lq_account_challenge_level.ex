...
defmodule(Soulless.Tourney.Lq.Account.ChallengeLevel) do
  @moduledoc false
  (
        ...
        defp(encode_rank(acc, msg)) do
          try do
            if(msg.rank == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.rank)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.Account.ChallengeLevel))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.Account.ChallengeLevel,
