...
defmodule(Soulless.Tourney.Lq.ContestDetailRuleV2.ExtraRule) do
  @moduledoc false
  (
      ...
      [
        defp(encode_required_level(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:required_level, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_max_game_count(acc, msg)) do
          try do
            if(msg.max_game_count == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.max_game_count)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:max_game_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ContestDetailRuleV2.ExtraRule))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ContestDetailRuleV2.ExtraRule,
