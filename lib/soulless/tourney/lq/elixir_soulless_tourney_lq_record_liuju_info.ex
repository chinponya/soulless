...
defmodule Soulless.Tourney.Lq.RecordLiujuInfo do
  @moduledoc false
  (
    defstruct seat: 0, type: 0, __uf__: []
    ...
    (
      (
        ...
        def encode!(msg) do
          [] |> encode_seat(msg) |> encode_type(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def decode!(bytes) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.RecordLiujuInfo))
          end
        )
      )
    ...
    (
      ...
      def json_decode!(input, opts \\ []) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.RecordLiujuInfo,
    ...
    def defs() do
      %{1 => {:seat, {:scalar, 0}, :uint32}, 2 => {:type, {:scalar, 0}, :uint32}}
    end
    ...
    def defs_by_name() do
      %{seat: {1, {:scalar, 0}, :uint32}, type: {2, {:scalar, 0}, :uint32}}
    end
