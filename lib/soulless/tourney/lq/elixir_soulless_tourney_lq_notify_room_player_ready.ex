...
defmodule(Soulless.Tourney.Lq.NotifyRoomPlayerReady) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.NotifyRoomPlayerReady))
          end
        )
      )
                ...
                {[
                   account_list:
                     Protox.Message.merge(
                       msg.account_list,
                       Soulless.Tourney.Lq.NotifyRoomPlayerReady.AccountReadyState.decode!(
                         delimited
                       )
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.NotifyRoomPlayerReady,
      ...
      %{
        ...
        3 =>
          {:account_list, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyRoomPlayerReady.AccountReadyState}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :account_list,
          tag: 3,
          type: {:message, Soulless.Tourney.Lq.NotifyRoomPlayerReady.AccountReadyState}
        },
        %{
          __struct__: Protox.Field,
          json_name: "seq",
