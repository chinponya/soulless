...
defmodule Soulless.Tourney.Lq.AccountCacheView do
  @moduledoc false
    ...
    [
      ...
      defp encode_playing_game(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:playing_game, "invalid field value"), __STACKTRACE__
        end
      end,
      ...
      defp encode_ban_deadline(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:ban_deadline, "invalid field value"), __STACKTRACE__
        end
      end,
      defp encode_comment_ban(acc, msg) do
        try do
          ...
          ArgumentError ->
            reraise Protox.EncodingError.new(:comment_ban, "invalid field value"), __STACKTRACE__
        end
      end,
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountCacheView))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountCacheView,
  ...
  (
    ...
    def defs() do
      %{
        ...
        11 => {:level, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        12 => {:playing_game, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountPlayingGame}},
        13 => {:level3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
    ...
    def defs_by_name() do
      %{
        ...
        level: {11, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        level3: {13, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        login_time: {4, {:scalar, 0}, :uint32},
        logout_time: {5, {:scalar, 0}, :uint32},
        nickname: {3, {:scalar, ""}, :string},
        playing_game: {12, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountPlayingGame}},
