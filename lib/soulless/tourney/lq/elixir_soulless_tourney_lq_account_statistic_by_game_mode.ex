          ...
          case Protox.Decode.parse_key(bytes) do
            ...
            {8, _, bytes} ->
              ...
              {[
                 round_end:
                   msg.round_end ++
                     [
                       Soulless.Tourney.Lq.AccountStatisticByGameMode.RoundEndData.decode!(
                         delimited
                       )
                     ]
               ], rest}
            ...
            {14, _, bytes} ->
              ...
              {[
                 rank_score:
                   msg.rank_score ++
                     [Soulless.Tourney.Lq.AccountStatisticByGameMode.RankScore.decode!(delimited)]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.AccountStatisticByGameMode,
  ...
  (
    ...
    def defs() do
      %{
        ...
        8 =>
          {:round_end, :unpacked,
           {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RoundEndData}},
        ...
        14 =>
          {:rank_score, :unpacked,
           {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RankScore}}
      }
    end
    ...
    def defs_by_name() do
      %{
        ...
        rank_score:
          {14, :unpacked, {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RankScore}},
        round_count_sum: {6, {:scalar, 0}, :uint32},
        round_end:
          {8, :unpacked, {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RoundEndData}},
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          name: :round_end,
          tag: 8,
          type: {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RoundEndData}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :rank_score,
          tag: 14,
          type: {:message, Soulless.Tourney.Lq.AccountStatisticByGameMode.RankScore}
        }
      ]
    end
