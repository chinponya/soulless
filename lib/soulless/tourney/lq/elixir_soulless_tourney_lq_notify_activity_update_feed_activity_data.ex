...
defmodule Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData do
  @moduledoc false
    ...
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(
            bytes,
            struct(Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData)
          )
        end
      )
    )
              ...
              {[
                 friend_receive_data:
                   Protox.MergeMessage.merge(
                     ...
                     Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData.decode!(
                       delimited
                     )
                   )
               ], rest}
            ...
            {5, _, bytes} ->
              ...
              {[
                 gift_inbox:
                   msg.gift_inbox ++
                     [
                       Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.GiftBoxData.decode!(
                         delimited
                       )
                     ]
               ], rest}
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData,
      ...
      %{
        ...
        3 =>
          {:friend_receive_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData}},
        4 =>
          {:friend_send_data, {:scalar, nil},
           {:message, Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData}},
        5 =>
          {:gift_inbox, :unpacked,
           {:message, Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.GiftBoxData}}
      }
    end
    ...
    def fields_defs() do
      [
        ...
        %{
          ...
          type:
            {:message,
             Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.CountWithTimeData}
        },
        %{
          __struct__: Protox.Field,
        ...
        %{
          ...
          name: :gift_inbox,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.NotifyActivityUpdate.FeedActivityData.GiftBoxData}
        }
      ]
    end
