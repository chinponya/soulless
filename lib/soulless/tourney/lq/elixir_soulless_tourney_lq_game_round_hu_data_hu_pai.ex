...
defmodule Soulless.Tourney.Lq.GameRoundHuData.HuPai do
  @moduledoc false
  defstruct tile: "", seat: 0, liqi: 0, __uf__: []
      ...
      defp encode_liqi(acc, msg) do
        try do
          if msg.liqi == 0 do
            ...
            [acc, "\x18", Protox.Encode.encode_uint32(msg.liqi)]
          end
        rescue
          ArgumentError ->
  ...
  (
    (
      ...
      (
        ...
        def decode!(bytes) do
          parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameRoundHuData.HuPai))
        end
      )
    )
  ...
  (
    ...
    def json_decode!(input, opts \\ []) do
      ...
      Protox.JsonDecode.decode!(
        input,
        Soulless.Tourney.Lq.GameRoundHuData.HuPai,
