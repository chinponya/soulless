...
defmodule(Soulless.Tourney.Lq.ReqContestManageOauth2Login) do
  @moduledoc false
  (
    defstruct(type: 0, access_token: "", reconnect: false, __uf__: [])
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ReqContestManageOauth2Login))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ReqContestManageOauth2Login,
