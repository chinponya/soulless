...
defmodule(Soulless.Tourney.Lq.ResCustomizedContestChatInfo.Item) do
  @moduledoc false
  (
    defstruct(account_id: 0, nickname: "", __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_account_id(msg) |> encode_nickname(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResCustomizedContestChatInfo.Item))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ResCustomizedContestChatInfo.Item,
    ...
    def(defs()) do
      %{1 => {:account_id, {:scalar, 0}, :uint32}, 2 => {:nickname, {:scalar, ""}, :string}}
    end
    ...
    def(defs_by_name()) do
      %{account_id: {1, {:scalar, 0}, :uint32}, nickname: {2, {:scalar, ""}, :string}}
    end
