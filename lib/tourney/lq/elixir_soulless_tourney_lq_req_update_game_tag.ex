...
defmodule(Soulless.Tourney.Lq.ReqUpdateGameTag) do
  @moduledoc false
  (
    defstruct(uuid: "", tag: "", __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_uuid(msg) |> encode_tag(msg) |> encode_unknown_fields(msg)
        end
      )
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ReqUpdateGameTag))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ReqUpdateGameTag,
    ...
    def(defs()) do
      %{1 => {:uuid, {:scalar, ""}, :string}, 2 => {:tag, {:scalar, ""}, :string}}
    end
    ...
    def(defs_by_name()) do
      %{tag: {2, {:scalar, ""}, :string}, uuid: {1, {:scalar, ""}, :string}}
    end
