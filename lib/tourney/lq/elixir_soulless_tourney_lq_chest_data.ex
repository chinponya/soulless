...
defmodule(Soulless.Tourney.Lq.ChestData) do
  @moduledoc false
  (
    defstruct(chest_id: 0, total_open_count: 0, consume_count: 0, face_black_count: 0, __uf__: [])
        ...
        defp(encode_total_open_count(acc, msg)) do
          try do
            if(msg.total_open_count == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.total_open_count)]
            end
          rescue
            ArgumentError ->
              reraise(
        ...
        defp(encode_consume_count(acc, msg)) do
          try do
            if(msg.consume_count == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.consume_count)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:consume_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_face_black_count(acc, msg)) do
          try do
            if(msg.face_black_count == 0) do
              ...
              [acc, " ", Protox.Encode.encode_uint32(msg.face_black_count)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:face_black_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ChestData))
          end
        )
      )
    ...
    def(defs()) do
      %{
        ...
        4 => {:face_black_count, {:scalar, 0}, :uint32}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        face_black_count: {4, {:scalar, 0}, :uint32},
