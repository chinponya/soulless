...
defmodule(Soulless.Tourney.Lq.RecordGame) do
  @moduledoc false
  (
    defstruct(
      uuid: "",
        ...
        defp(encode_end_time(acc, msg)) do
          try do
            if(msg.end_time == 0) do
              ...
              [acc, <<24>>, Protox.Encode.encode_uint32(msg.end_time)]
            end
          rescue
            ArgumentError ->
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.RecordGame))
          end
        )
      )
            ...
            case(Protox.Decode.parse_key(bytes)) do
                ...
                {[
                   config:
                     Protox.Message.merge(
                       msg.config,
                       Soulless.Tourney.Lq.GameConfig.decode!(delimited)
                     )
                 ], rest}
              ...
              {11, _, bytes} ->
                ...
                {[
                   accounts:
                     msg.accounts ++
                       [Soulless.Tourney.Lq.RecordGame.AccountInfo.decode!(delimited)]
                 ], rest}
              ...
              {12, _, bytes} ->
                ...
                {[
                   result:
                     Protox.Message.merge(
                       msg.result,
                       Soulless.Tourney.Lq.GameEndResult.decode!(delimited)
                     )
                 ], rest}
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.RecordGame,
    ...
    def(defs()) do
      %{
        ...
        5 => {:config, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameConfig}},
        11 => {:accounts, :unpacked, {:message, Soulless.Tourney.Lq.RecordGame.AccountInfo}},
        12 => {:result, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameEndResult}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        accounts: {11, :unpacked, {:message, Soulless.Tourney.Lq.RecordGame.AccountInfo}},
        config: {5, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameConfig}},
        end_time: {3, {:scalar, 0}, :uint32},
        result: {12, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameEndResult}},
    ...
    def(fields_defs()) do
      [
        ...
        %{
          ...
          name: :config,
          tag: 5,
          type: {:message, Soulless.Tourney.Lq.GameConfig}
        },
        %{
          __struct__: Protox.Field,
          json_name: "accounts",
          ...
          name: :accounts,
          tag: 11,
          type: {:message, Soulless.Tourney.Lq.RecordGame.AccountInfo}
        },
        %{
          __struct__: Protox.Field,
          json_name: "result",
          ...
          name: :result,
          tag: 12,
          type: {:message, Soulless.Tourney.Lq.GameEndResult}
        }
      ]
    end
