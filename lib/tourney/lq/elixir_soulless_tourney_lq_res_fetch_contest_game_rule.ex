...
defmodule(Soulless.Tourney.Lq.ResFetchContestGameRule) do
  @moduledoc false
  (
    defstruct(error: nil, game_rule_setting: nil, __uf__: [])
    ...
    (
      (
        ...
        def(encode!(msg)) do
          [] |> encode_error(msg) |> encode_game_rule_setting(msg) |> encode_unknown_fields(msg)
        end
      )
        ...
        defp(encode_game_rule_setting(acc, msg)) do
          try do
            if(msg.game_rule_setting == nil) do
              ...
              [acc, <<18>>, Protox.Encode.encode_message(msg.game_rule_setting)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:game_rule_setting, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.ResFetchContestGameRule))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.ResFetchContestGameRule,
    ...
    def(defs()) do
      %{
        ...
        2 => {:game_rule_setting, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRuleSetting}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        game_rule_setting: {2, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameRuleSetting}}
      }
    end
