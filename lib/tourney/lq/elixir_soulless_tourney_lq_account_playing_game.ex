...
defmodule(Soulless.Tourney.Lq.AccountPlayingGame) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.AccountPlayingGame))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.AccountPlayingGame,
    ...
    def(defs()) do
      %{
        ...
        3 => {:meta, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMetaData}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        meta: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMetaData}}
      }
    end
