...
defmodule(Soulless.Tourney.Lq.CommentItem) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.CommentItem))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.CommentItem,
    ...
    def(defs()) do
      %{
        ...
        3 => {:commenter, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PlayerBaseView}},
    ...
    def(defs_by_name()) do
      %{
        ...
        commenter: {3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.PlayerBaseView}},
