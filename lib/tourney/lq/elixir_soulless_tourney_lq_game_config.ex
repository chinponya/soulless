...
defmodule(Soulless.Tourney.Lq.GameConfig) do
  @moduledoc false
  (
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameConfig))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.GameConfig,
    ...
    def(defs()) do
      %{
        ...
        2 => {:mode, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMode}},
    ...
    def(defs_by_name()) do
      %{
        ...
        mode: {2, {:scalar, nil}, {:message, Soulless.Tourney.Lq.GameMode}}
      }
    end
