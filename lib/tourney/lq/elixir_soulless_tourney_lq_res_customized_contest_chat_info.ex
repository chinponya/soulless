      ...
      [
        ...
        defp(encode_chat_limit_type(acc, msg)) do
          try do
            if(msg.chat_limit_type == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.chat_limit_type)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:chat_limit_type, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_chat_limit_roster(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:chat_limit_roster, "invalid field value"),
                __STACKTRACE__
              )
          end
        end
