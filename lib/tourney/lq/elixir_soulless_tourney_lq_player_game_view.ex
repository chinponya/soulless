...
defmodule(Soulless.Tourney.Lq.PlayerGameView) do
  @moduledoc false
  (
    defstruct(
      account_id: 0,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.PlayerGameView))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.PlayerGameView,
    ...
    def(defs()) do
      %{
        ...
        6 => {:character, {:scalar, nil}, {:message, Soulless.Tourney.Lq.Character}},
        7 => {:level3, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        8 => {:avatar_frame, {:scalar, 0}, :uint32},
        9 => {:verified, {:scalar, 0}, :uint32},
        10 => {:views, :unpacked, {:message, Soulless.Tourney.Lq.ViewSlot}}
      }
    end
    ...
    def(defs_by_name()) do
      %{
        ...
        character: {6, {:scalar, nil}, {:message, Soulless.Tourney.Lq.Character}},
        level: {5, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        level3: {7, {:scalar, nil}, {:message, Soulless.Tourney.Lq.AccountLevel}},
        nickname: {4, {:scalar, ""}, :string},
        title: {3, {:scalar, 0}, :uint32},
        verified: {9, {:scalar, 0}, :uint32},
        views: {10, :unpacked, {:message, Soulless.Tourney.Lq.ViewSlot}}
      }
    end
