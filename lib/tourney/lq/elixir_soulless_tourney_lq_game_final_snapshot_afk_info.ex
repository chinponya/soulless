...
defmodule(Soulless.Tourney.Lq.GameFinalSnapshot.AFKInfo) do
  @moduledoc false
  (
      ...
      [
        defp(encode_deal_tile_count(acc, msg)) do
          try do
            ...
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:deal_tile_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
        defp(encode_moqie_count(acc, msg)) do
          try do
            if(msg.moqie_count == 0) do
              ...
              [acc, <<16>>, Protox.Encode.encode_uint32(msg.moqie_count)]
            end
          rescue
            ArgumentError ->
              reraise(
                Protox.EncodingError.new(:moqie_count, "invalid field value"),
                __STACKTRACE__
              )
          end
        end,
    ...
    (
      (
        ...
        (
          ...
          def(decode!(bytes)) do
            parse_key_value(bytes, struct(Soulless.Tourney.Lq.GameFinalSnapshot.AFKInfo))
          end
        )
      )
    ...
    (
      ...
      def(json_decode!(input, opts \\ [])) do
        ...
        Protox.JsonDecode.decode!(
          input,
          Soulless.Tourney.Lq.GameFinalSnapshot.AFKInfo,
